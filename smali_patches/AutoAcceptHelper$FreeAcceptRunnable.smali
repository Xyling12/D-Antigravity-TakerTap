...
# Background runnable for free-order auto-accept via NetworkService.V(intent)
...
.method public run()V
    ...
    # v0=orderId, v1=fromCity, v2=toCity, v3=price
    ...
    # Log: [FreeACCEPT] orderId=X from->to
    ...
    :after_send
    # postLog(fromCity, toCity, orderId, price)
