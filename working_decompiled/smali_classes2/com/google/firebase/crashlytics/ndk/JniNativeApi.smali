...
# interfaces
.implements Lcom/google/firebase/crashlytics/ndk/nhdortzefg;


# static fields
.field private static final feyxvdiekx:Z

.field private static final khjnvckbwi:Ljava/io/FilenameFilter;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/google/firebase/crashlytics/ndk/extxjewlhp;

    invoke-direct {v0}, Lcom/google/firebase/crashlytics/ndk/extxjewlhp;-><init>()V

    sput-object v0, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->khjnvckbwi:Ljava/io/FilenameFilter;
    ...
    invoke-virtual {v1, v0}, Lcom/google/firebase/crashlytics/internal/nhdortzefg;->ibzphkbtmt(Ljava/lang/String;)V

    const/4 v0, 0x0

    :goto_0
    sput-boolean v0, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->feyxvdiekx:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->qfzjddwuyn:Landroid/content/Context;
...
.method private static ibzphkbtmt()I
    .locals 1
...
.method public static khjnvckbwi(Ljava/util/List;Landroid/content/pm/PackageInfo;)V
    .locals 6
    ...
    invoke-static {p1}, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->qhoahqxrkc(Landroid/content/pm/PackageInfo;)Ljava/lang/String;
    ...
    :cond_1
    sget-object p1, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->khjnvckbwi:Ljava/io/FilenameFilter;
    ...
    invoke-virtual {v2, v1}, Lcom/google/firebase/crashlytics/internal/nhdortzefg;->feyxvdiekx(Ljava/lang/String;)V
...
.method private static qhoahqxrkc(Landroid/content/pm/PackageInfo;)Ljava/lang/String;
    .locals 2
...
# virtual methods
.method public nhdortzefg(Ljava/lang/String;)[Ljava/lang/String;
    .locals 7
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->qfzjddwuyn:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v2

    iget-object v3, p0, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->qfzjddwuyn:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-static {}, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->ibzphkbtmt()I
    ...
    invoke-static {}, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->extxjewlhp()Z

    move-result v5

    if-eqz v5, :cond_0

    invoke-static {v3, v2}, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->khjnvckbwi(Ljava/util/List;Landroid/content/pm/PackageInfo;)V
...
.method public qfzjddwuyn(Ljava/lang/String;Landroid/content/res/AssetManager;)Z
    .locals 5

    sget-object v0, Landroid/os/Build;->CPU_ABI:Ljava/lang/String;

    invoke-virtual {p0, v0}, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->nhdortzefg(Ljava/lang/String;)[Ljava/lang/String;
    ...
    sget-boolean v4, Lcom/google/firebase/crashlytics/ndk/JniNativeApi;->feyxvdiekx:Z
