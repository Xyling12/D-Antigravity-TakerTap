.class abstract Lcom/google/common/collect/kgyfkythat;
...
.field private transient kqhmbgiocc:Lcom/google/common/collect/txdisotafi;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lcom/google/common/collect/txdisotafi<",
            "TE;>;"
...
.method constructor <init>(Ljava/util/Comparator;)V
    ...
    iput-object p1, p0, Lcom/google/common/collect/kgyfkythat;->comparator:Ljava/util/Comparator;
...
.method public comparator()Ljava/util/Comparator;
    ...
    iget-object v0, p0, Lcom/google/common/collect/kgyfkythat;->comparator:Ljava/util/Comparator;

    return-object v0
.end method

.method createDescendingMultiset()Lcom/google/common/collect/txdisotafi;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    new-instance v0, Lcom/google/common/collect/kgyfkythat$qfzjddwuyn;

    invoke-direct {v0, p0}, Lcom/google/common/collect/kgyfkythat$qfzjddwuyn;-><init>(Lcom/google/common/collect/kgyfkythat;)V
...
.method bridge synthetic createElementSet()Ljava/util/Set;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/common/collect/kgyfkythat;->createElementSet()Ljava/util/NavigableSet;
...
.method descendingIterator()Ljava/util/Iterator;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/kgyfkythat;->descendingMultiset()Lcom/google/common/collect/txdisotafi;

    move-result-object v0

    invoke-static {v0}, Lcom/google/common/collect/Multisets;->bveuzccgjl(Lcom/google/common/collect/ekuiibmleg;)Ljava/util/Iterator;
...
.method public descendingMultiset()Lcom/google/common/collect/txdisotafi;
    ...
    iget-object v0, p0, Lcom/google/common/collect/kgyfkythat;->kqhmbgiocc:Lcom/google/common/collect/txdisotafi;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lcom/google/common/collect/kgyfkythat;->createDescendingMultiset()Lcom/google/common/collect/txdisotafi;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/collect/kgyfkythat;->kqhmbgiocc:Lcom/google/common/collect/txdisotafi;
...
.method public bridge synthetic elementSet()Ljava/util/Set;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/common/collect/kgyfkythat;->elementSet()Ljava/util/NavigableSet;
...
.method public firstEntry()Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/ibzphkbtmt;->entryIterator()Ljava/util/Iterator;
...
.method public lastEntry()Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/kgyfkythat;->descendingEntryIterator()Ljava/util/Iterator;
...
.method public subMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/txdisotafi;
    ...
    invoke-interface {p0, p1, p2}, Lcom/google/common/collect/txdisotafi;->tailMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/txdisotafi;
