...
# instance fields
.field private transient bomdigteio:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private transient obafekducm:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Comparator<",
            "-TK;>;"
...
.method constructor <init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
    ...
    .line 2
    iput-object p1, p0, Lcom/google/common/collect/TreeMultimap;->obafekducm:Ljava/util/Comparator;

    .line 3
    iput-object p2, p0, Lcom/google/common/collect/TreeMultimap;->bomdigteio:Ljava/util/Comparator;

    return-void
.end method

.method private constructor <init>(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/ekiqcarcrq;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-virtual {p0, p3}, Lcom/google/common/collect/TreeMultimap;->putAll(Lcom/google/common/collect/ekiqcarcrq;)Z
...
.method public static create(Lcom/google/common/collect/ekiqcarcrq;)Lcom/google/common/collect/TreeMultimap;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K::",
    ...
    invoke-direct {v0, v1, v2, p0}, Lcom/google/common/collect/TreeMultimap;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/ekiqcarcrq;)V
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    iput-object v0, p0, Lcom/google/common/collect/TreeMultimap;->obafekducm:Ljava/util/Comparator;
    ...
    iput-object v0, p0, Lcom/google/common/collect/TreeMultimap;->bomdigteio:Ljava/util/Comparator;

    new-instance v0, Ljava/util/TreeMap;

    iget-object v1, p0, Lcom/google/common/collect/TreeMultimap;->obafekducm:Ljava/util/Comparator;

    invoke-direct {v0, v1}, Ljava/util/TreeMap;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {p0, v0}, Lcom/google/common/collect/AbstractMapBasedMultimap;->setMap(Ljava/util/Map;)V

    invoke-static {p0, p1}, Lcom/google/common/collect/rbcjxezqjz;->ibzphkbtmt(Lcom/google/common/collect/ekiqcarcrq;Ljava/io/ObjectInputStream;)V
...
.method createCollection()Ljava/util/SortedSet;
    ...
    iget-object v1, p0, Lcom/google/common/collect/TreeMultimap;->bomdigteio:Ljava/util/Comparator;
...
.method public keyComparator()Ljava/util/Comparator;
    ...
    iget-object v0, p0, Lcom/google/common/collect/TreeMultimap;->obafekducm:Ljava/util/Comparator;
...
.method public valueComparator()Ljava/util/Comparator;
    ...
    iget-object v0, p0, Lcom/google/common/collect/TreeMultimap;->bomdigteio:Ljava/util/Comparator;
