...
.method private static feyxvdiekx(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
    .locals 5
    ...
    check-cast v3, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;

    invoke-interface {v3}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getRowKey()Ljava/lang/Object;

    move-result-object v4

    invoke-interface {v0, v4}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    invoke-interface {v3}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getColumnKey()Ljava/lang/Object;
...
.method static forCells(Ljava/lang/Iterable;)Lcom/google/common/collect/RegularImmutableTable;
    ...
    .line 5
    invoke-static {p0, v0, v0}, Lcom/google/common/collect/RegularImmutableTable;->feyxvdiekx(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
...
.method static forCells(Ljava/util/List;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
    ...
    .line 2
    :cond_0
    new-instance v0, Lcom/google/common/collect/wvwtypabui;

    invoke-direct {v0, p1, p2}, Lcom/google/common/collect/wvwtypabui;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
    ...
    .line 4
    :cond_1
    invoke-static {p0, p1, p2}, Lcom/google/common/collect/RegularImmutableTable;->feyxvdiekx(Ljava/lang/Iterable;Ljava/util/Comparator;Ljava/util/Comparator;)Lcom/google/common/collect/RegularImmutableTable;
...
.method public static synthetic qfzjddwuyn(Ljava/util/Comparator;Ljava/util/Comparator;Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;)I
    .locals 3
    ...
    :cond_0
    invoke-interface {p2}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getRowKey()Ljava/lang/Object;

    move-result-object v1

    invoke-interface {p3}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getRowKey()Ljava/lang/Object;
    ...
    :cond_2
    invoke-interface {p2}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getColumnKey()Ljava/lang/Object;

    move-result-object p0

    invoke-interface {p3}, Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;->getColumnKey()Ljava/lang/Object;
...
.method final checkNoDuplicate(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/google/common/base/jodmjjzdpr;->cqwyelzfbm(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method final createCellSet()Lcom/google/common/collect/ImmutableSet;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/RegularImmutableTable$CellSet;-><init>(Lcom/google/common/collect/RegularImmutableTable;Lcom/google/common/collect/RegularImmutableTable$qfzjddwuyn;)V
...
.method final createValues()Lcom/google/common/collect/ImmutableCollection;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/RegularImmutableTable$Values;-><init>(Lcom/google/common/collect/RegularImmutableTable;Lcom/google/common/collect/RegularImmutableTable$qfzjddwuyn;)V
...
.method abstract getCell(I)Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
            "Lcom/google/common/collect/uxoafglpkw$qfzjddwuyn<",
