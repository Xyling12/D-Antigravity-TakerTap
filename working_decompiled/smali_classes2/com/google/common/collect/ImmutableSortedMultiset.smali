...
.method public static copyOf(Ljava/util/Comparator;Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-static {p0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset;->extxjewlhp(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    .line 13
    :cond_1
    new-instance v0, Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;

    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;-><init>(Ljava/util/Comparator;)V

    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;->ewnfwzyokr(Ljava/lang/Iterable;)Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;
...
.method public static copyOf(Ljava/util/Comparator;Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset;
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;->pednzybqgd(Ljava/util/Iterator;)Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;
...
.method public static copyOfSorted(Lcom/google/common/collect/txdisotafi;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    invoke-interface {p0}, Lcom/google/common/collect/txdisotafi;->comparator()Ljava/util/Comparator;

    move-result-object v0

    invoke-interface {p0}, Lcom/google/common/collect/txdisotafi;->entrySet()Ljava/util/Set;
    ...
    invoke-static {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset;->extxjewlhp(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
...
.method private static extxjewlhp(Ljava/util/Comparator;Ljava/util/Collection;)Lcom/google/common/collect/ImmutableSortedMultiset;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
    ...
    check-cast v5, Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;

    invoke-interface {v5}, Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;->getElement()Ljava/lang/Object;

    move-result-object v6

    invoke-virtual {v0, v6}, Lcom/google/common/collect/ImmutableList$qfzjddwuyn;->tthmnequln(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$qfzjddwuyn;

    add-int/lit8 v6, v4, 0x1

    aget-wide v7, v1, v4

    invoke-interface {v5}, Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;->getCount()I
...
.method public static naturalOrder()Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
    ...
    invoke-direct {v0, v1}, Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;-><init>(Ljava/util/Comparator;)V
...
.method public static orderedBy(Ljava/util/Comparator;)Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E:",
...
.method public static reverseOrder()Lcom/google/common/collect/ImmutableSortedMultiset$qfzjddwuyn;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<E::",
...
.method public bridge synthetic headMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/txdisotafi;
    .locals 0
...
.method public final pollFirstEntry()Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final pollLastEntry()Lcom/google/common/collect/ekuiibmleg$qfzjddwuyn;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public bridge synthetic tailMultiset(Ljava/lang/Object;Lcom/google/common/collect/BoundType;)Lcom/google/common/collect/txdisotafi;
    .locals 0
...
.method writeReplace()Ljava/lang/Object;
    ...
    invoke-direct {v0, p0}, Lcom/google/common/collect/ImmutableSortedMultiset$SerializedForm;-><init>(Lcom/google/common/collect/txdisotafi;)V
