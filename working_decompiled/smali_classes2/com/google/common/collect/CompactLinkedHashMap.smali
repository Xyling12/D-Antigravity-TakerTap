...
# static fields
.field private static final nnzwevhkoa:I = -0x2
...
.method private ewnfwzyokr(I)I
    .locals 2

    invoke-direct {p0, p1}, Lcom/google/common/collect/CompactLinkedHashMap;->pednzybqgd(I)J
...
.method private jodmjjzdpr(II)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcom/google/common/collect/CompactLinkedHashMap;->vlnjtcdbbq(IJ)V

    return-void
.end method

.method private ldyhhegomq()[J
    .locals 1
...
.method private opauvyugnb(II)V
    .locals 1
    ...
    iput p2, p0, Lcom/google/common/collect/CompactLinkedHashMap;->bomdigteio:I

    goto :goto_0

    :cond_0
    invoke-direct {p0, p1, p2}, Lcom/google/common/collect/CompactLinkedHashMap;->jodmjjzdpr(II)V

    :goto_0
    if-ne p2, v0, :cond_1

    iput p1, p0, Lcom/google/common/collect/CompactLinkedHashMap;->oqddtttpsr:I

    return-void

    :cond_1
    invoke-direct {p0, p2, p1}, Lcom/google/common/collect/CompactLinkedHashMap;->pyxggrwgoy(II)V

    return-void
.end method

.method private pednzybqgd(I)J
    .locals 3

    invoke-direct {p0}, Lcom/google/common/collect/CompactLinkedHashMap;->ldyhhegomq()[J
...
.method private pyxggrwgoy(II)V
    .locals 4
...
.method private vlnjtcdbbq(IJ)V
    .locals 1
...
.method accessEntry(I)V
    ...
    invoke-direct {p0, p1}, Lcom/google/common/collect/CompactLinkedHashMap;->ewnfwzyokr(I)I
    ...
    invoke-direct {p0, v0, v1}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    iget v0, p0, Lcom/google/common/collect/CompactLinkedHashMap;->oqddtttpsr:I

    invoke-direct {p0, v0, p1}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    const/4 v0, -0x2

    invoke-direct {p0, p1, v0}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V
...
.method public clear()V
    ...
    iput v0, p0, Lcom/google/common/collect/CompactLinkedHashMap;->bomdigteio:I

    iput v0, p0, Lcom/google/common/collect/CompactLinkedHashMap;->oqddtttpsr:I
...
.method firstEntryIndex()I
    ...
    iget v0, p0, Lcom/google/common/collect/CompactLinkedHashMap;->bomdigteio:I
...
.method init(I)V
    ...
    iput p1, p0, Lcom/google/common/collect/CompactLinkedHashMap;->bomdigteio:I
...
.method insertEntry(ILjava/lang/Object;Ljava/lang/Object;II)V
    ...
    iget p3, p1, Lcom/google/common/collect/CompactLinkedHashMap;->oqddtttpsr:I

    invoke-direct {p0, p3, p2}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    const/4 p3, -0x2

    invoke-direct {p0, p2, p3}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V
...
.method moveLastEntry(II)V
    ...
    invoke-direct {p0, p2, v1}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    if-ge p1, v0, :cond_0

    invoke-direct {p0, v0}, Lcom/google/common/collect/CompactLinkedHashMap;->ewnfwzyokr(I)I

    move-result p2

    invoke-direct {p0, p2, p1}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    invoke-virtual {p0, v0}, Lcom/google/common/collect/CompactLinkedHashMap;->getSuccessor(I)I

    move-result p2

    invoke-direct {p0, p1, p2}, Lcom/google/common/collect/CompactLinkedHashMap;->opauvyugnb(II)V

    :cond_0
    const-wide/16 p1, 0x0

    invoke-direct {p0, v0, p1, p2}, Lcom/google/common/collect/CompactLinkedHashMap;->vlnjtcdbbq(IJ)V
