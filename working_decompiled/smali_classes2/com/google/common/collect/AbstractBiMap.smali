...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/google/common/collect/AbstractBiMap$khjnvckbwi;,
        Lcom/google/common/collect/AbstractBiMap$feyxvdiekx;,
        Lcom/google/common/collect/AbstractBiMap$qhoahqxrkc;,
        Lcom/google/common/collect/AbstractBiMap$ibzphkbtmt;
    }
.end annotation
...
# instance fields
.field private transient cbsxzgznvp:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "TK;TV;>;"
...
.method private constructor <init>(Ljava/util/Map;Lcom/google/common/collect/AbstractBiMap;)V
    ...
    .line 5
    iput-object p1, p0, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;
...
.method synthetic constructor <init>(Ljava/util/Map;Lcom/google/common/collect/AbstractBiMap;Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;)V
    .locals 0
...
.method private A(Ljava/lang/Object;ZLjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p3}, Lcom/google/common/collect/njmpchkvgz;->qfzjddwuyn(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    invoke-direct {p0, p2}, Lcom/google/common/collect/AbstractBiMap;->y(Ljava/lang/Object;)V

    :cond_0
    iget-object p2, p0, Lcom/google/common/collect/AbstractBiMap;->inverse:Lcom/google/common/collect/AbstractBiMap;

    iget-object p2, p2, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;
...
.method static synthetic access$100(Lcom/google/common/collect/AbstractBiMap;)Ljava/util/Map;
    ...
    iget-object p0, p0, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;
...
.method static synthetic access$200(Lcom/google/common/collect/AbstractBiMap;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Lcom/google/common/collect/AbstractBiMap;->k(Ljava/lang/Object;)Ljava/lang/Object;
...
.method static synthetic access$600(Lcom/google/common/collect/AbstractBiMap;Ljava/lang/Object;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/common/collect/AbstractBiMap;->y(Ljava/lang/Object;)V

    return-void
.end method

.method private e(Ljava/lang/Object;Ljava/lang/Object;Z)Ljava/lang/Object;
    .locals 2
    .param p1    # Ljava/lang/Object;
        .annotation runtime Lcom/google/common/collect/nnzwevhkoa;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/collect/oltojwzksj;->containsKey(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/google/common/collect/oltojwzksj;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    invoke-static {p2, v1}, Lcom/google/common/base/ldyhhegomq;->qfzjddwuyn(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lcom/google/common/collect/AbstractBiMap;->inverse()Lcom/google/common/collect/ktvtxjqbtt;
    ...
    invoke-static {p3, v1, p2}, Lcom/google/common/base/jodmjjzdpr;->pyxggrwgoy(ZLjava/lang/String;Ljava/lang/Object;)V

    :goto_0
    iget-object p3, p0, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;

    invoke-interface {p3, p1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p3

    invoke-direct {p0, p1, v0, p3, p2}, Lcom/google/common/collect/AbstractBiMap;->A(Ljava/lang/Object;ZLjava/lang/Object;Ljava/lang/Object;)V
...
.method private k(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;
...
.method private y(Ljava/lang/Object;)V
    ...
    iget-object v0, v0, Lcom/google/common/collect/AbstractBiMap;->cbsxzgznvp:Ljava/util/Map;
...
.method public containsValue(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/collect/oltojwzksj;->containsKey(Ljava/lang/Object;)Z
...
.method public entrySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->thipomyfnm:Ljava/util/Set;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/common/collect/AbstractBiMap$khjnvckbwi;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/AbstractBiMap$khjnvckbwi;-><init>(Lcom/google/common/collect/AbstractBiMap;Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;)V

    iput-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->thipomyfnm:Ljava/util/Set;
...
.method entrySetIterator()Ljava/util/Iterator;
    ...
    new-instance v1, Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;

    invoke-direct {v1, p0, v0}, Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;-><init>(Lcom/google/common/collect/AbstractBiMap;Ljava/util/Iterator;)V
...
.method public forcePut(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/google/common/collect/AbstractBiMap;->e(Ljava/lang/Object;Ljava/lang/Object;Z)Ljava/lang/Object;
...
.method public keySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->xglnwpaccw:Ljava/util/Set;

    if-nez v0, :cond_0

    new-instance v0, Lcom/google/common/collect/AbstractBiMap$ibzphkbtmt;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/AbstractBiMap$ibzphkbtmt;-><init>(Lcom/google/common/collect/AbstractBiMap;Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;)V

    iput-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->xglnwpaccw:Ljava/util/Set;
...
.method public values()Ljava/util/Set;
    ...
    .line 2
    iget-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->kqhmbgiocc:Ljava/util/Set;

    if-nez v0, :cond_0

    .line 3
    new-instance v0, Lcom/google/common/collect/AbstractBiMap$qhoahqxrkc;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/google/common/collect/AbstractBiMap$qhoahqxrkc;-><init>(Lcom/google/common/collect/AbstractBiMap;Lcom/google/common/collect/AbstractBiMap$qfzjddwuyn;)V

    iput-object v0, p0, Lcom/google/common/collect/AbstractBiMap;->kqhmbgiocc:Ljava/util/Set;
