...
.field private final qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;
...
.method private constructor <init>(Lcom/google/common/graph/ElementOrder$Type;Ljava/util/Comparator;)V
    ...
    iput-object v0, p0, Lcom/google/common/graph/ElementOrder;->qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;

    iput-object p2, p0, Lcom/google/common/graph/ElementOrder;->feyxvdiekx:Ljava/util/Comparator;
...
.method public static drkbbjxjkt()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static extxjewlhp(Ljava/util/Comparator;)Lcom/google/common/graph/ElementOrder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static ibzphkbtmt()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static nhdortzefg()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S:",
...
.method public static qhoahqxrkc()Lcom/google/common/graph/ElementOrder;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<S::",
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/google/common/graph/ElementOrder;->qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;

    iget-object v3, p1, Lcom/google/common/graph/ElementOrder;->qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;

    if-ne v1, v3, :cond_2

    iget-object v1, p0, Lcom/google/common/graph/ElementOrder;->feyxvdiekx:Ljava/util/Comparator;

    iget-object p1, p1, Lcom/google/common/graph/ElementOrder;->feyxvdiekx:Ljava/util/Comparator;
...
.method public feyxvdiekx()Ljava/util/Comparator;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/common/graph/ElementOrder;->feyxvdiekx:Ljava/util/Comparator;
...
.method public hashCode()I
    ...
    iget-object v0, p0, Lcom/google/common/graph/ElementOrder;->qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;
...
.method public kgyfkythat()Lcom/google/common/graph/ElementOrder$Type;
    .locals 1
...
.method khjnvckbwi(I)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:TT;V:",
    ...
    sget-object v0, Lcom/google/common/graph/ElementOrder$qfzjddwuyn;->qfzjddwuyn:[I
    ...
    invoke-virtual {p0}, Lcom/google/common/graph/ElementOrder;->feyxvdiekx()Ljava/util/Comparator;

    move-result-object p1

    invoke-static {p1}, Lcom/google/common/collect/Maps;->qzideqapiw(Ljava/util/Comparator;)Ljava/util/TreeMap;
    ...
    :cond_1
    invoke-static {p1}, Lcom/google/common/collect/Maps;->pgglzjfpqi(I)Ljava/util/LinkedHashMap;
    ...
    :cond_2
    invoke-static {p1}, Lcom/google/common/collect/Maps;->cbvdcosrqn(I)Ljava/util/HashMap;
...
.method qfzjddwuyn()Lcom/google/common/graph/ElementOrder;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T1:TT;>()",
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/common/graph/ElementOrder;->qfzjddwuyn:Lcom/google/common/graph/ElementOrder$Type;
