...
.method private qfzjddwuyn()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    new-instance v1, Lcom/google/common/util/concurrent/AtomicLongMap$qfzjddwuyn;

    invoke-direct {v1, p0}, Lcom/google/common/util/concurrent/AtomicLongMap$qfzjddwuyn;-><init>(Lcom/google/common/util/concurrent/AtomicLongMap;)V

    invoke-static {v0, v1}, Lcom/google/common/collect/Maps;->uenyyqdybd(Ljava/util/Map;Lcom/google/common/base/bveuzccgjl;)Ljava/util/Map;
...
.method public asMap()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/common/util/concurrent/AtomicLongMap;->cbsxzgznvp:Ljava/util/Map;

    if-nez v0, :cond_0

    invoke-direct {p0}, Lcom/google/common/util/concurrent/AtomicLongMap;->qfzjddwuyn()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/google/common/util/concurrent/AtomicLongMap;->cbsxzgznvp:Ljava/util/Map;
