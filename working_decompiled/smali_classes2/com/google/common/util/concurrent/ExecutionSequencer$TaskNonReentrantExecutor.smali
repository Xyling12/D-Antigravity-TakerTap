...
.method synthetic constructor <init>(Ljava/util/concurrent/Executor;Lcom/google/common/util/concurrent/ExecutionSequencer;Lcom/google/common/util/concurrent/ExecutionSequencer$qfzjddwuyn;)V
    .locals 0
...
.method static synthetic access$200(Lcom/google/common/util/concurrent/ExecutionSequencer$TaskNonReentrantExecutor;)Z
    ...
    invoke-direct {p0}, Lcom/google/common/util/concurrent/ExecutionSequencer$TaskNonReentrantExecutor;->feyxvdiekx()Z
...
.method static synthetic access$400(Lcom/google/common/util/concurrent/ExecutionSequencer$TaskNonReentrantExecutor;)Z
    ...
    invoke-direct {p0}, Lcom/google/common/util/concurrent/ExecutionSequencer$TaskNonReentrantExecutor;->qfzjddwuyn()Z
...
.method public execute(Ljava/lang/Runnable;)V
    ...
    invoke-static {v0}, Lcom/google/common/util/concurrent/ExecutionSequencer;->feyxvdiekx(Lcom/google/common/util/concurrent/ExecutionSequencer;)Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;

    move-result-object v0

    iget-object v1, v0, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->qfzjddwuyn:Ljava/lang/Thread;
    ...
    iget-object v1, v0, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->feyxvdiekx:Ljava/lang/Runnable;
    ...
    iput-object p1, v0, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->feyxvdiekx:Ljava/lang/Runnable;
    ...
    iput-object p1, v0, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->khjnvckbwi:Ljava/util/concurrent/Executor;
...
.method public run()V
    ...
    :cond_0
    new-instance v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;

    invoke-direct {v1, v2}, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;-><init>(Lcom/google/common/util/concurrent/ExecutionSequencer$qfzjddwuyn;)V

    iput-object v0, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->qfzjddwuyn:Ljava/lang/Thread;

    iget-object v0, p0, Lcom/google/common/util/concurrent/ExecutionSequencer$TaskNonReentrantExecutor;->sequencer:Lcom/google/common/util/concurrent/ExecutionSequencer;

    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {v0, v1}, Lcom/google/common/util/concurrent/ExecutionSequencer;->khjnvckbwi(Lcom/google/common/util/concurrent/ExecutionSequencer;Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;)Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;
    ...
    :goto_0
    iget-object v0, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->feyxvdiekx:Ljava/lang/Runnable;

    if-eqz v0, :cond_1

    iget-object v3, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->khjnvckbwi:Ljava/util/concurrent/Executor;

    if-eqz v3, :cond_1

    iput-object v2, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->feyxvdiekx:Ljava/lang/Runnable;

    iput-object v2, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->khjnvckbwi:Ljava/util/concurrent/Executor;
    ...
    :cond_1
    iput-object v2, v1, Lcom/google/common/util/concurrent/ExecutionSequencer$khjnvckbwi;->qfzjddwuyn:Ljava/lang/Thread;
