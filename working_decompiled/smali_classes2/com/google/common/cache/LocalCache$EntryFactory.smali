...
.field private static final synthetic cbsxzgznvp:[Lcom/google/common/cache/LocalCache$EntryFactory;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/google/common/cache/LocalCache$EntryFactory;->khjnvckbwi()[Lcom/google/common/cache/LocalCache$EntryFactory;

    move-result-object v15

    sput-object v15, Lcom/google/common/cache/LocalCache$EntryFactory;->cbsxzgznvp:[Lcom/google/common/cache/LocalCache$EntryFactory;
...
.method synthetic constructor <init>(Ljava/lang/String;ILcom/google/common/cache/LocalCache$qfzjddwuyn;)V
    .locals 0
...
.method private static synthetic khjnvckbwi()[Lcom/google/common/cache/LocalCache$EntryFactory;
    .locals 8
...
.method public static values()[Lcom/google/common/cache/LocalCache$EntryFactory;
    ...
    sget-object v0, Lcom/google/common/cache/LocalCache$EntryFactory;->cbsxzgznvp:[Lcom/google/common/cache/LocalCache$EntryFactory;
...
# virtual methods
.method copyAccessEntry(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Lcom/google/common/cache/lsvcqaryex;->setAccessTime(J)V

    invoke-interface {p1}, Lcom/google/common/cache/lsvcqaryex;->getPreviousInAccessQueue()Lcom/google/common/cache/lsvcqaryex;

    move-result-object v0

    invoke-static {v0, p2}, Lcom/google/common/cache/LocalCache;->khjnvckbwi(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V

    invoke-interface {p1}, Lcom/google/common/cache/lsvcqaryex;->getNextInAccessQueue()Lcom/google/common/cache/lsvcqaryex;

    move-result-object v0

    invoke-static {p2, v0}, Lcom/google/common/cache/LocalCache;->khjnvckbwi(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V
...
.method copyEntry(Lcom/google/common/cache/LocalCache$Segment;Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)Lcom/google/common/cache/lsvcqaryex;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2}, Lcom/google/common/cache/lsvcqaryex;->getKey()Ljava/lang/Object;

    move-result-object v0

    invoke-interface {p2}, Lcom/google/common/cache/lsvcqaryex;->getHash()I

    move-result p2

    invoke-virtual {p0, p1, v0, p2, p3}, Lcom/google/common/cache/LocalCache$EntryFactory;->newEntry(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILcom/google/common/cache/lsvcqaryex;)Lcom/google/common/cache/lsvcqaryex;
...
.method copyWriteEntry(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-interface {p2, v0, v1}, Lcom/google/common/cache/lsvcqaryex;->setWriteTime(J)V

    invoke-interface {p1}, Lcom/google/common/cache/lsvcqaryex;->getPreviousInWriteQueue()Lcom/google/common/cache/lsvcqaryex;

    move-result-object v0

    invoke-static {v0, p2}, Lcom/google/common/cache/LocalCache;->ibzphkbtmt(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V

    invoke-interface {p1}, Lcom/google/common/cache/lsvcqaryex;->getNextInWriteQueue()Lcom/google/common/cache/lsvcqaryex;

    move-result-object v0

    invoke-static {p2, v0}, Lcom/google/common/cache/LocalCache;->ibzphkbtmt(Lcom/google/common/cache/lsvcqaryex;Lcom/google/common/cache/lsvcqaryex;)V
...
.method abstract newEntry(Lcom/google/common/cache/LocalCache$Segment;Ljava/lang/Object;ILcom/google/common/cache/lsvcqaryex;)Lcom/google/common/cache/lsvcqaryex;
