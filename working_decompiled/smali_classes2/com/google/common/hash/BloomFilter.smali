...
# instance fields
.field private final bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
...
# direct methods
.method private constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, v3, p2}, Lcom/google/common/base/jodmjjzdpr;->ktvtxjqbtt(ZLjava/lang/String;I)V
    ...
    invoke-static {v0, v1, p2}, Lcom/google/common/base/jodmjjzdpr;->ktvtxjqbtt(ZLjava/lang/String;I)V
    ...
    iput-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
...
.method synthetic constructor <init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;Lcom/google/common/hash/BloomFilter$qfzjddwuyn;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V

    return-void
.end method

.method static synthetic access$000(Lcom/google/common/hash/BloomFilter;)Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
    .locals 0

    iget-object p0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
...
.method static create(Lcom/google/common/hash/Funnel;JDLcom/google/common/hash/BloomFilter$Strategy;)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static {v3, v4, p1, p2}, Lcom/google/common/base/jodmjjzdpr;->lohkmxcimj(ZLjava/lang/String;J)V
    ...
    invoke-static {v3, v5, v4}, Lcom/google/common/base/jodmjjzdpr;->pyxggrwgoy(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v3, v2}, Lcom/google/common/base/jodmjjzdpr;->pyxggrwgoy(ZLjava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p3, p4}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;-><init>(J)V

    invoke-direct {p2, v0, p1, p0, p5}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_0
...
.method public static readFrom(Ljava/io/InputStream;Lcom/google/common/hash/Funnel;)Lcom/google/common/hash/BloomFilter;
    ...
    invoke-static {v2}, Lcom/google/common/primitives/UnsignedBytes;->lohkmxcimj(B)I
    ...
    new-instance v4, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    int-to-long v5, v0

    const-wide/16 v7, 0x40

    invoke-static {v5, v6, v7, v8}, Lcom/google/common/math/LongMath;->ibzphkbtmt(JJ)J

    move-result-wide v5

    invoke-direct {v4, v5, v6}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;-><init>(J)V
    ...
    invoke-virtual {v4, v5, v6, v7}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->nhdortzefg(IJ)V
    ...
    invoke-direct {v1, v4, v2, p1, v3}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
    :try_end_2
...
.method public approximateElementCount()J
    ...
    iget-object v0, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->feyxvdiekx()J

    move-result-wide v0

    iget-object v2, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    invoke-virtual {v2}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->qfzjddwuyn()J
    ...
    invoke-static {v2, v3, v0}, Lcom/google/common/math/khjnvckbwi;->ewnfwzyokr(DLjava/math/RoundingMode;)J
...
.method public copy()Lcom/google/common/hash/BloomFilter;
    ...
    iget-object v1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    invoke-virtual {v1}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->khjnvckbwi()Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/google/common/hash/BloomFilter;-><init>(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;ILcom/google/common/hash/Funnel;Lcom/google/common/hash/BloomFilter$Strategy;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    invoke-virtual {v1, v3}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->equals(Ljava/lang/Object;)Z
...
.method public expectedFpp()D
    ...
    invoke-virtual {v0}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->qfzjddwuyn()J
...
.method public hashCode()I
    ...
    iget-object v3, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
...
.method public mightContain(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->mightContain(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;)Z
...
.method public put(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, p1, v1, v2, v3}, Lcom/google/common/hash/BloomFilter$Strategy;->put(Ljava/lang/Object;Lcom/google/common/hash/Funnel;ILcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;)Z
...
.method public putAll(Lcom/google/common/hash/BloomFilter;)V
    ...
    invoke-static {v4, v5, v2, v3}, Lcom/google/common/base/jodmjjzdpr;->rmnxkaltsn(ZLjava/lang/String;II)V
    ...
    invoke-static/range {v3 .. v8}, Lcom/google/common/base/jodmjjzdpr;->ldyhhegomq(ZLjava/lang/String;JJ)V
    ...
    invoke-static {v0, v3, v1, v2}, Lcom/google/common/base/jodmjjzdpr;->bdweufyeak(ZLjava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;

    invoke-virtual {v0, p1}, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->extxjewlhp(Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;)V
...
.method public writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-static {v1, v2}, Lcom/google/common/primitives/SignedBytes;->qfzjddwuyn(J)B
    ...
    invoke-static {v1, v2}, Lcom/google/common/primitives/UnsignedBytes;->qfzjddwuyn(J)B

    move-result p1

    invoke-virtual {v0, p1}, Ljava/io/DataOutputStream;->writeByte(I)V

    iget-object p1, p0, Lcom/google/common/hash/BloomFilter;->bits:Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;
    ...
    iget-object v1, v1, Lcom/google/common/hash/BloomFilterStrategies$qfzjddwuyn;->qfzjddwuyn:Ljava/util/concurrent/atomic/AtomicLongArray;
