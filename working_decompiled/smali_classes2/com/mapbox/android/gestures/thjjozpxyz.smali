.class public Lcom/mapbox/android/gestures/thjjozpxyz;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;,
        Lcom/mapbox/android/gestures/thjjozpxyz$feyxvdiekx;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/mapbox/android/gestures/thjjozpxyz;->kedepleukr:Ljava/util/Set;
...
.method protected cqwyelzfbm()Z
    ...
    invoke-virtual {p0}, Lcom/mapbox/android/gestures/thjjozpxyz;->ffafdrhafs()Z
...
.method ffafdrhafs()Z
    ...
    iget v2, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->czxichccep:F
...
.method public gsqtbaunhh()F
    ...
    iget v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->tgyvlqjbcn:F
...
.method protected jtuzwzphqf()V
    ...
    iput v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->tgyvlqjbcn:F
...
.method protected khjnvckbwi(I)Z
    ...
    iget v1, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->bdweufyeak:F
...
.method public klvawbfmro(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/mapbox/android/gestures/thjjozpxyz;->lrtruanqwg(F)V
...
.method public lrtruanqwg(F)V
    ...
    iput p1, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->bdweufyeak:F
...
.method protected lsvcqaryex()Z
    ...
    invoke-virtual {p0}, Lcom/mapbox/android/gestures/thjjozpxyz;->yjsnmddfnr()F

    move-result v0

    iput v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->cqwyelzfbm:F

    iget v1, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->tgyvlqjbcn:F

    add-float/2addr v1, v0

    iput v1, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->tgyvlqjbcn:F
    ...
    iget v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->cqwyelzfbm:F
    ...
    check-cast v1, Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;

    iget v2, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->tgyvlqjbcn:F

    invoke-interface {v1, p0, v0, v2}, Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;->khjnvckbwi(Lcom/mapbox/android/gestures/thjjozpxyz;FF)Z
    ...
    invoke-virtual {p0, v0}, Lcom/mapbox/android/gestures/thjjozpxyz;->khjnvckbwi(I)Z
    ...
    check-cast v0, Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;

    invoke-interface {v0, p0}, Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;->feyxvdiekx(Lcom/mapbox/android/gestures/thjjozpxyz;)Z
...
.method protected nnapbkpnda()Ljava/util/Set;
    ...
    sget-object v0, Lcom/mapbox/android/gestures/thjjozpxyz;->kedepleukr:Ljava/util/Set;
...
.method public oltojwzksj()F
    ...
    iget v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->czxichccep:F
...
.method protected pfbsrxdbry()V
    ...
    invoke-interface {v0, p0, v1, v2}, Lcom/mapbox/android/gestures/thjjozpxyz$qfzjddwuyn;->qfzjddwuyn(Lcom/mapbox/android/gestures/thjjozpxyz;FF)V
...
.method public pldnqpfyrw()F
    ...
    iget v0, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->bdweufyeak:F
...
.method public qzbvjsuekv(F)V
    ...
    iput p1, p0, Lcom/mapbox/android/gestures/thjjozpxyz;->czxichccep:F
