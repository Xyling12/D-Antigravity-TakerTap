...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/window/layout/WindowInfoTrackerImpl;->ibzphkbtmt(Landroid/app/Activity;)Lkotlinx/coroutines/flow/qhoahqxrkc;
.end annotation
...
# direct methods
.method constructor <init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lkotlin/coroutines/khjnvckbwi;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final nhdortzefg(Lkotlinx/coroutines/channels/ktvtxjqbtt;Landroidx/window/layout/bdweufyeak;)V
    .locals 1
...
.method public static synthetic qfzjddwuyn(Lkotlinx/coroutines/channels/ktvtxjqbtt;Landroidx/window/layout/bdweufyeak;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->nhdortzefg(Lkotlinx/coroutines/channels/ktvtxjqbtt;Landroidx/window/layout/bdweufyeak;)V
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Lkotlin/coroutines/khjnvckbwi;
    ...
    invoke-direct {v0, v1, v2, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;-><init>(Landroidx/window/layout/WindowInfoTrackerImpl;Landroid/app/Activity;Lkotlin/coroutines/khjnvckbwi;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->invoke(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public final invoke(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->create(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Lkotlin/coroutines/khjnvckbwi;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v5, v1, v6, v4, v6}, Lkotlinx/coroutines/channels/rmnxkaltsn;->ibzphkbtmt(ILkotlinx/coroutines/channels/BufferOverflow;Ls3/lsvcqaryex;ILjava/lang/Object;)Lkotlinx/coroutines/channels/ktvtxjqbtt;

    move-result-object v1

    new-instance v4, Landroidx/window/layout/czxichccep;

    invoke-direct {v4, v1}, Landroidx/window/layout/czxichccep;-><init>(Lkotlinx/coroutines/channels/ktvtxjqbtt;)V
    ...
    invoke-static {v5}, Landroidx/window/layout/WindowInfoTrackerImpl;->qhoahqxrkc(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/pyxggrwgoy;

    move-result-object v5

    iget-object v6, p0, Landroidx/window/layout/WindowInfoTrackerImpl$windowLayoutInfo$1;->$activity:Landroid/app/Activity;

    new-instance v7, Landroidx/privacysandbox/ads/adservices/adid/ktvtxjqbtt;

    invoke-direct {v7}, Landroidx/privacysandbox/ads/adservices/adid/ktvtxjqbtt;-><init>()V

    invoke-interface {v5, v6, v7, v4}, Landroidx/window/layout/pyxggrwgoy;->qfzjddwuyn(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/ibzphkbtmt;)V
    ...
    invoke-interface {v5, p1, p0}, Lkotlinx/coroutines/flow/extxjewlhp;->emit(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Landroidx/window/layout/WindowInfoTrackerImpl;->qhoahqxrkc(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/pyxggrwgoy;

    move-result-object p1

    invoke-interface {p1, v4}, Landroidx/window/layout/pyxggrwgoy;->feyxvdiekx(Landroidx/core/util/ibzphkbtmt;)V
    ...
    invoke-static {v0}, Landroidx/window/layout/WindowInfoTrackerImpl;->qhoahqxrkc(Landroidx/window/layout/WindowInfoTrackerImpl;)Landroidx/window/layout/pyxggrwgoy;

    move-result-object v0

    invoke-interface {v0, v4}, Landroidx/window/layout/pyxggrwgoy;->feyxvdiekx(Landroidx/core/util/ibzphkbtmt;)V
