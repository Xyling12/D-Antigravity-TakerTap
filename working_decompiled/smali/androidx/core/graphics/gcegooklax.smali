.class public Landroidx/core/graphics/gcegooklax;
...
.method private static lohkmxcimj(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    .locals 2
...
.method private thjjozpxyz(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    .locals 5
    ...
    invoke-static {v0, v1}, Landroidx/core/graphics/gcegooklax;->lohkmxcimj(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Landroidx/core/graphics/gcegooklax;->lohkmxcimj(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method public feyxvdiekx(Landroid/content/Context;Landroidx/core/content/res/extxjewlhp$ibzphkbtmt;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Landroidx/core/content/res/extxjewlhp$qhoahqxrkc;->ibzphkbtmt()Ljava/lang/String;
    ...
    invoke-direct {p0, p2, p4}, Landroidx/core/graphics/gcegooklax;->thjjozpxyz(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public ibzphkbtmt(Landroid/content/Context;Landroid/os/CancellationSignal;[Landroidx/core/provider/kgyfkythat$khjnvckbwi;I)Landroid/graphics/Typeface;
    ...
    :try_start_1
    invoke-virtual {v4}, Landroidx/core/provider/kgyfkythat$khjnvckbwi;->ibzphkbtmt()Landroid/net/Uri;
    ...
    invoke-virtual {v4}, Landroidx/core/provider/kgyfkythat$khjnvckbwi;->qhoahqxrkc()I
    ...
    invoke-virtual {v4}, Landroidx/core/provider/kgyfkythat$khjnvckbwi;->extxjewlhp()Z
    ...
    invoke-virtual {v4}, Landroidx/core/provider/kgyfkythat$khjnvckbwi;->khjnvckbwi()I
    ...
    invoke-direct {p0, p1, p4}, Landroidx/core/graphics/gcegooklax;->thjjozpxyz(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
