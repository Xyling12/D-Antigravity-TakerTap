...
# instance fields
.field private final qfzjddwuyn:Landroid/util/Range;
...
.method public constructor <init>(Landroidx/camera/camera2/internal/compat/bdweufyeak;)V
    ...
    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/compat/quirk/AeFpsRangeLegacyQuirk;->drkbbjxjkt([Landroid/util/Range;)Landroid/util/Range;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/camera2/internal/compat/quirk/AeFpsRangeLegacyQuirk;->qfzjddwuyn:Landroid/util/Range;

    return-void
.end method

.method private drkbbjxjkt([Landroid/util/Range;)Landroid/util/Range;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    invoke-direct {p0, v3}, Landroidx/camera/camera2/internal/compat/quirk/AeFpsRangeLegacyQuirk;->nhdortzefg(Landroid/util/Range;)Landroid/util/Range;
...
.method private nhdortzefg(Landroid/util/Range;)Landroid/util/Range;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public qfzjddwuyn()Landroid/util/Range;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Landroidx/camera/camera2/internal/compat/quirk/AeFpsRangeLegacyQuirk;->qfzjddwuyn:Landroid/util/Range;
