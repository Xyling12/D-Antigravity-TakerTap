.class Landroidx/camera/camera2/internal/compat/lqubyxtgks;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Landroidx/camera/camera2/internal/compat/tgyvlqjbcn$qfzjddwuyn;


# annotations
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/camera/camera2/internal/compat/lqubyxtgks$qfzjddwuyn;
    }
.end annotation
...
.field final qfzjddwuyn:Landroid/hardware/camera2/CameraDevice;
...
.method constructor <init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->qfzjddwuyn:Landroid/hardware/camera2/CameraDevice;

    iput-object p2, p0, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->feyxvdiekx:Ljava/lang/Object;

    return-void
.end method

.method static ibzphkbtmt(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/lohkmxcimj;)V
    .locals 1
    ...
    invoke-static {p0, v0}, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->khjnvckbwi(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
...
.method private static khjnvckbwi(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;)V
    .locals 3
    ...
    check-cast v0, Landroidx/camera/camera2/internal/compat/params/tthmnequln;

    invoke-virtual {v0}, Landroidx/camera/camera2/internal/compat/params/tthmnequln;->extxjewlhp()Ljava/lang/String;
...
.method static nhdortzefg(Ljava/util/List;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1}, Landroidx/camera/camera2/internal/compat/params/tthmnequln;->kgyfkythat()Landroid/view/Surface;
...
.method static qhoahqxrkc(Landroid/hardware/camera2/CameraDevice;Landroid/os/Handler;)Landroidx/camera/camera2/internal/compat/lqubyxtgks;
    .locals 2

    new-instance v0, Landroidx/camera/camera2/internal/compat/lqubyxtgks;
    ...
    invoke-direct {v0, p0, v1}, Landroidx/camera/camera2/internal/compat/lqubyxtgks;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
# virtual methods
.method extxjewlhp(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public feyxvdiekx(Landroidx/camera/camera2/internal/compat/params/lohkmxcimj;)V
    ...
    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->nhdortzefg(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iget-object v1, p0, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->feyxvdiekx:Ljava/lang/Object;

    check-cast v1, Landroidx/camera/camera2/internal/compat/lqubyxtgks$qfzjddwuyn;

    iget-object v2, p0, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->qfzjddwuyn:Landroid/hardware/camera2/CameraDevice;

    iget-object v1, v1, Landroidx/camera/camera2/internal/compat/lqubyxtgks$qfzjddwuyn;->qfzjddwuyn:Landroid/os/Handler;

    invoke-virtual {p0, v2, p1, v0, v1}, Landroidx/camera/camera2/internal/compat/lqubyxtgks;->extxjewlhp(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
...
.method public qfzjddwuyn()Landroid/hardware/camera2/CameraDevice;
    .locals 1
