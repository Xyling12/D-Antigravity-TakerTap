.class public final Landroidx/camera/video/internal/khjnvckbwi;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field private static final feyxvdiekx:Ljava/lang/String; = "[CodecCaps] "

.field private static final ibzphkbtmt:Ljava/lang/String; = "[AudioCaps] "

.field private static final khjnvckbwi:Ljava/lang/String; = "[VideoCaps] "

.field private static final qfzjddwuyn:Ljava/lang/String; = "DebugUtils"

.field private static final qhoahqxrkc:Ljava/lang/String; = "[EncoderCaps] "
...
.method public static bveuzccgjl(J)Ljava/lang/String;
    .locals 1
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/internal/khjnvckbwi;->rmnxkaltsn(J)Ljava/lang/String;
...
.method private static drkbbjxjkt(J)Ljava/lang/String;
    .locals 11
...
.method private static extxjewlhp(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$EncoderCapabilities;Landroid/media/MediaFormat;)V
    .locals 2
    ...
    invoke-static {p0, v0}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Landroidx/camera/video/internal/compat/ibzphkbtmt;->qfzjddwuyn(Landroid/media/MediaCodecInfo$EncoderCapabilities;)Landroid/util/Range;
    ...
    invoke-static {p0, p1}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    :try_end_0
...
.method public static ibzphkbtmt(Ljava/lang/String;Landroid/media/MediaCodec;Landroid/media/MediaFormat;)Ljava/lang/String;
    .locals 3
    ...
    invoke-static {v0, v1, p2}, Landroidx/camera/video/internal/khjnvckbwi;->qhoahqxrkc(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$CodecCapabilities;Landroid/media/MediaFormat;)V
    :try_end_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, p0}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private static kgyfkythat(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$VideoCapabilities;Landroid/media/MediaFormat;)V
    .locals 9
    ...
    :goto_0
    invoke-static {v4}, Landroidx/core/util/thjjozpxyz;->qfzjddwuyn(Z)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/IllegalArgumentException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {p0, v2}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {p0, v7}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-static {p0, p2}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private static khjnvckbwi(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$AudioCapabilities;Landroid/media/MediaFormat;)V
    .locals 2
    ...
    invoke-static {p1}, Landroidx/camera/video/internal/compat/extxjewlhp;->feyxvdiekx(Landroid/media/MediaCodecInfo$AudioCapabilities;)I
    ...
    invoke-static {p1}, Landroidx/camera/video/internal/compat/extxjewlhp;->qfzjddwuyn(Landroid/media/MediaCodecInfo$AudioCapabilities;)[Landroid/util/Range;
...
.method private static ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    .locals 0
...
.method private static lohkmxcimj(Landroid/media/MediaCodecInfo$CodecProfileLevel;)Ljava/lang/String;
    .locals 1
...
.method public static lsvcqaryex(Landroid/media/MediaCodec$BufferInfo;)Ljava/lang/String;
    .locals 5
...
.method public static nhdortzefg(Landroid/media/MediaCodecList;Landroid/media/MediaFormat;)Ljava/lang/String;
    .locals 10
    ...
    invoke-static {v1, v2}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    :goto_1
    :try_start_0
    invoke-static {v8}, Landroidx/core/util/thjjozpxyz;->qfzjddwuyn(Z)V
    ...
    :goto_2
    invoke-static {v7}, Landroidx/core/util/thjjozpxyz;->qfzjddwuyn(Z)V
    ...
    invoke-static {v1, v7}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    invoke-static {v1, v8, p1}, Landroidx/camera/video/internal/khjnvckbwi;->qhoahqxrkc(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$CodecCapabilities;Landroid/media/MediaFormat;)V
    ...
    invoke-static {v1, v6}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    invoke-static {v1, p0}, Landroidx/camera/video/internal/khjnvckbwi;->ktvtxjqbtt(Ljava/lang/StringBuilder;Ljava/lang/String;)V

    invoke-virtual {v1}, Ljava/lang/StringBuilder;->toString()Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Landroidx/camera/video/internal/khjnvckbwi;->thjjozpxyz(Ljava/lang/String;)V

    return-object p0
.end method

.method public static qfzjddwuyn(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    .locals 2
    ...
    invoke-static {v1}, Landroidx/camera/video/internal/khjnvckbwi;->feyxvdiekx([B)Ljava/lang/String;
...
.method private static qhoahqxrkc(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$CodecCapabilities;Landroid/media/MediaFormat;)V
    .locals 6
    ...
    invoke-static {v5}, Landroidx/camera/video/internal/khjnvckbwi;->lohkmxcimj(Landroid/media/MediaCodecInfo$CodecProfileLevel;)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p2}, Landroidx/camera/video/internal/khjnvckbwi;->kgyfkythat(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$VideoCapabilities;Landroid/media/MediaFormat;)V
    ...
    invoke-static {p0, v0, p2}, Landroidx/camera/video/internal/khjnvckbwi;->khjnvckbwi(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$AudioCapabilities;Landroid/media/MediaFormat;)V
    ...
    invoke-static {p0, p1, p2}, Landroidx/camera/video/internal/khjnvckbwi;->extxjewlhp(Ljava/lang/StringBuilder;Landroid/media/MediaCodecInfo$EncoderCapabilities;Landroid/media/MediaFormat;)V

    :cond_5
    return-void
.end method

.method public static rmnxkaltsn(J)Ljava/lang/String;
    .locals 0

    invoke-static {p0, p1}, Landroidx/camera/video/internal/khjnvckbwi;->drkbbjxjkt(J)Ljava/lang/String;
...
.method private static thjjozpxyz(Ljava/lang/String;)V
    .locals 2

    const-string v0, "DebugUtils"

    invoke-static {v0}, Landroidx/camera/core/eeoxvijxqb;->tthmnequln(Ljava/lang/String;)Z
    ...
    invoke-static {v0, p0}, Landroidx/camera/core/eeoxvijxqb;->extxjewlhp(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static tthmnequln(Landroid/media/MediaFormat;)Ljava/lang/String;
    .locals 5
    ...
    invoke-static {v1}, Landroidx/camera/video/internal/khjnvckbwi;->qfzjddwuyn(Ljava/nio/ByteBuffer;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/camera/video/internal/khjnvckbwi;->qfzjddwuyn(Ljava/nio/ByteBuffer;)Ljava/lang/String;
