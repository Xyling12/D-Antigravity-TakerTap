.class Landroidx/camera/core/impl/compat/feyxvdiekx;
...
.method private static feyxvdiekx(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static/range {v2 .. v7}, Landroidx/camera/core/impl/skopevfyym$qfzjddwuyn;->qfzjddwuyn(ILjava/lang/String;IIII)Landroidx/camera/core/impl/skopevfyym$qfzjddwuyn;
...
.method private static khjnvckbwi(Ljava/util/List;)Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v2 .. v11}, Landroidx/camera/core/impl/skopevfyym$khjnvckbwi;->qfzjddwuyn(ILjava/lang/String;IIIIIIII)Landroidx/camera/core/impl/skopevfyym$khjnvckbwi;
...
.method public static qfzjddwuyn(Landroid/media/EncoderProfiles;)Landroidx/camera/core/impl/skopevfyym;
    .locals 3
    ...
    invoke-static {v2}, Landroidx/camera/core/impl/compat/feyxvdiekx;->feyxvdiekx(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/compat/feyxvdiekx;->khjnvckbwi(Ljava/util/List;)Ljava/util/List;
