...
.field private static final synthetic cbsxzgznvp:[Landroidx/constraintlayout/solver/state/State$Chain;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Landroidx/constraintlayout/solver/state/State$Chain;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Landroidx/constraintlayout/solver/state/State$Chain;

    const-string v3, "PACKED"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Landroidx/constraintlayout/solver/state/State$Chain;-><init>(Ljava/lang/String;I)V

    sput-object v2, Landroidx/constraintlayout/solver/state/State$Chain;->PACKED:Landroidx/constraintlayout/solver/state/State$Chain;

    filled-new-array {v0, v1, v2}, [Landroidx/constraintlayout/solver/state/State$Chain;

    move-result-object v0

    sput-object v0, Landroidx/constraintlayout/solver/state/State$Chain;->cbsxzgznvp:[Landroidx/constraintlayout/solver/state/State$Chain;
...
.method public static values()[Landroidx/constraintlayout/solver/state/State$Chain;
    ...
    sget-object v0, Landroidx/constraintlayout/solver/state/State$Chain;->cbsxzgznvp:[Landroidx/constraintlayout/solver/state/State$Chain;
