.class Landroid/support/v4/media/session/MediaSessionCompat$nhdortzefg;
.super Landroid/support/v4/media/session/MediaSessionCompat$extxjewlhp;
.source "SourceFile"
...
.method constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/v4/media/session/MediaSessionCompat$extxjewlhp;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method czxichccep(J)I
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$extxjewlhp;->czxichccep(J)I
...
.method public extxjewlhp(Landroid/support/v4/media/session/MediaSessionCompat$ibzphkbtmt;Landroid/os/Handler;)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$extxjewlhp;->extxjewlhp(Landroid/support/v4/media/session/MediaSessionCompat$ibzphkbtmt;Landroid/os/Handler;)V
    ...
    :cond_0
    new-instance p1, Landroid/support/v4/media/session/MediaSessionCompat$nhdortzefg$qfzjddwuyn;

    invoke-direct {p1, p0}, Landroid/support/v4/media/session/MediaSessionCompat$nhdortzefg$qfzjddwuyn;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$nhdortzefg;)V
...
.method feyxvdiekx(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$tthmnequln;->feyxvdiekx(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    :cond_0
    invoke-virtual {v1}, Landroid/support/v4/media/session/PlaybackStateCompat;->feyxvdiekx()J
