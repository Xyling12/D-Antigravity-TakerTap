...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public constructor <init>(Lokio/strivszpdp;)V
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/bveuzccgjl;)I
    ...
    .line 29
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lokio/bveuzccgjl;)Ljava/util/List;
...
.method private final readCertificateList(Lokio/bveuzccgjl;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lokio/bveuzccgjl;)I
    ...
    invoke-interface {p1}, Lokio/bveuzccgjl;->Q()Ljava/lang/String;

    move-result-object v4

    new-instance v5, Lokio/lsvcqaryex;

    invoke-direct {v5}, Lokio/lsvcqaryex;-><init>()V

    sget-object v6, Lokio/ByteString;->Companion:Lokio/ByteString$qfzjddwuyn;

    invoke-virtual {v6, v4}, Lokio/ByteString$qfzjddwuyn;->kgyfkythat(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v4

    invoke-static {v4}, Lkotlin/jvm/internal/erplbhbeyt;->rmnxkaltsn(Ljava/lang/Object;)V

    invoke-virtual {v5, v4}, Lokio/lsvcqaryex;->N(Lokio/ByteString;)Lokio/lsvcqaryex;

    invoke-virtual {v5}, Lokio/lsvcqaryex;->B3()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/rmnxkaltsn;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;
    ...
    invoke-static/range {v2 .. v7}, Lokio/ByteString$qfzjddwuyn;->lohkmxcimj(Lokio/ByteString$qfzjddwuyn;[BIIILjava/lang/Object;)Lokio/ByteString;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/klvawbfmro;
    ...
    invoke-interface {p1, v3, v4}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v6}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v6

    invoke-interface {v6, v4}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v4, v3}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v3

    invoke-interface {v3, v2}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v5, v6}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v5}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v5

    invoke-interface {v5, v4}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v5, v0}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v0, v5, v6}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v2}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lokio/rmnxkaltsn;Ljava/util/List;)V
