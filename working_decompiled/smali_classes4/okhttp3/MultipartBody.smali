...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method private final writeOrCountBytes(Lokio/rmnxkaltsn;Z)J
    .locals 13
    ...
    invoke-interface {p1, v8}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v8}, Lokio/rmnxkaltsn;->U2(Lokio/ByteString;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v11}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v11

    sget-object v12, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v11, v12}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v11, v9}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v9

    sget-object v11, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v11}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v8}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v8, v7}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v9}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, v9}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
    ...
    :cond_5
    invoke-virtual {v5, p1}, Lokhttp3/RequestBody;->writeTo(Lokio/rmnxkaltsn;)V
    ...
    invoke-interface {p1, v1}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {p1, v2}, Lokio/rmnxkaltsn;->U2(Lokio/ByteString;)Lokio/rmnxkaltsn;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/rmnxkaltsn;Z)J
...
.method public writeTo(Lokio/rmnxkaltsn;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lokio/rmnxkaltsn;Z)J
