...
.field private sink:Lokio/rmnxkaltsn;
    .annotation build Ld6/lsvcqaryex;
    .end annotation
.end field
...
.field private source:Lokio/bveuzccgjl;
    .annotation build Ld6/lsvcqaryex;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lokio/fdbcgriwfo;->opauvyugnb(Ljava/net/Socket;)Lokio/strivszpdp;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;

    invoke-static {v1}, Lokio/fdbcgriwfo;->ewnfwzyokr(Ljava/net/Socket;)Lokio/klvawbfmro;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/rmnxkaltsn;
    :try_end_1
    ...
    invoke-static {p4, p3}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1, v2, v6, v2}, Lkotlin/text/lohkmxcimj;->pednzybqgd(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Ls3/qfzjddwuyn;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Ls3/qfzjddwuyn;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/rmnxkaltsn;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;

    invoke-static {v0}, Lkotlin/jvm/internal/erplbhbeyt;->rmnxkaltsn(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/rmnxkaltsn;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/bveuzccgjl;Lokio/rmnxkaltsn;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, Lokio/dyeavzhfro;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/dyeavzhfro;
    ...
    invoke-static {v2, p3, v1}, Lkotlin/text/lohkmxcimj;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {p3, p2}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lokio/lsvcqaryex;->w1()Z
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lokio/bveuzccgjl;Lokio/rmnxkaltsn;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v8, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;

    iput-object v8, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/rmnxkaltsn;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lokio/bveuzccgjl;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lokio/bveuzccgjl;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, Lokio/strivszpdp;->timeout()Lokio/dyeavzhfro;
    ...
    invoke-virtual {v0, v3, v4, v5}, Lokio/dyeavzhfro;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/dyeavzhfro;
    ...
    invoke-direct {p2, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/bveuzccgjl;Lokio/rmnxkaltsn;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokio/bveuzccgjl;Lokio/rmnxkaltsn;Lokhttp3/internal/connection/Exchange;)V
