...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v4, v5}, Lkotlin/text/lohkmxcimj;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4, v2}, Lokio/lsvcqaryex;->S2(Ljava/lang/String;)Lokio/lsvcqaryex;

    move-result-object v2

    :try_start_0
    invoke-static {v2, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lokio/lsvcqaryex;Ljava/util/List;)V
    :try_end_0
...
.method public static final promisesBody(Lokhttp3/Response;)Z
    ...
    invoke-static {v0, p0, v3}, Lkotlin/text/lohkmxcimj;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final readChallengeHeader(Lokio/lsvcqaryex;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Lokio/lsvcqaryex;)Z

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lokio/lsvcqaryex;)Ljava/lang/String;
    ...
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Lokio/lsvcqaryex;B)I
    ...
    invoke-static {v4, v5}, Lkotlin/text/lohkmxcimj;->l0(Ljava/lang/CharSequence;I)Ljava/lang/String;

    move-result-object v4

    invoke-static {v3, v4}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0, v6}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Lokio/lsvcqaryex;B)Z

    move-result v6

    if-eqz v6, :cond_a

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lokio/lsvcqaryex;)Ljava/lang/String;
...
.method private static final readQuotedString(Lokio/lsvcqaryex;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    invoke-virtual {p0, v2}, Lokio/lsvcqaryex;->bayimxdfur(Lokio/ByteString;)J
    ...
    invoke-virtual {v0, p0, v2, v3}, Lokio/lsvcqaryex;->write(Lokio/lsvcqaryex;J)V
    ...
    invoke-virtual {v0, p0, v8, v9}, Lokio/lsvcqaryex;->write(Lokio/lsvcqaryex;J)V
...
.method private static final readToken(Lokio/lsvcqaryex;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lokio/ByteString;

    invoke-virtual {p0, v0}, Lokio/lsvcqaryex;->bayimxdfur(Lokio/ByteString;)J
...
.method private static final skipCommasAndWhitespace(Lokio/lsvcqaryex;)Z
    .locals 3
...
.method private static final startsWith(Lokio/lsvcqaryex;B)Z
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Lokio/lsvcqaryex;->lqubyxtgks(J)B
