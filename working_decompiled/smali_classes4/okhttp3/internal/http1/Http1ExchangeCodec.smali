...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lokio/bveuzccgjl;Lokio/rmnxkaltsn;)V
    .locals 1
    ...
    .param p2    # Lokhttp3/internal/connection/RealConnection;
        ...
        .end annotation
    .end param
    .param p3    # Lokio/bveuzccgjl;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .param p4    # Lokio/rmnxkaltsn;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokio/bveuzccgjl;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/rmnxkaltsn;

    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lokio/bveuzccgjl;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/czxichccep;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(Lokio/czxichccep;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/rmnxkaltsn;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/rmnxkaltsn;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lokio/bveuzccgjl;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lokio/bveuzccgjl;
...
.method private final detachTimeout(Lokio/czxichccep;)V
    .locals 2

    invoke-virtual {p1}, Lokio/czxichccep;->qfzjddwuyn()Lokio/dyeavzhfro;

    move-result-object v0

    sget-object v1, Lokio/dyeavzhfro;->NONE:Lokio/dyeavzhfro;

    invoke-virtual {p1, v1}, Lokio/czxichccep;->feyxvdiekx(Lokio/dyeavzhfro;)Lokio/czxichccep;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v1, p1, v0}, Lkotlin/text/lohkmxcimj;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lokio/klvawbfmro;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/strivszpdp;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/strivszpdp;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/klvawbfmro;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/strivszpdp;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/klvawbfmro;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/klvawbfmro;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/klvawbfmro;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/rmnxkaltsn;
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/strivszpdp;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)Lokio/strivszpdp;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/strivszpdp;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()Lokio/strivszpdp;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokio/strivszpdp;ILjava/util/concurrent/TimeUnit;)Z

    invoke-interface {p1}, Lokio/strivszpdp;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/rmnxkaltsn;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v4}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    invoke-interface {v3, v1}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;

    move-result-object v1

    invoke-interface {v1, v0}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
    ...
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/rmnxkaltsn;

    invoke-interface {p1, v0}, Lokio/rmnxkaltsn;->s(Ljava/lang/String;)Lokio/rmnxkaltsn;
