...
.field private static final UNICODE_BOMS:Lokio/nnapbkpnda;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lokio/nnapbkpnda;->thipomyfnm:Lokio/nnapbkpnda$qfzjddwuyn;

    sget-object v2, Lokio/ByteString;->Companion:Lokio/ByteString$qfzjddwuyn;

    const-string v3, "efbbbf"

    invoke-virtual {v2, v3}, Lokio/ByteString$qfzjddwuyn;->drkbbjxjkt(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v3

    const-string v4, "feff"

    invoke-virtual {v2, v4}, Lokio/ByteString$qfzjddwuyn;->drkbbjxjkt(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v4

    const-string v5, "fffe"

    invoke-virtual {v2, v5}, Lokio/ByteString$qfzjddwuyn;->drkbbjxjkt(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v5

    const-string v6, "0000ffff"

    invoke-virtual {v2, v6}, Lokio/ByteString$qfzjddwuyn;->drkbbjxjkt(Ljava/lang/String;)Lokio/ByteString;

    move-result-object v6

    const-string v7, "ffff0000"

    invoke-virtual {v2, v7}, Lokio/ByteString$qfzjddwuyn;->drkbbjxjkt(Ljava/lang/String;)Lokio/ByteString;
    ...
    invoke-virtual {v1, v2}, Lokio/nnapbkpnda$qfzjddwuyn;->ibzphkbtmt([Lokio/ByteString;)Lokio/nnapbkpnda;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/nnapbkpnda;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    new-instance v0, Ly4/qfzjddwuyn;

    invoke-direct {v0, p0}, Ly4/qfzjddwuyn;-><init>(Lokhttp3/EventListener;)V
...
.method public static final checkDuration(Ljava/lang/String;JLjava/util/concurrent/TimeUnit;)I
    ...
    invoke-static {p0, p1}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public static final concat([Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p0}, Lkotlin/collections/tthmnequln;->Ac([Ljava/lang/Object;)I
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v1, v4, v2, v3}, Lkotlin/text/lohkmxcimj;->Z0(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(Lokio/strivszpdp;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(Lokio/strivszpdp;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static synthetic feyxvdiekx(Lokhttp3/EventListener;Lokhttp3/Call;)Lokhttp3/EventListener;
    .locals 0
...
.method public static final filterList(Ljava/lang/Iterable;Ls3/lsvcqaryex;)Ljava/util/List;
    .locals 3
...
.method public static final ignoreIoExceptions(Ls3/qfzjddwuyn;)V
    .locals 1
...
.method public static final indexOfControlOrNonAscii(Ljava/lang/String;)I
    ...
    invoke-static {v3, v4}, Lkotlin/jvm/internal/erplbhbeyt;->vlnjtcdbbq(II)I
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/klvawbfmro;
...
.method public static final isHealthy(Ljava/net/Socket;Lokio/bveuzccgjl;)Z
    .locals 2
    .param p0    # Ljava/net/Socket;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-interface {p1}, Lokio/bveuzccgjl;->w1()Z
...
.method public static final isSensitiveHeader(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, Lkotlin/text/lohkmxcimj;->S(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static synthetic qfzjddwuyn(Ljava/lang/String;ZLjava/lang/Runnable;)Ljava/lang/Thread;
    .locals 0
...
.method public static final readBomAsCharset(Lokio/bveuzccgjl;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lokio/nnapbkpnda;

    invoke-interface {p0, v0}, Lokio/bveuzccgjl;->C3(Lokio/nnapbkpnda;)I
    ...
    sget-object p0, Lkotlin/text/ibzphkbtmt;->qfzjddwuyn:Lkotlin/text/ibzphkbtmt;

    invoke-virtual {p0}, Lkotlin/text/ibzphkbtmt;->khjnvckbwi()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, Lkotlin/text/ibzphkbtmt;->feyxvdiekx()Ljava/nio/charset/Charset;
...
.method public static final readMedium(Lokio/bveuzccgjl;)I
    .locals 3
    .param p0    # Lokio/bveuzccgjl;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
...
.method public static final skipAll(Lokio/lsvcqaryex;B)I
    .locals 3
    ...
    .line 14
    :goto_0
    invoke-virtual {p0}, Lokio/lsvcqaryex;->w1()Z
...
.method public static final skipAll(Lokio/strivszpdp;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .param p0    # Lokio/strivszpdp;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    .line 2
    invoke-interface {p0}, Lokio/strivszpdp;->timeout()Lokio/dyeavzhfro;

    move-result-object v2

    invoke-virtual {v2}, Lokio/dyeavzhfro;->hasDeadline()Z
    ...
    invoke-virtual {v2}, Lokio/dyeavzhfro;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, Lokio/dyeavzhfro;->deadlineNanoTime(J)Lokio/dyeavzhfro;
    ...
    .line 6
    invoke-interface {p0, p1, v7, v8}, Lokio/strivszpdp;->read(Lokio/lsvcqaryex;J)J
    ...
    invoke-virtual {p0}, Lokio/dyeavzhfro;->clearDeadline()Lokio/dyeavzhfro;
    ...
    invoke-virtual {p0, v0, v1}, Lokio/dyeavzhfro;->deadlineNanoTime(J)Lokio/dyeavzhfro;
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    new-instance v0, Ly4/feyxvdiekx;

    invoke-direct {v0, p0, p1}, Ly4/feyxvdiekx;-><init>(Ljava/lang/String;Z)V
...
.method public static final threadName(Ljava/lang/String;Ls3/qfzjddwuyn;)V
    .locals 2
    .param p0    # Ljava/lang/String;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
...
.method public static final toImmutableList(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {p0}, Lkotlin/collections/pednzybqgd;->c4(Ljava/util/Collection;)Ljava/util/List;
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, Lkotlin/thjjozpxyz;->qfzjddwuyn(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final writeMedium(Lokio/rmnxkaltsn;I)V
    .locals 1
    .param p0    # Lokio/rmnxkaltsn;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .annotation system Ldalvik/annotation/Throws;
    ...
    invoke-interface {p0, v0}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p0, p1}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;
