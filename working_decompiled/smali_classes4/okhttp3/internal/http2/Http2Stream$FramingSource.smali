...
.field private final readBuffer:Lokio/lsvcqaryex;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field

.field private final receiveBuffer:Lokio/lsvcqaryex;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Stream;JZ)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/lsvcqaryex;

    new-instance p1, Lokio/lsvcqaryex;

    invoke-direct {p1}, Lokio/lsvcqaryex;-><init>()V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokio/lsvcqaryex;
...
.method public close()V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Lokio/lsvcqaryex;
    ...
    invoke-virtual {v3}, Lokio/lsvcqaryex;->khjnvckbwi()V
...
.method public final getReadBuffer()Lokio/lsvcqaryex;
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->readBuffer:Lokio/lsvcqaryex;

    return-object v0
.end method

.method public final getReceiveBuffer()Lokio/lsvcqaryex;
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/lsvcqaryex;
...
.method public read(Lokio/lsvcqaryex;J)J
    ...
    invoke-virtual {v7}, Lokio/tthmnequln;->enter()V
    :try_end_0
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReadBuffer()Lokio/lsvcqaryex;
    ...
    invoke-virtual {v12}, Lokio/lsvcqaryex;->size()J
    ...
    invoke-virtual {v8, v0, v12, v13}, Lokio/lsvcqaryex;->read(Lokio/lsvcqaryex;J)J
    ...
    invoke-static {v0, v2}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public final receive$okhttp(Lokio/bveuzccgjl;J)V
    .locals 9
    ...
    :cond_4
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Stream$FramingSource;->receiveBuffer:Lokio/lsvcqaryex;

    invoke-interface {p1, v2, p2, p3}, Lokio/strivszpdp;->read(Lokio/lsvcqaryex;J)J
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream$FramingSource;->getReceiveBuffer()Lokio/lsvcqaryex;
    ...
    invoke-virtual {v5}, Lokio/lsvcqaryex;->khjnvckbwi()V
    ...
    invoke-virtual {v3, v4}, Lokio/lsvcqaryex;->E(Lokio/strivszpdp;)J
