...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public constructor <init>(Lokio/bveuzccgjl;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokio/bveuzccgjl;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lokio/strivszpdp;IIILkotlin/jvm/internal/pyxggrwgoy;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILokio/bveuzccgjl;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lokio/bveuzccgjl;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {p4}, Lokio/bveuzccgjl;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {v0}, Lokio/bveuzccgjl;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lokio/bveuzccgjl;->S0(J)Lokio/ByteString;
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {p2}, Lokio/bveuzccgjl;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {v3}, Lokio/bveuzccgjl;->readByte()B
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lkotlin/ranges/ldyhhegomq;->a0(II)Lkotlin/ranges/lsvcqaryex;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkotlin/ranges/ldyhhegomq;->F(Lkotlin/ranges/tthmnequln;I)Lkotlin/ranges/tthmnequln;
    ...
    invoke-virtual {p2}, Lkotlin/ranges/tthmnequln;->ktvtxjqbtt()I
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {v4}, Lokio/bveuzccgjl;->readShort()S
    ...
    iget-object v5, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lokio/bveuzccgjl;

    invoke-interface {v5}, Lokio/bveuzccgjl;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lokio/bveuzccgjl;)I
    ...
    invoke-static {v0, p2}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-interface {p1, v0, v1}, Lokio/bveuzccgjl;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v1, v2}, Lokio/bveuzccgjl;->S0(J)Lokio/ByteString;
    ...
    invoke-static {v1, p1}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
