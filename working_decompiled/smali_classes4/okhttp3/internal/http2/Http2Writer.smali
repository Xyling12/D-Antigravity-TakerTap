...
.field private final hpackBuffer:Lokio/lsvcqaryex;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public constructor <init>(Lokio/rmnxkaltsn;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Writer;->client:Z

    new-instance v4, Lokio/lsvcqaryex;

    invoke-direct {v4}, Lokio/lsvcqaryex;-><init>()V

    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/lsvcqaryex;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLokio/lsvcqaryex;ILkotlin/jvm/internal/pyxggrwgoy;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/lsvcqaryex;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lokio/rmnxkaltsn;->U2(Lokio/ByteString;)Lokio/rmnxkaltsn;
...
.method public final declared-synchronized data(ZILokio/lsvcqaryex;I)V
    .locals 1
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILokio/lsvcqaryex;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILokio/lsvcqaryex;I)V
    .locals 2
    .param p3    # Lokio/lsvcqaryex;
        .annotation build Ld6/lsvcqaryex;
        .end annotation
    ...
    invoke-interface {p1, p3, v0, v1}, Lokio/klvawbfmro;->write(Lokio/lsvcqaryex;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {p1, v5}, Lokhttp3/internal/Util;->writeMedium(Lokio/rmnxkaltsn;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    and-int/lit16 p2, v6, 0xff

    invoke-interface {p1, p2}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, p2}, Lokio/rmnxkaltsn;->writeInt(I)Lokio/rmnxkaltsn;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/rmnxkaltsn;->writeInt(I)Lokio/rmnxkaltsn;
    ...
    invoke-interface {p1, p3}, Lokio/rmnxkaltsn;->write([B)Lokio/rmnxkaltsn;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/lsvcqaryex;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/lsvcqaryex;

    invoke-interface {p1, v4, v2, v3}, Lokio/klvawbfmro;->write(Lokio/lsvcqaryex;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/rmnxkaltsn;->writeInt(I)Lokio/rmnxkaltsn;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Lokio/rmnxkaltsn;->writeInt(I)Lokio/rmnxkaltsn;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/lsvcqaryex;

    invoke-interface {p2, v2, v3, v4}, Lokio/klvawbfmro;->write(Lokio/lsvcqaryex;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    invoke-interface {v4, v3}, Lokio/rmnxkaltsn;->writeShort(I)Lokio/rmnxkaltsn;

    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lokio/rmnxkaltsn;

    invoke-virtual {p1, v2}, Lokhttp3/internal/http2/Settings;->get(I)I

    move-result v2

    invoke-interface {v3, v2}, Lokio/rmnxkaltsn;->writeInt(I)Lokio/rmnxkaltsn;
...
.method public final declared-synchronized windowUpdate(IJ)V
    ...
    invoke-static {p1, p2}, Lkotlin/jvm/internal/erplbhbeyt;->jtuzwzphqf(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
