...
.method private final newSource(I)Lokio/strivszpdp;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/strivszpdp;
    ...
    invoke-direct {v0, p1, v1, p0}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokio/strivszpdp;Lokhttp3/internal/cache/DiskLruCache;Lokhttp3/internal/cache/DiskLruCache$Entry;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lokio/strivszpdp;
    ...
    check-cast v2, Lokio/strivszpdp;
...
.method public final writeLengths$okhttp(Lokio/rmnxkaltsn;)V
    .locals 6
    ...
    invoke-interface {p1, v5}, Lokio/rmnxkaltsn;->writeByte(I)Lokio/rmnxkaltsn;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lokio/rmnxkaltsn;->w0(J)Lokio/rmnxkaltsn;
