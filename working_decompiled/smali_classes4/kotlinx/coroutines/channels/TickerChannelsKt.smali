...
# direct methods
.method public static synthetic extxjewlhp(JJLkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/channels/TickerMode;ILjava/lang/Object;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 0
    ...
    :cond_2
    invoke-static/range {p0 .. p5}, Lkotlinx/coroutines/channels/TickerChannelsKt;->qhoahqxrkc(JJLkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/channels/TickerMode;)Lkotlinx/coroutines/channels/ReceiveChannel;
...
.method public static final synthetic feyxvdiekx(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static/range {p0 .. p5}, Lkotlinx/coroutines/channels/TickerChannelsKt;->ibzphkbtmt(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method private static final ibzphkbtmt(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 18
    ...
    invoke-direct {v1, v0}, Lkotlinx/coroutines/channels/TickerChannelsKt$fixedPeriodTicker$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast v3, Lkotlinx/coroutines/channels/cqwyelzfbm;
    ...
    :goto_1
    invoke-static/range {p2 .. p3}, Lkotlinx/coroutines/njmpchkvgz;->ibzphkbtmt(J)J
    ...
    invoke-static {v12, v13, v1}, Lkotlinx/coroutines/DelayKt;->feyxvdiekx(JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :goto_2
    invoke-static {v10, v11}, Lkotlinx/coroutines/njmpchkvgz;->ibzphkbtmt(J)J
    ...
    invoke-interface {v0, v3, v1}, Lkotlinx/coroutines/channels/cqwyelzfbm;->cbvdcosrqn(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v13, v14, v4, v5}, Lkotlin/ranges/ldyhhegomq;->opauvyugnb(JJ)J
    ...
    invoke-static {v4, v5}, Lkotlinx/coroutines/njmpchkvgz;->khjnvckbwi(J)J
    ...
    invoke-static {v4, v5, v1}, Lkotlinx/coroutines/DelayKt;->feyxvdiekx(JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v13, v14}, Lkotlinx/coroutines/njmpchkvgz;->khjnvckbwi(J)J
...
.method private static final khjnvckbwi(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(JJ",
    ...
    invoke-direct {v0, p5}, Lkotlinx/coroutines/channels/TickerChannelsKt$fixedDelayTicker$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast p2, Lkotlinx/coroutines/channels/cqwyelzfbm;
    ...
    check-cast p4, Lkotlinx/coroutines/channels/cqwyelzfbm;
    ...
    invoke-static {p2, p3, v0}, Lkotlinx/coroutines/DelayKt;->feyxvdiekx(JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-interface {p4, p2, v0}, Lkotlinx/coroutines/channels/cqwyelzfbm;->cbvdcosrqn(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1, v0}, Lkotlinx/coroutines/DelayKt;->feyxvdiekx(JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic qfzjddwuyn(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static/range {p0 .. p5}, Lkotlinx/coroutines/channels/TickerChannelsKt;->khjnvckbwi(JJLkotlinx/coroutines/channels/cqwyelzfbm;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final qhoahqxrkc(JJLkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/channels/TickerMode;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 8
    ...
    invoke-virtual {v1, p4}, Lkotlin/coroutines/qfzjddwuyn;->plus(Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;
    ...
    invoke-direct/range {v1 .. v7}, Lkotlinx/coroutines/channels/TickerChannelsKt$ticker$3;-><init>(Lkotlinx/coroutines/channels/TickerMode;JJLkotlin/coroutines/khjnvckbwi;)V

    const/4 p0, 0x0

    invoke-static {v0, p4, p0, v1}, Lkotlinx/coroutines/channels/ProduceKt;->nhdortzefg(Lkotlinx/coroutines/oltojwzksj;Lkotlin/coroutines/CoroutineContext;ILs3/lohkmxcimj;)Lkotlinx/coroutines/channels/ReceiveChannel;
