...
# instance fields
.field private final ekiqcarcrq:Ljava/lang/ThreadLocal;
...
.method public constructor <init>(Lkotlin/coroutines/CoroutineContext;Lkotlin/coroutines/khjnvckbwi;)V
    ...
    :goto_0
    invoke-direct {p0, v0, p2}, Lkotlinx/coroutines/internal/ffafdrhafs;-><init>(Lkotlin/coroutines/CoroutineContext;Lkotlin/coroutines/khjnvckbwi;)V

    new-instance v0, Ljava/lang/ThreadLocal;

    invoke-direct {v0}, Ljava/lang/ThreadLocal;-><init>()V

    iput-object v0, p0, Lkotlinx/coroutines/u;->ekiqcarcrq:Ljava/lang/ThreadLocal;
    ...
    instance-of p2, p2, Lkotlinx/coroutines/vrjnqucdkj;

    if-nez p2, :cond_1

    const/4 p2, 0x0

    invoke-static {p1, p2}, Lkotlinx/coroutines/internal/vqxedydgmu;->drkbbjxjkt(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p2

    invoke-static {p1, p2}, Lkotlinx/coroutines/internal/vqxedydgmu;->extxjewlhp(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)V
...
.method protected d0(Ljava/lang/Object;)V
    ...
    iget-boolean v0, p0, Lkotlinx/coroutines/u;->threadLocalIsSet:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lkotlinx/coroutines/u;->ekiqcarcrq:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/vqxedydgmu;->drkbbjxjkt(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    sget-object v4, Lkotlinx/coroutines/internal/vqxedydgmu;->qfzjddwuyn:Lkotlinx/coroutines/internal/epwdywcysm;

    if-eq v3, v4, :cond_2

    invoke-static {v0, v1, v3}, Lkotlinx/coroutines/fdbcgriwfo;->rmnxkaltsn(Lkotlin/coroutines/khjnvckbwi;Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)Lkotlinx/coroutines/u;
    ...
    invoke-virtual {v2}, Lkotlinx/coroutines/u;->i0()Z
    ...
    :cond_4
    :goto_0
    invoke-static {v1, v3}, Lkotlinx/coroutines/internal/vqxedydgmu;->extxjewlhp(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)V
...
.method public final i0()Z
    ...
    :goto_0
    iget-object v2, p0, Lkotlinx/coroutines/u;->ekiqcarcrq:Ljava/lang/ThreadLocal;
...
.method public final j0(Lkotlin/coroutines/CoroutineContext;Ljava/lang/Object;)V
    ...
    iput-boolean v0, p0, Lkotlinx/coroutines/u;->threadLocalIsSet:Z
