...
# direct methods
.method public static final extxjewlhp(Lkotlinx/coroutines/channels/ReceiveChannel;)Lkotlinx/coroutines/flow/qhoahqxrkc;
    .locals 8
...
.method public static final feyxvdiekx(Lkotlinx/coroutines/channels/ReceiveChannel;)Lkotlinx/coroutines/flow/qhoahqxrkc;
    .locals 8
    .param p0    # Lkotlinx/coroutines/channels/ReceiveChannel;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
...
.method private static final ibzphkbtmt(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p3}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt$emitAllImpl$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-static {p0}, Lkotlinx/coroutines/flow/nhdortzefg;->ekiqcarcrq(Lkotlinx/coroutines/flow/extxjewlhp;)V
    ...
    invoke-interface {p3, v0}, Lkotlinx/coroutines/channels/ChannelIterator;->feyxvdiekx(Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-interface {v2, p3, v0}, Lkotlinx/coroutines/flow/extxjewlhp;->emit(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final khjnvckbwi(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlinx/coroutines/channels/ReceiveChannel;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p0, p1, v0, p2}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt;->ibzphkbtmt(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic qfzjddwuyn(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lkotlinx/coroutines/flow/FlowKt__ChannelsKt;->ibzphkbtmt(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlinx/coroutines/channels/ReceiveChannel;ZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final qhoahqxrkc(Lkotlinx/coroutines/flow/qhoahqxrkc;Lkotlinx/coroutines/oltojwzksj;)Lkotlinx/coroutines/channels/ReceiveChannel;
    .locals 0
    ...
    invoke-static {p0}, Lkotlinx/coroutines/flow/internal/ibzphkbtmt;->feyxvdiekx(Lkotlinx/coroutines/flow/qhoahqxrkc;)Lkotlinx/coroutines/flow/internal/ChannelFlow;

    move-result-object p0

    invoke-virtual {p0, p1}, Lkotlinx/coroutines/flow/internal/ChannelFlow;->bveuzccgjl(Lkotlinx/coroutines/oltojwzksj;)Lkotlinx/coroutines/channels/ReceiveChannel;
