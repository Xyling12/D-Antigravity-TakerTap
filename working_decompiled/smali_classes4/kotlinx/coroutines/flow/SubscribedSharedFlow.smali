...
# instance fields
.field private final cbsxzgznvp:Lkotlinx/coroutines/flow/vlnjtcdbbq;
...
# direct methods
.method public constructor <init>(Lkotlinx/coroutines/flow/vlnjtcdbbq;Ls3/lohkmxcimj;)V
    .locals 0
    ...
    iput-object p1, p0, Lkotlinx/coroutines/flow/SubscribedSharedFlow;->cbsxzgznvp:Lkotlinx/coroutines/flow/vlnjtcdbbq;

    iput-object p2, p0, Lkotlinx/coroutines/flow/SubscribedSharedFlow;->xglnwpaccw:Ls3/lohkmxcimj;
...
.method public khjnvckbwi()Ljava/util/List;
    ...
    iget-object v0, p0, Lkotlinx/coroutines/flow/SubscribedSharedFlow;->cbsxzgznvp:Lkotlinx/coroutines/flow/vlnjtcdbbq;
...
.method public qfzjddwuyn(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, Lkotlinx/coroutines/flow/SubscribedSharedFlow$collect$1;-><init>(Lkotlinx/coroutines/flow/SubscribedSharedFlow;Lkotlin/coroutines/khjnvckbwi;)V
    ...
    iget-object p2, p0, Lkotlinx/coroutines/flow/SubscribedSharedFlow;->cbsxzgznvp:Lkotlinx/coroutines/flow/vlnjtcdbbq;

    new-instance v2, Lkotlinx/coroutines/flow/SubscribedFlowCollector;

    iget-object v4, p0, Lkotlinx/coroutines/flow/SubscribedSharedFlow;->xglnwpaccw:Ls3/lohkmxcimj;

    invoke-direct {v2, p1, v4}, Lkotlinx/coroutines/flow/SubscribedFlowCollector;-><init>(Lkotlinx/coroutines/flow/extxjewlhp;Ls3/lohkmxcimj;)V

    iput v3, v0, Lkotlinx/coroutines/flow/SubscribedSharedFlow$collect$1;->label:I

    invoke-interface {p2, v2, v0}, Lkotlinx/coroutines/flow/vlnjtcdbbq;->qfzjddwuyn(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
