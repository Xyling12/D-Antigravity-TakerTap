...
# static fields
.field public static final khjnvckbwi:Lkotlinx/serialization/internal/z;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/serialization/internal/z;->khjnvckbwi:Lkotlinx/serialization/internal/z;
...
.method private constructor <init>()V
    ...
    sget-object v0, Lkotlin/nnzwevhkoa;->xglnwpaccw:Lkotlin/nnzwevhkoa$qfzjddwuyn;

    invoke-static {v0}, Lx4/qfzjddwuyn;->cqwyelzfbm(Lkotlin/nnzwevhkoa$qfzjddwuyn;)Lkotlinx/serialization/drkbbjxjkt;
...
.method public bridge synthetic bdweufyeak(Lkotlinx/serialization/encoding/ibzphkbtmt;ILkotlinx/serialization/internal/synncqogho;Z)V
    ...
    check-cast p3, Lkotlinx/serialization/internal/y;

    invoke-virtual {p0, p1, p2, p3, p4}, Lkotlinx/serialization/internal/z;->jolohcwnyk(Lkotlinx/serialization/encoding/ibzphkbtmt;ILkotlinx/serialization/internal/y;Z)V
...
.method public bridge synthetic cqwyelzfbm(Lkotlinx/serialization/encoding/qhoahqxrkc;Ljava/lang/Object;I)V
    ...
    check-cast p2, Lkotlin/skopevfyym;

    invoke-virtual {p2}, Lkotlin/skopevfyym;->gcegooklax()[S

    move-result-object p2

    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/serialization/internal/z;->erplbhbeyt(Lkotlinx/serialization/encoding/qhoahqxrkc;[SI)V
...
.method protected erplbhbeyt(Lkotlinx/serialization/encoding/qhoahqxrkc;[SI)V
    ...
    invoke-static {p2, v0}, Lkotlin/skopevfyym;->thjjozpxyz([SI)S

    move-result v2

    invoke-interface {v1, v2}, Lkotlinx/serialization/encoding/kgyfkythat;->pednzybqgd(S)V
...
.method protected gcegooklax([S)Lkotlinx/serialization/internal/y;
    .locals 2
    .param p1    # [S
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-direct {v0, p1, v1}, Lkotlinx/serialization/internal/y;-><init>([SLkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public bridge synthetic jodmjjzdpr()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlinx/serialization/internal/z;->jtuzwzphqf()[S

    move-result-object v0

    invoke-static {v0}, Lkotlin/skopevfyym;->qhoahqxrkc([S)Lkotlin/skopevfyym;
...
.method protected jolohcwnyk(Lkotlinx/serialization/encoding/ibzphkbtmt;ILkotlinx/serialization/internal/y;Z)V
    .locals 0
    .param p1    # Lkotlinx/serialization/encoding/ibzphkbtmt;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .param p3    # Lkotlinx/serialization/internal/y;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    invoke-virtual {p3, p1}, Lkotlinx/serialization/internal/y;->qhoahqxrkc(S)V
...
.method public bridge synthetic lohkmxcimj(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lkotlinx/serialization/internal/z;->gcegooklax([S)Lkotlinx/serialization/internal/y;
...
.method public bridge synthetic tthmnequln(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lkotlinx/serialization/internal/z;->kedepleukr([S)I
