...
.field private static final synthetic cbsxzgznvp:[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;

.field private static final synthetic xglnwpaccw:Lkotlin/enums/qfzjddwuyn;


# instance fields
.field private final arrayClassId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field

.field private final classId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;->qhoahqxrkc(Ljava/lang/String;)Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
    ...
    invoke-direct {v0, v2, v3, v1}, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;-><init>(Ljava/lang/String;ILkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;)V
    ...
    invoke-static {}, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->khjnvckbwi()[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;

    move-result-object v0

    sput-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->cbsxzgznvp:[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;

    invoke-static {v0}, Lkotlin/enums/khjnvckbwi;->khjnvckbwi([Ljava/lang/Enum;)Lkotlin/enums/qfzjddwuyn;

    move-result-object v0

    sput-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->xglnwpaccw:Lkotlin/enums/qfzjddwuyn;

    return-void
.end method

.method private constructor <init>(Ljava/lang/String;ILkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->classId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;

    invoke-virtual {p3}, Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;->tthmnequln()Lkotlin/reflect/jvm/internal/impl/name/extxjewlhp;
    ...
    iput-object p1, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->typeName:Lkotlin/reflect/jvm/internal/impl/name/extxjewlhp;

    new-instance p2, Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;

    invoke-virtual {p3}, Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;->kgyfkythat()Lkotlin/reflect/jvm/internal/impl/name/khjnvckbwi;
    ...
    invoke-direct {p2, p3, p1}, Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;-><init>(Lkotlin/reflect/jvm/internal/impl/name/khjnvckbwi;Lkotlin/reflect/jvm/internal/impl/name/extxjewlhp;)V

    iput-object p2, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->arrayClassId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;

    return-void
.end method

.method private static final synthetic khjnvckbwi()[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;
    .locals 4
...
.method public static values()[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;
    ...
    sget-object v0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->cbsxzgznvp:[Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;
...
# virtual methods
.method public final getArrayClassId()Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->arrayClassId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;

    return-object v0
.end method

.method public final getClassId()Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->classId:Lkotlin/reflect/jvm/internal/impl/name/feyxvdiekx;
...
.method public final getTypeName()Lkotlin/reflect/jvm/internal/impl/name/extxjewlhp;
    ...
    iget-object v0, p0, Lkotlin/reflect/jvm/internal/impl/builtins/UnsignedType;->typeName:Lkotlin/reflect/jvm/internal/impl/name/extxjewlhp;
