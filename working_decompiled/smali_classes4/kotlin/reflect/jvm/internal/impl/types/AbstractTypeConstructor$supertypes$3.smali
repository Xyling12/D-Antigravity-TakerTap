...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    check-cast p1, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;

    invoke-virtual {p0, p1}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$supertypes$3;->invoke(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;)V
...
.method public final invoke(Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;)V
    .locals 7
    .param p1    # Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->ewnfwzyokr()Lkotlin/reflect/jvm/internal/impl/descriptors/epwdywcysm;
    ...
    invoke-virtual {p1}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;->qfzjddwuyn()Ljava/util/Collection;
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Lkotlin/reflect/jvm/internal/impl/descriptors/epwdywcysm;->qfzjddwuyn(Lkotlin/reflect/jvm/internal/impl/types/dyeavzhfro;Ljava/util/Collection;Ls3/lsvcqaryex;Ls3/lsvcqaryex;)Ljava/util/Collection;
    ...
    invoke-virtual {v0}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->rmnxkaltsn()Lkotlin/reflect/jvm/internal/impl/types/jolohcwnyk;
    ...
    invoke-virtual {v1}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->lohkmxcimj()Z
    ...
    invoke-virtual {v1}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->ewnfwzyokr()Lkotlin/reflect/jvm/internal/impl/descriptors/epwdywcysm;
    ...
    invoke-interface {v1, v3, v0, v4, v5}, Lkotlin/reflect/jvm/internal/impl/descriptors/epwdywcysm;->qfzjddwuyn(Lkotlin/reflect/jvm/internal/impl/types/dyeavzhfro;Ljava/util/Collection;Ls3/lsvcqaryex;Ls3/lsvcqaryex;)Ljava/util/Collection;
    ...
    :cond_5
    invoke-virtual {v1, v2}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor;->ldyhhegomq(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    .line 12
    invoke-virtual {p1, v0}, Lkotlin/reflect/jvm/internal/impl/types/AbstractTypeConstructor$qfzjddwuyn;->khjnvckbwi(Ljava/util/List;)V
