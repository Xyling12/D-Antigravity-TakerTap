.class public abstract Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;
...
.method private final nhdortzefg(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z
    .locals 1
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->hashCode()I
    ...
    :cond_3
    invoke-virtual {p0}, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->ibzphkbtmt()Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;
    ...
    :cond_4
    invoke-direct {p0, v0}, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->nhdortzefg(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-direct {p0, p1}, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->nhdortzefg(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z
    ...
    :cond_5
    invoke-virtual {p0, p1}, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->kgyfkythat(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z
...
.method protected final extxjewlhp(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z
    .locals 3
    .param p1    # Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .param p2    # Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    instance-of v2, p1, Lkotlin/reflect/jvm/internal/impl/descriptors/jolohcwnyk;

    if-eqz v2, :cond_1

    instance-of p1, p2, Lkotlin/reflect/jvm/internal/impl/descriptors/jolohcwnyk;

    return p1

    :cond_1
    instance-of v2, p2, Lkotlin/reflect/jvm/internal/impl/descriptors/jolohcwnyk;
    ...
    :cond_2
    instance-of v2, p1, Lkotlin/reflect/jvm/internal/impl/descriptors/noartptryl;

    if-eqz v2, :cond_4

    instance-of v2, p2, Lkotlin/reflect/jvm/internal/impl/descriptors/noartptryl;
...
.method public hashCode()I
    ...
    iget v0, p0, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->qfzjddwuyn:I
    ...
    :goto_0
    iput v0, p0, Lkotlin/reflect/jvm/internal/impl/types/ktvtxjqbtt;->qfzjddwuyn:I

    return v0
.end method

.method public abstract ibzphkbtmt()Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end method

.method protected abstract kgyfkythat(Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;)Z
    .param p1    # Lkotlin/reflect/jvm/internal/impl/descriptors/extxjewlhp;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
