...
.method constructor <init>(Lorg/chromium/net/DnsOptions$Builder;)V
    ...
    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->qfzjddwuyn(Lorg/chromium/net/DnsOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/DnsOptions;->mEnableStaleDns:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->qhoahqxrkc(Lorg/chromium/net/DnsOptions$Builder;)Lorg/chromium/net/DnsOptions$StaleDnsOptions;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/DnsOptions;->mStaleDnsOptions:Lorg/chromium/net/DnsOptions$StaleDnsOptions;

    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->khjnvckbwi(Lorg/chromium/net/DnsOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/DnsOptions;->mPersistHostCachePeriodMillis:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->ibzphkbtmt(Lorg/chromium/net/DnsOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/DnsOptions;->mPreestablishConnectionsToStaleDnsResults:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->extxjewlhp(Lorg/chromium/net/DnsOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/DnsOptions;->mUseBuiltInDnsResolver:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/DnsOptions$Builder;->feyxvdiekx(Lorg/chromium/net/DnsOptions$Builder;)Ljava/lang/Boolean;
