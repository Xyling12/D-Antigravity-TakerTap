...
.method public constructor <init>(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)V
    ...
    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->khjnvckbwi(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mEnableDefaultNetworkMigration:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->ibzphkbtmt(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mEnablePathDegradationMigration:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->feyxvdiekx(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mAllowServerMigration:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->drkbbjxjkt(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mMigrateIdleConnections:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->qhoahqxrkc(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mIdleMigrationPeriodSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->tthmnequln(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;
    ...
    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->qfzjddwuyn(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mAllowNonDefaultNetworkUsage:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->nhdortzefg(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mMaxTimeOnNonDefaultNetworkSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->kgyfkythat(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/ConnectionMigrationOptions;->mMaxWriteErrorEagerMigrationsCount:Ljava/lang/Integer;

    invoke-static {p1}, Lorg/chromium/net/ConnectionMigrationOptions$Builder;->extxjewlhp(Lorg/chromium/net/ConnectionMigrationOptions$Builder;)Ljava/lang/Integer;
