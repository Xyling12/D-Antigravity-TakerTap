.class final Lorg/chromium/net/ibzphkbtmt;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/chromium/net/ibzphkbtmt$qfzjddwuyn;
    }
.end annotation
...
.field private final khjnvckbwi:Lorg/chromium/net/ICronetEngineBuilder;

.field private qfzjddwuyn:Lorg/json/JSONObject;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/chromium/net/ibzphkbtmt;->ibzphkbtmt:Ljava/util/Set;
...
.method constructor <init>(Lorg/chromium/net/ICronetEngineBuilder;)V
    ...
    iput-object v0, p0, Lorg/chromium/net/ibzphkbtmt;->feyxvdiekx:Ljava/util/List;

    iput-object p1, p0, Lorg/chromium/net/ibzphkbtmt;->khjnvckbwi:Lorg/chromium/net/ICronetEngineBuilder;

    return-void
.end method

.method private static extxjewlhp(Ljava/lang/String;)Lorg/json/JSONObject;
    .locals 2
...
.method public static synthetic feyxvdiekx(Lorg/chromium/net/QuicOptions;Lorg/json/JSONObject;)V
    .locals 3

    const-string v0, "QUIC"

    invoke-static {p1, v0}, Lorg/chromium/net/ibzphkbtmt;->ibzphkbtmt(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
...
.method private static ibzphkbtmt(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
    .locals 3
...
.method public static synthetic khjnvckbwi(Lorg/chromium/net/DnsOptions;Lorg/json/JSONObject;)V
    .locals 4
...
.method public static synthetic qfzjddwuyn(Lorg/chromium/net/ConnectionMigrationOptions;Lorg/json/JSONObject;)V
    .locals 2
...
.method public addPublicKeyPins(Ljava/lang/String;Ljava/util/Set;ZLjava/util/Date;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    iget-object v0, p0, Lorg/chromium/net/ibzphkbtmt;->khjnvckbwi:Lorg/chromium/net/ICronetEngineBuilder;
...
.method public build()Lorg/chromium/net/ExperimentalCronetEngine;
    ...
    iget-object v0, p0, Lorg/chromium/net/ibzphkbtmt;->qfzjddwuyn:Lorg/json/JSONObject;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/chromium/net/ibzphkbtmt;->feyxvdiekx:Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/chromium/net/ibzphkbtmt;->qfzjddwuyn:Lorg/json/JSONObject;
    ...
    check-cast v1, Lorg/chromium/net/ibzphkbtmt$qfzjddwuyn;

    :try_start_0
    iget-object v2, p0, Lorg/chromium/net/ibzphkbtmt;->qfzjddwuyn:Lorg/json/JSONObject;

    invoke-interface {v1, v2}, Lorg/chromium/net/ibzphkbtmt$qfzjddwuyn;->qfzjddwuyn(Lorg/json/JSONObject;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v1, p0, Lorg/chromium/net/ibzphkbtmt;->qfzjddwuyn:Lorg/json/JSONObject;
...
.method protected getSupportedConfigOptions()Ljava/util/Set;
    ...
    sget-object v0, Lorg/chromium/net/ibzphkbtmt;->ibzphkbtmt:Ljava/util/Set;

    return-object v0
.end method

.method qhoahqxrkc()Lorg/chromium/net/ICronetEngineBuilder;
    .locals 1
...
.method public setConnectionMigrationOptions(Lorg/chromium/net/ConnectionMigrationOptions;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    new-instance v1, Lorg/chromium/net/feyxvdiekx;

    invoke-direct {v1, p1}, Lorg/chromium/net/feyxvdiekx;-><init>(Lorg/chromium/net/ConnectionMigrationOptions;)V
...
.method public setDnsOptions(Lorg/chromium/net/DnsOptions;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    new-instance v1, Lorg/chromium/net/qfzjddwuyn;

    invoke-direct {v1, p1}, Lorg/chromium/net/qfzjddwuyn;-><init>(Lorg/chromium/net/DnsOptions;)V
...
.method public setExperimentalOptions(Ljava/lang/String;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    :cond_0
    invoke-static {p1}, Lorg/chromium/net/ibzphkbtmt;->extxjewlhp(Ljava/lang/String;)Lorg/json/JSONObject;

    move-result-object p1

    iput-object p1, p0, Lorg/chromium/net/ibzphkbtmt;->qfzjddwuyn:Lorg/json/JSONObject;
...
.method public setQuicOptions(Lorg/chromium/net/QuicOptions;)Lorg/chromium/net/ICronetEngineBuilder;
    ...
    new-instance v1, Lorg/chromium/net/khjnvckbwi;

    invoke-direct {v1, p1}, Lorg/chromium/net/khjnvckbwi;-><init>(Lorg/chromium/net/QuicOptions;)V
