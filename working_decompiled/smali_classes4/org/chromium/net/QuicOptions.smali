...
.method constructor <init>(Lorg/chromium/net/QuicOptions$Builder;)V
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->lohkmxcimj(Lorg/chromium/net/QuicOptions$Builder;)Ljava/util/Set;
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->nhdortzefg(Lorg/chromium/net/QuicOptions$Builder;)Ljava/util/Set;
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->khjnvckbwi(Lorg/chromium/net/QuicOptions$Builder;)Ljava/util/Set;
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->qfzjddwuyn(Lorg/chromium/net/QuicOptions$Builder;)Ljava/util/Set;
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->lsvcqaryex(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mInMemoryServerConfigsCacheSize:Ljava/lang/Integer;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->tthmnequln(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mHandshakeUserAgent:Ljava/lang/String;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->pednzybqgd(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mRetryWithoutAltSvcOnQuicErrors:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->extxjewlhp(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mEnableTlsZeroRtt:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->thjjozpxyz(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mPreCryptoHandshakeIdleTimeoutSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->ibzphkbtmt(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mCryptoHandshakeTimeoutSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->ktvtxjqbtt(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mIdleConnectionTimeoutSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->ewnfwzyokr(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mRetransmittableOnWireTimeoutMillis:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->feyxvdiekx(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mCloseSessionsOnIpChange:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->drkbbjxjkt(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mGoawaySessionsOnIpChange:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->bveuzccgjl(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mInitialBrokenServicePeriodSeconds:Ljava/lang/Long;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->rmnxkaltsn(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;

    move-result-object v0

    iput-object v0, p0, Lorg/chromium/net/QuicOptions;->mIncreaseBrokenServicePeriodExponentially:Ljava/lang/Boolean;

    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->qhoahqxrkc(Lorg/chromium/net/QuicOptions$Builder;)Ljava/lang/Boolean;
    ...
    invoke-static {p1}, Lorg/chromium/net/QuicOptions$Builder;->kgyfkythat(Lorg/chromium/net/QuicOptions$Builder;)Ljava/util/Set;
