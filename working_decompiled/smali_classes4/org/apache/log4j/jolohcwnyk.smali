.class public Lorg/apache/log4j/jolohcwnyk;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-wide v0, p0, Lorg/apache/log4j/jolohcwnyk;->thjjozpxyz:J

    const/4 v0, 0x1

    .line 3
    iput v0, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I

    const-wide/16 v0, 0x0

    .line 4
    iput-wide v0, p0, Lorg/apache/log4j/jolohcwnyk;->ewnfwzyokr:J
...
.method public constructor <init>(Lorg/apache/log4j/ewnfwzyokr;Ljava/lang/String;)V
    ...
    .line 9
    invoke-direct {p0, p1, p2}, Lorg/apache/log4j/bveuzccgjl;-><init>(Lorg/apache/log4j/ewnfwzyokr;Ljava/lang/String;)V

    const-wide/32 p1, 0xa00000

    .line 10
    iput-wide p1, p0, Lorg/apache/log4j/jolohcwnyk;->thjjozpxyz:J

    const/4 p1, 0x1

    .line 11
    iput p1, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I

    const-wide/16 p1, 0x0

    .line 12
    iput-wide p1, p0, Lorg/apache/log4j/jolohcwnyk;->ewnfwzyokr:J
...
.method public constructor <init>(Lorg/apache/log4j/ewnfwzyokr;Ljava/lang/String;Z)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lorg/apache/log4j/bveuzccgjl;-><init>(Lorg/apache/log4j/ewnfwzyokr;Ljava/lang/String;Z)V
...
.method public cbvdcosrqn()I
    ...
    iget v0, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I
...
.method protected dyeavzhfro(Ljava/io/Writer;)V
    ...
    new-instance v0, Lorg/apache/log4j/helpers/khjnvckbwi;

    iget-object v1, p0, Lorg/apache/log4j/feyxvdiekx;->ibzphkbtmt:Lorg/apache/log4j/spi/qhoahqxrkc;

    invoke-direct {v0, p1, v1}, Lorg/apache/log4j/helpers/khjnvckbwi;-><init>(Ljava/io/Writer;Lorg/apache/log4j/spi/qhoahqxrkc;)V
...
.method public declared-synchronized myathtdxpy(Ljava/lang/String;ZZI)V
    ...
    :try_start_0
    iget-boolean p3, p0, Lorg/apache/log4j/bveuzccgjl;->rmnxkaltsn:Z

    iget p4, p0, Lorg/apache/log4j/bveuzccgjl;->bveuzccgjl:I

    invoke-super {p0, p1, p2, p3, p4}, Lorg/apache/log4j/bveuzccgjl;->myathtdxpy(Ljava/lang/String;ZZI)V
    ...
    check-cast p1, Lorg/apache/log4j/helpers/khjnvckbwi;

    invoke-virtual {p2}, Ljava/io/File;->length()J

    move-result-wide p2

    invoke-virtual {p1, p2, p3}, Lorg/apache/log4j/helpers/khjnvckbwi;->khjnvckbwi(J)V
    :try_end_0
...
.method protected nnapbkpnda(Lorg/apache/log4j/spi/LoggingEvent;)V
    ...
    iget-object p1, p0, Lorg/apache/log4j/bveuzccgjl;->lsvcqaryex:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lorg/apache/log4j/helpers/khjnvckbwi;->feyxvdiekx()J

    move-result-wide v0

    iget-wide v2, p0, Lorg/apache/log4j/jolohcwnyk;->thjjozpxyz:J

    cmp-long p1, v0, v2

    if-ltz p1, :cond_0

    iget-wide v2, p0, Lorg/apache/log4j/jolohcwnyk;->ewnfwzyokr:J

    cmp-long p1, v0, v2

    if-ltz p1, :cond_0

    invoke-virtual {p0}, Lorg/apache/log4j/jolohcwnyk;->rbnwhbktth()V
...
.method public pgglzjfpqi(Ljava/lang/String;)V
    ...
    iget-wide v0, p0, Lorg/apache/log4j/jolohcwnyk;->thjjozpxyz:J

    const-wide/16 v2, 0x1

    add-long/2addr v0, v2

    invoke-static {p1, v0, v1}, Lorg/apache/log4j/helpers/rmnxkaltsn;->lsvcqaryex(Ljava/lang/String;J)J
...
.method public rbnwhbktth()V
    ...
    check-cast v0, Lorg/apache/log4j/helpers/khjnvckbwi;

    invoke-virtual {v0}, Lorg/apache/log4j/helpers/khjnvckbwi;->feyxvdiekx()J
    ...
    iget v1, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I
    ...
    iget-object v4, p0, Lorg/apache/log4j/bveuzccgjl;->lsvcqaryex:Ljava/lang/String;
    ...
    iget v5, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I
    ...
    :goto_0
    iget v3, p0, Lorg/apache/log4j/jolohcwnyk;->lohkmxcimj:I
    ...
    iget-object v10, p0, Lorg/apache/log4j/bveuzccgjl;->lsvcqaryex:Ljava/lang/String;
    ...
    iget-object v9, p0, Lorg/apache/log4j/bveuzccgjl;->lsvcqaryex:Ljava/lang/String;
    ...
    iget-boolean v4, p0, Lorg/apache/log4j/bveuzccgjl;->rmnxkaltsn:Z

    iget v5, p0, Lorg/apache/log4j/bveuzccgjl;->bveuzccgjl:I

    invoke-virtual {p0, v3, v2, v4, v5}, Lorg/apache/log4j/jolohcwnyk;->myathtdxpy(Ljava/lang/String;ZZI)V
    :try_end_0
    ...
    invoke-static {v3, v2}, Lorg/apache/log4j/helpers/drkbbjxjkt;->ibzphkbtmt(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, v0, v4, v2, v3}, Lorg/apache/log4j/jolohcwnyk;->myathtdxpy(Ljava/lang/String;ZZI)V

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lorg/apache/log4j/jolohcwnyk;->ewnfwzyokr:J
    :try_end_1
