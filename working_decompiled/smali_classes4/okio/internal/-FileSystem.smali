...
# direct methods
.method public static final extxjewlhp(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;Z)Lkotlin/sequences/rmnxkaltsn;
    .locals 2
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/sxwagxhdwa;Lokio/pyxggrwgoy;ZLkotlin/coroutines/khjnvckbwi;)V

    invoke-static {v0}, Lkotlin/sequences/lohkmxcimj;->feyxvdiekx(Ls3/lohkmxcimj;)Lkotlin/sequences/rmnxkaltsn;
...
.method public static final feyxvdiekx(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;Lokio/sxwagxhdwa;)V
    .locals 4
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    :try_start_0
    invoke-virtual {p0, p2}, Lokio/pyxggrwgoy;->fdbcgriwfo(Lokio/sxwagxhdwa;)Lokio/klvawbfmro;
    ...
    :try_start_1
    invoke-interface {p0, p1}, Lokio/rmnxkaltsn;->E(Lokio/strivszpdp;)J
    ...
    :try_start_4
    invoke-static {p2, p0}, Lkotlin/thjjozpxyz;->qfzjddwuyn(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final ibzphkbtmt(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;Z)V
    .locals 2
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;Lkotlin/coroutines/khjnvckbwi;)V
    ...
    :goto_1
    invoke-virtual {p0, v0, v1}, Lokio/pyxggrwgoy;->pednzybqgd(Lokio/sxwagxhdwa;Z)V
...
.method public static final kgyfkythat(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;)Lokio/sxwagxhdwa;
    .locals 1
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lokio/pyxggrwgoy;->jolohcwnyk(Lokio/sxwagxhdwa;)Lokio/vlnjtcdbbq;

    move-result-object p0

    invoke-virtual {p0}, Lokio/vlnjtcdbbq;->drkbbjxjkt()Lokio/sxwagxhdwa;
    ...
    :cond_0
    invoke-virtual {p1}, Lokio/sxwagxhdwa;->opauvyugnb()Lokio/sxwagxhdwa;

    move-result-object p1

    invoke-static {p1}, Lkotlin/jvm/internal/erplbhbeyt;->rmnxkaltsn(Ljava/lang/Object;)V

    invoke-virtual {p1, p0}, Lokio/sxwagxhdwa;->kedepleukr(Lokio/sxwagxhdwa;)Lokio/sxwagxhdwa;
...
.method public static final khjnvckbwi(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;Z)V
    .locals 3
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-virtual {p0, v1}, Lokio/pyxggrwgoy;->jodmjjzdpr(Lokio/sxwagxhdwa;)Z
    ...
    invoke-virtual {v1}, Lokio/sxwagxhdwa;->opauvyugnb()Lokio/sxwagxhdwa;
    ...
    check-cast p2, Lokio/sxwagxhdwa;

    invoke-virtual {p0, p2}, Lokio/pyxggrwgoy;->rmnxkaltsn(Lokio/sxwagxhdwa;)V
...
.method public static final nhdortzefg(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;)Lokio/vlnjtcdbbq;
    .locals 2
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Lokio/pyxggrwgoy;->gcegooklax(Lokio/sxwagxhdwa;)Lokio/vlnjtcdbbq;
...
.method public static final qfzjddwuyn(Lkotlin/sequences/thjjozpxyz;Lokio/pyxggrwgoy;Lkotlin/collections/drkbbjxjkt;Lokio/sxwagxhdwa;ZZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 15
    .param p0    # Lkotlin/sequences/thjjozpxyz;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .param p1    # Lokio/pyxggrwgoy;
        ...
        .end annotation
    .end param
    .param p2    # Lkotlin/collections/drkbbjxjkt;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    invoke-direct {v4, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast v6, Lkotlin/collections/drkbbjxjkt;
    ...
    invoke-virtual {p0, v1, v4}, Lkotlin/sequences/thjjozpxyz;->qfzjddwuyn(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :goto_2
    invoke-virtual {v10, v1}, Lokio/pyxggrwgoy;->tgyvlqjbcn(Lokio/sxwagxhdwa;)Ljava/util/List;
    ...
    invoke-virtual {v6, v12}, Lkotlin/collections/drkbbjxjkt;->contains(Ljava/lang/Object;)Z
    ...
    :cond_9
    :goto_4
    invoke-static {v10, v12}, Lokio/internal/-FileSystem;->kgyfkythat(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;)Lokio/sxwagxhdwa;
    ...
    :cond_a
    invoke-virtual {v6, v12}, Lkotlin/collections/drkbbjxjkt;->addLast(Ljava/lang/Object;)V
    ...
    :try_start_2
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->qfzjddwuyn(Lkotlin/sequences/thjjozpxyz;Lokio/pyxggrwgoy;Lkotlin/collections/drkbbjxjkt;Lokio/sxwagxhdwa;ZZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-virtual {v7}, Lkotlin/collections/drkbbjxjkt;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v1, v4}, Lkotlin/sequences/thjjozpxyz;->qfzjddwuyn(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final qhoahqxrkc(Lokio/pyxggrwgoy;Lokio/sxwagxhdwa;)Z
    .locals 1
    .param p0    # Lokio/pyxggrwgoy;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
