...
# direct methods
.method constructor <init>(Ljava/lang/reflect/Type;Lio/reactivex/lqubyxtgks;ZZZZZZZ)V
    .locals 0
    .param p2    # Lio/reactivex/lqubyxtgks;
        .annotation runtime Lh3/kgyfkythat;
        .end annotation
    .end param
    ...
    iput-object p2, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:Lio/reactivex/lqubyxtgks;
...
.method public adapt(Lretrofit2/Call;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/ResultObservable;-><init>(Lio/reactivex/tgyvlqjbcn;)V
    ...
    invoke-direct {p1, v0}, Lretrofit2/adapter/rxjava2/BodyObservable;-><init>(Lio/reactivex/tgyvlqjbcn;)V

    goto :goto_1

    :cond_2
    :goto_2
    iget-object p1, p0, Lretrofit2/adapter/rxjava2/RxJava2CallAdapter;->scheduler:Lio/reactivex/lqubyxtgks;

    if-eqz p1, :cond_3

    invoke-virtual {v0, p1}, Lio/reactivex/tgyvlqjbcn;->subscribeOn(Lio/reactivex/lqubyxtgks;)Lio/reactivex/tgyvlqjbcn;
    ...
    invoke-virtual {v0, p1}, Lio/reactivex/tgyvlqjbcn;->toFlowable(Lio/reactivex/BackpressureStrategy;)Lio/reactivex/tthmnequln;
    ...
    invoke-virtual {v0}, Lio/reactivex/tgyvlqjbcn;->singleOrError()Lio/reactivex/pfbsrxdbry;
    ...
    invoke-virtual {v0}, Lio/reactivex/tgyvlqjbcn;->singleElement()Lio/reactivex/ewnfwzyokr;
    ...
    invoke-virtual {v0}, Lio/reactivex/tgyvlqjbcn;->ignoreElements()Lio/reactivex/qfzjddwuyn;
