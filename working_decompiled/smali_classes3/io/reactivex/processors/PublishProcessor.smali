...
# static fields
.field static final ekiqcarcrq:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;

.field static final thipomyfnm:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/processors/PublishProcessor;->thipomyfnm:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;

    new-array v0, v0, [Lio/reactivex/processors/PublishProcessor$PublishSubscription;

    sput-object v0, Lio/reactivex/processors/PublishProcessor;->ekiqcarcrq:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;
...
.method constructor <init>()V
    ...
    sget-object v1, Lio/reactivex/processors/PublishProcessor;->ekiqcarcrq:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lio/reactivex/processors/PublishProcessor;->xglnwpaccw:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static S6()Lio/reactivex/processors/PublishProcessor;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public M6()Ljava/lang/Throwable;
    ...
    iget-object v0, p0, Lio/reactivex/processors/PublishProcessor;->xglnwpaccw:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    sget-object v1, Lio/reactivex/processors/PublishProcessor;->thipomyfnm:[Lio/reactivex/processors/PublishProcessor$PublishSubscription;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lio/reactivex/processors/PublishProcessor;->kqhmbgiocc:Ljava/lang/Throwable;
...
.method R6(Lio/reactivex/processors/PublishProcessor$PublishSubscription;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lio/reactivex/processors/PublishProcessor;->xglnwpaccw:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public T6(Ljava/lang/Object;)Z
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)Z"
...
.method U6(Lio/reactivex/processors/PublishProcessor$PublishSubscription;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    iget-object v2, p0, Lio/reactivex/processors/PublishProcessor;->xglnwpaccw:Ljava/util/concurrent/atomic/AtomicReference;
...
.method protected k4(Lx6/khjnvckbwi;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/processors/PublishProcessor$PublishSubscription;-><init>(Lx6/khjnvckbwi;Lio/reactivex/processors/PublishProcessor;)V

    invoke-interface {p1, v0}, Lx6/khjnvckbwi;->onSubscribe(Lx6/ibzphkbtmt;)V

    invoke-virtual {p0, v0}, Lio/reactivex/processors/PublishProcessor;->R6(Lio/reactivex/processors/PublishProcessor$PublishSubscription;)Z
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/PublishProcessor;->U6(Lio/reactivex/processors/PublishProcessor$PublishSubscription;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/processors/PublishProcessor;->kqhmbgiocc:Ljava/lang/Throwable;
