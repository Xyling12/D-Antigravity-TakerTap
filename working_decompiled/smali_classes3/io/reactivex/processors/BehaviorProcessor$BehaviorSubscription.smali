...
.field queue:Lio/reactivex/internal/util/qfzjddwuyn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lio/reactivex/processors/BehaviorProcessor;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->downstream:Lx6/khjnvckbwi;
...
.method public cancel()V
    ...
    invoke-virtual {v0, p0}, Lio/reactivex/processors/BehaviorProcessor;->Z6(Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;)V
...
.method emitFirst()V
    ...
    iget-object v1, v0, Lio/reactivex/processors/BehaviorProcessor;->thipomyfnm:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v1}, Ljava/util/concurrent/locks/Lock;->lock()V

    iget-wide v2, v0, Lio/reactivex/processors/BehaviorProcessor;->obafekducm:J

    iput-wide v2, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->index:J

    iget-object v0, v0, Lio/reactivex/processors/BehaviorProcessor;->ekuiibmleg:Ljava/util/concurrent/atomic/AtomicReference;
...
.method emitLoop()V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->queue:Lio/reactivex/internal/util/qfzjddwuyn;
    ...
    iput-object v1, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->queue:Lio/reactivex/internal/util/qfzjddwuyn;
...
.method emitNext(Ljava/lang/Object;J)V
    ...
    iget-object p2, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->queue:Lio/reactivex/internal/util/qfzjddwuyn;
    ...
    iput-object p2, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->queue:Lio/reactivex/internal/util/qfzjddwuyn;
...
.method public test(Ljava/lang/Object;)Z
    ...
    iget-object p1, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->downstream:Lx6/khjnvckbwi;
    ...
    iget-object v0, p0, Lio/reactivex/processors/BehaviorProcessor$BehaviorSubscription;->downstream:Lx6/khjnvckbwi;
