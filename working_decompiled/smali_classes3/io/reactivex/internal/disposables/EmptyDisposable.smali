...
.field private static final synthetic cbsxzgznvp:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->cbsxzgznvp:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method public static complete(Lio/reactivex/ibzphkbtmt;)V
    .locals 1

    .line 5
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->INSTANCE:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lio/reactivex/ibzphkbtmt;->onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V

    .line 6
    invoke-interface {p0}, Lio/reactivex/ibzphkbtmt;->onComplete()V

    return-void
.end method

.method public static complete(Lio/reactivex/noartptryl;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lio/reactivex/noartptryl;->onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V

    .line 2
    invoke-interface {p0}, Lio/reactivex/noartptryl;->onComplete()V

    return-void
.end method

.method public static complete(Lio/reactivex/vlnjtcdbbq;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lio/reactivex/vlnjtcdbbq;->onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V

    .line 4
    invoke-interface {p0}, Lio/reactivex/vlnjtcdbbq;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lio/reactivex/ibzphkbtmt;)V
    .locals 1
    ...
    .line 4
    invoke-interface {p1, p0}, Lio/reactivex/ibzphkbtmt;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lio/reactivex/noartptryl;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lio/reactivex/vlnjtcdbbq;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 8
    invoke-interface {p1, p0}, Lio/reactivex/vlnjtcdbbq;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lio/reactivex/vrjnqucdkj;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-interface {p1, p0}, Lio/reactivex/vrjnqucdkj;->onError(Ljava/lang/Throwable;)V
...
.method public static values()[Lio/reactivex/internal/disposables/EmptyDisposable;
    ...
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->cbsxzgznvp:[Lio/reactivex/internal/disposables/EmptyDisposable;
