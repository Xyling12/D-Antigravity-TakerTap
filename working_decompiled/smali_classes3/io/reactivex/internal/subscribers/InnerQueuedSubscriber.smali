...
.field final parent:Lio/reactivex/internal/subscribers/nhdortzefg;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method public constructor <init>(Lio/reactivex/internal/subscribers/nhdortzefg;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lio/reactivex/internal/subscribers/nhdortzefg;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lio/reactivex/internal/subscribers/nhdortzefg;

    invoke-interface {v0, p0}, Lio/reactivex/internal/subscribers/nhdortzefg;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p0, p1}, Lio/reactivex/internal/subscribers/nhdortzefg;->innerError(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p0, p1}, Lio/reactivex/internal/subscribers/nhdortzefg;->innerNext(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Object;)V

    return-void

    :cond_0
    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lio/reactivex/internal/subscribers/nhdortzefg;

    invoke-interface {p1}, Lio/reactivex/internal/subscribers/nhdortzefg;->drain()V
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lg3/thjjozpxyz;

    iput-boolean v2, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->parent:Lio/reactivex/internal/subscribers/nhdortzefg;

    invoke-interface {p1, p0}, Lio/reactivex/internal/subscribers/nhdortzefg;->innerComplete(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;)V
...
.method public queue()Lg3/thjjozpxyz;
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue:Lg3/thjjozpxyz;
...
.method public requestOne()V
    ...
    invoke-interface {v2, v0, v1}, Lx6/ibzphkbtmt;->request(J)V
