...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher$qfzjddwuyn;
    }
.end annotation
...
.field final subscribers:[Lx6/khjnvckbwi;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Lx6/khjnvckbwi<",
...
.method constructor <init>([Lx6/khjnvckbwi;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lx6/khjnvckbwi;
...
.method cancel(I)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lx6/ibzphkbtmt;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->queue:Lg3/thjjozpxyz;
...
.method drainAsync()V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->queue:Lg3/thjjozpxyz;

    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lx6/khjnvckbwi;
    ...
    invoke-interface {v3, v13}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v12, v11}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v11, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lx6/ibzphkbtmt;

    int-to-long v12, v7

    invoke-interface {v11, v12, v13}, Lx6/ibzphkbtmt;->request(J)V
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lx6/ibzphkbtmt;
    ...
    invoke-interface {v4, v0}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
...
.method drainSync()V
    ...
    invoke-interface {v11, v10}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->queue:Lg3/thjjozpxyz;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->queue:Lg3/thjjozpxyz;
...
.method setupSubscribers()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;->subscribers:[Lx6/khjnvckbwi;
    ...
    new-instance v5, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher$qfzjddwuyn;

    invoke-direct {v5, p0, v2, v1}, Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher$qfzjddwuyn;-><init>(Lio/reactivex/internal/operators/parallel/ParallelFromPublisher$ParallelDispatcher;II)V

    invoke-interface {v3, v5}, Lx6/khjnvckbwi;->onSubscribe(Lx6/ibzphkbtmt;)V
