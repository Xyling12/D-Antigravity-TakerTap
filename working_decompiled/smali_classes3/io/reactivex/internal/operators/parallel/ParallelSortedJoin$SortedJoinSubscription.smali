...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;ILjava/util/Comparator;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->downstream:Lx6/khjnvckbwi;
...
.method drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/parallel/ParallelSortedJoin$SortedJoinSubscription;->downstream:Lx6/khjnvckbwi;
    ...
    invoke-interface {v2, v13}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-static {v3, v4, v0}, Landroidx/camera/view/tgyvlqjbcn;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {v2, v5}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
