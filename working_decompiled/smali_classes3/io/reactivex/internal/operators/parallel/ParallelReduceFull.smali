...
# direct methods
.method public constructor <init>(Lio/reactivex/parallel/qfzjddwuyn;Lf3/khjnvckbwi;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;->xglnwpaccw:Lio/reactivex/parallel/qfzjddwuyn;

    iput-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;->kqhmbgiocc:Lf3/khjnvckbwi;
...
.method protected k4(Lx6/khjnvckbwi;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;->xglnwpaccw:Lio/reactivex/parallel/qfzjddwuyn;

    invoke-virtual {v1}, Lio/reactivex/parallel/qfzjddwuyn;->erplbhbeyt()I

    move-result v1

    iget-object v2, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;->kqhmbgiocc:Lf3/khjnvckbwi;

    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/parallel/ParallelReduceFull$ParallelReduceFullMainSubscriber;-><init>(Lx6/khjnvckbwi;ILf3/khjnvckbwi;)V

    invoke-interface {p1, v0}, Lx6/khjnvckbwi;->onSubscribe(Lx6/ibzphkbtmt;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelReduceFull;->xglnwpaccw:Lio/reactivex/parallel/qfzjddwuyn;
