...
# direct methods
.method constructor <init>(Lg3/qfzjddwuyn;ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/lqubyxtgks$khjnvckbwi;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;-><init>(ILio/reactivex/internal/queue/SpscArrayQueue;Lio/reactivex/lqubyxtgks$khjnvckbwi;)V

    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lx6/ibzphkbtmt;

    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
...
.method public run()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$RunOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
    ...
    invoke-interface {v3, v15}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V

    iget-object v1, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->worker:Lio/reactivex/lqubyxtgks$khjnvckbwi;
    ...
    :cond_6
    invoke-interface {v3, v15}, Lg3/qfzjddwuyn;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v13, v0, Lio/reactivex/internal/operators/parallel/ParallelRunOn$BaseRunOnSubscriber;->upstream:Lx6/ibzphkbtmt;

    int-to-long v14, v1

    invoke-interface {v13, v14, v15}, Lx6/ibzphkbtmt;->request(J)V
