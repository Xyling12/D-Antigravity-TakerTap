...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;II)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;-><init>(Lx6/khjnvckbwi;II)V
...
.method drainLoop()V
    ...
    iget-object v3, v0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lx6/khjnvckbwi;
    ...
    invoke-interface {v3, v12}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v8, v4, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lg3/bveuzccgjl;

    if-eqz v8, :cond_5

    invoke-interface {v8}, Lg3/bveuzccgjl;->poll()Ljava/lang/Object;
    ...
    invoke-interface {v3, v4}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v9, v9, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->queue:Lg3/bveuzccgjl;

    if-eqz v9, :cond_c

    invoke-interface {v9}, Lg3/thjjozpxyz;->isEmpty()Z
...
.method public onNext(Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lx6/khjnvckbwi;
    ...
    :cond_1
    invoke-virtual {p1}, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinInnerSubscriber;->getQueue()Lg3/bveuzccgjl;
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/parallel/ParallelJoin$JoinSubscriptionBase;->downstream:Lx6/khjnvckbwi;
