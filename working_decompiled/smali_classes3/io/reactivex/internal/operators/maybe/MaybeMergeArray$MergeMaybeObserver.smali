...
.field final queue:Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;ILio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->downstream:Lx6/khjnvckbwi;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->set:Lio/reactivex/disposables/qfzjddwuyn;
    ...
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->queue:Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->set:Lio/reactivex/disposables/qfzjddwuyn;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->queue:Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;
...
.method drainFused()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->downstream:Lx6/khjnvckbwi;

    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->queue:Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;
    ...
    invoke-interface {v0, v4}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_2
    invoke-interface {v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->producerIndex()I
...
.method drainNormal()V
    ...
    :cond_3
    invoke-interface {v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->consumerIndex()I
    ...
    :cond_4
    invoke-interface {v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->poll()Ljava/lang/Object;
    ...
    :cond_7
    :goto_2
    invoke-interface {v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->peek()Ljava/lang/Object;
    ...
    invoke-interface {v1}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->drop()V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->set:Lio/reactivex/disposables/qfzjddwuyn;

    invoke-virtual {p1}, Lio/reactivex/disposables/qfzjddwuyn;->dispose()V

    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$MergeMaybeObserver;->queue:Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;

    sget-object v0, Lio/reactivex/internal/util/NotificationLite;->COMPLETE:Lio/reactivex/internal/util/NotificationLite;

    invoke-interface {p1, v0}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
...
.method public poll()Ljava/lang/Object;
    ...
    invoke-interface {v0}, Lio/reactivex/internal/operators/maybe/MaybeMergeArray$qfzjddwuyn;->poll()Ljava/lang/Object;
