...
# static fields
.field static final BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;-><init>(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;)V

    sput-object v0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;
...
.method constructor <init>(Lio/reactivex/noartptryl;ILjava/util/concurrent/Callable;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Lio/reactivex/noartptryl;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
...
.method disposeBoundary()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->BOUNDARY_DISPOSED:Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;
...
.method drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    invoke-static {v5, p0}, Lio/reactivex/subjects/UnicastSubject;->lsvcqaryex(ILjava/lang/Runnable;)Lio/reactivex/subjects/UnicastSubject;
    ...
    new-instance v8, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;

    invoke-direct {v8, p0}, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;-><init>(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;)V
    ...
    invoke-static {v9, v6, v8}, Landroidx/camera/view/tgyvlqjbcn;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-interface {v0, v5}, Lio/reactivex/noartptryl;->onNext(Ljava/lang/Object;)V
...
.method innerNext(Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$qfzjddwuyn;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableWindowBoundarySupplier$WindowBoundaryMainObserver;->downstream:Lio/reactivex/noartptryl;
