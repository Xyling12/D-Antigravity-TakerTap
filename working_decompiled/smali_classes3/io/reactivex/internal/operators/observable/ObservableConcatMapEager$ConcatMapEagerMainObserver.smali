...
.implements Lio/reactivex/internal/observers/tthmnequln;
...
# direct methods
.method constructor <init>(Lio/reactivex/noartptryl;Lf3/thjjozpxyz;IILio/reactivex/internal/util/ErrorMode;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Lio/reactivex/noartptryl;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:Lf3/thjjozpxyz;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
...
.method public drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lg3/thjjozpxyz;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    :cond_4
    iget-object v8, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->mapper:Lf3/thjjozpxyz;

    invoke-interface {v8, v7}, Lf3/thjjozpxyz;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v8, p0, v9}, Lio/reactivex/internal/observers/InnerQueuedObserver;-><init>(Lio/reactivex/internal/observers/tthmnequln;I)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
    ...
    :cond_a
    invoke-interface {v2}, Lio/reactivex/noartptryl;->onComplete()V
    ...
    invoke-virtual {v6}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lg3/thjjozpxyz;
    ...
    :try_start_1
    invoke-interface {v8}, Lg3/thjjozpxyz;->poll()Ljava/lang/Object;
    ...
    :cond_12
    invoke-interface {v2, v11}, Lio/reactivex/noartptryl;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v6}, Lio/reactivex/exceptions/qfzjddwuyn;->feyxvdiekx(Ljava/lang/Throwable;)V
...
.method public innerError(Lio/reactivex/internal/observers/InnerQueuedObserver;Ljava/lang/Throwable;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;

    invoke-interface {p2}, Lio/reactivex/disposables/feyxvdiekx;->dispose()V
...
.method public innerNext(Lio/reactivex/internal/observers/InnerQueuedObserver;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/internal/observers/InnerQueuedObserver;->queue()Lg3/thjjozpxyz;

    move-result-object p1

    invoke-interface {p1, p2}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->queue:Lg3/thjjozpxyz;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableConcatMapEager$ConcatMapEagerMainObserver;->downstream:Lio/reactivex/noartptryl;
