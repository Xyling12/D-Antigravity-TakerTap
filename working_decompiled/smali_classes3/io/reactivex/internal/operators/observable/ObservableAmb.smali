...
# direct methods
.method public constructor <init>([Lio/reactivex/gcegooklax;Ljava/lang/Iterable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableAmb;->cbsxzgznvp:[Lio/reactivex/gcegooklax;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableAmb;->xglnwpaccw:Ljava/lang/Iterable;
...
.method public subscribeActual(Lio/reactivex/noartptryl;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableAmb;->cbsxzgznvp:[Lio/reactivex/gcegooklax;
    ...
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableAmb;->xglnwpaccw:Ljava/lang/Iterable;
    ...
    :cond_5
    new-instance v1, Lio/reactivex/internal/operators/observable/ObservableAmb$qfzjddwuyn;

    invoke-direct {v1, p1, v3}, Lio/reactivex/internal/operators/observable/ObservableAmb$qfzjddwuyn;-><init>(Lio/reactivex/noartptryl;I)V

    invoke-virtual {v1, v0}, Lio/reactivex/internal/operators/observable/ObservableAmb$qfzjddwuyn;->qfzjddwuyn([Lio/reactivex/gcegooklax;)V
