...
# interfaces
.implements Lio/reactivex/kedepleukr;
...
.field final emitter:Lio/reactivex/kedepleukr;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lio/reactivex/kedepleukr<",
            "TT;>;"
...
# direct methods
.method constructor <init>(Lio/reactivex/kedepleukr;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/kedepleukr;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method drainLoop()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/kedepleukr;

    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
    ...
    :cond_0
    :goto_0
    invoke-interface {v0}, Lio/reactivex/kedepleukr;->isDisposed()Z
    ...
    invoke-interface {v0, v1}, Lio/reactivex/drkbbjxjkt;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0}, Lio/reactivex/drkbbjxjkt;->onComplete()V
    ...
    :cond_5
    invoke-interface {v0, v6}, Lio/reactivex/drkbbjxjkt;->onNext(Ljava/lang/Object;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/drkbbjxjkt;->onNext(Ljava/lang/Object;)V
    ...
    :cond_2
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public serialize()Lio/reactivex/kedepleukr;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public setCancellable(Lf3/extxjewlhp;)V
    .locals 1

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/kedepleukr;

    invoke-interface {v0, p1}, Lio/reactivex/kedepleukr;->setCancellable(Lf3/extxjewlhp;)V

    return-void
.end method

.method public setDisposable(Lio/reactivex/disposables/feyxvdiekx;)V
    .locals 1

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCreate$SerializedEmitter;->emitter:Lio/reactivex/kedepleukr;

    invoke-interface {v0, p1}, Lio/reactivex/kedepleukr;->setDisposable(Lio/reactivex/disposables/feyxvdiekx;)V
