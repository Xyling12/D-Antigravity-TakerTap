...
.field final keySelector:Lf3/thjjozpxyz;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf3/thjjozpxyz<",
            "-TT;+TK;>;"
...
.field final valueSelector:Lf3/thjjozpxyz;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf3/thjjozpxyz<",
            "-TT;+TV;>;"
...
.method public constructor <init>(Lio/reactivex/noartptryl;Lf3/thjjozpxyz;Lf3/thjjozpxyz;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/noartptryl;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->keySelector:Lf3/thjjozpxyz;

    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->valueSelector:Lf3/thjjozpxyz;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
...
.method public onComplete()V
    ...
    check-cast v1, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;

    invoke-virtual {v1}, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;->onComplete()V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/noartptryl;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v1, p1}, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->keySelector:Lf3/thjjozpxyz;
    ...
    check-cast v2, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;
    ...
    invoke-static {v0, v2, p0, v3}, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;->extxjewlhp(Ljava/lang/Object;ILio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;Z)Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;
    ...
    invoke-interface {v0, v2}, Lio/reactivex/noartptryl;->onNext(Ljava/lang/Object;)V

    :cond_2
    :try_start_1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->valueSelector:Lf3/thjjozpxyz;
    ...
    invoke-virtual {v2, p1}, Lio/reactivex/internal/operators/observable/ObservableGroupBy$qfzjddwuyn;->onNext(Ljava/lang/Object;)V
...
.method public onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableGroupBy$GroupByObserver;->downstream:Lio/reactivex/noartptryl;
