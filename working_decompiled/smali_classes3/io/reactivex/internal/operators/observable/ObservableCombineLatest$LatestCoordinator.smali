...
# direct methods
.method constructor <init>(Lio/reactivex/noartptryl;Lf3/thjjozpxyz;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->downstream:Lio/reactivex/noartptryl;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->combiner:Lf3/thjjozpxyz;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method clear(Lio/reactivex/internal/queue/qfzjddwuyn;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public dispose()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;

    invoke-virtual {p0, v0}, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->clear(Lio/reactivex/internal/queue/qfzjddwuyn;)V
...
.method drain()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->downstream:Lio/reactivex/noartptryl;
    ...
    :cond_7
    :try_start_0
    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->combiner:Lf3/thjjozpxyz;

    invoke-interface {v5, v6}, Lf3/thjjozpxyz;->apply(Ljava/lang/Object;)Ljava/lang/Object;
...
.method innerNext(ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public subscribe([Lio/reactivex/gcegooklax;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableCombineLatest$LatestCoordinator;->downstream:Lio/reactivex/noartptryl;

    invoke-interface {v2, p0}, Lio/reactivex/noartptryl;->onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
