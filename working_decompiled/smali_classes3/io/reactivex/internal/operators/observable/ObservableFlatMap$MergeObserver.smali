...
.method constructor <init>(Lio/reactivex/noartptryl;Lf3/thjjozpxyz;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;

    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lf3/thjjozpxyz;
...
.method checkTerminate()Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;

    invoke-interface {v2, v0}, Lio/reactivex/noartptryl;->onError(Ljava/lang/Throwable;)V
...
.method disposeAll()Z
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
...
.method drainLoop()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    :cond_1
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lg3/bveuzccgjl;
    ...
    :cond_2
    invoke-interface {v3}, Lg3/bveuzccgjl;->poll()Ljava/lang/Object;
    ...
    :cond_3
    invoke-interface {v0, v4}, Lio/reactivex/noartptryl;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lg3/bveuzccgjl;
    ...
    invoke-interface {v4}, Lg3/thjjozpxyz;->isEmpty()Z
    ...
    iget-object v11, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lg3/thjjozpxyz;

    if-eqz v11, :cond_13

    :cond_10
    :try_start_1
    invoke-interface {v11}, Lg3/thjjozpxyz;->poll()Ljava/lang/Object;
    ...
    :cond_11
    invoke-interface {v0, v12}, Lio/reactivex/noartptryl;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v11}, Lio/reactivex/exceptions/qfzjddwuyn;->feyxvdiekx(Ljava/lang/Throwable;)V
    ...
    iget-object v12, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lg3/thjjozpxyz;
    ...
    invoke-virtual {p0, v4}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Lio/reactivex/gcegooklax;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Lf3/thjjozpxyz;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Lio/reactivex/gcegooklax;)V
...
.method public onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;
...
.method subscribeInner(Lio/reactivex/gcegooklax;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    :cond_0
    iget-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lg3/thjjozpxyz;
    ...
    iput-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Lg3/thjjozpxyz;
...
.method tryEmitScalar(Ljava/util/concurrent/Callable;)Z
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lg3/bveuzccgjl;
    ...
    new-instance v1, Lio/reactivex/internal/queue/qfzjddwuyn;

    iget v3, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->bufferSize:I

    invoke-direct {v1, v3}, Lio/reactivex/internal/queue/qfzjddwuyn;-><init>(I)V
    ...
    :goto_0
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Lg3/bveuzccgjl;
