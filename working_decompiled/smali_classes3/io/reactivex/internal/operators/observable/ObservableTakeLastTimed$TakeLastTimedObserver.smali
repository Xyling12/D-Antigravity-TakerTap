...
# direct methods
.method constructor <init>(Lio/reactivex/noartptryl;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/lqubyxtgks;IZ)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->downstream:Lio/reactivex/noartptryl;
    ...
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->scheduler:Lio/reactivex/lqubyxtgks;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public dispose()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method drain()V
    ...
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->downstream:Lio/reactivex/noartptryl;

    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
    ...
    invoke-interface {v0, v3}, Lio/reactivex/noartptryl;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->scheduler:Lio/reactivex/lqubyxtgks;
    ...
    invoke-virtual {v3, v7}, Lio/reactivex/lqubyxtgks;->ibzphkbtmt(Ljava/util/concurrent/TimeUnit;)J
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->scheduler:Lio/reactivex/lqubyxtgks;
    ...
    invoke-virtual {v0, v9, p1}, Lio/reactivex/internal/queue/qfzjddwuyn;->offer(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0}, Lio/reactivex/internal/queue/qfzjddwuyn;->peek()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lio/reactivex/internal/queue/qfzjddwuyn;->rmnxkaltsn()I
...
.method public onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->upstream:Lio/reactivex/disposables/feyxvdiekx;

    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableTakeLastTimed$TakeLastTimedObserver;->downstream:Lio/reactivex/noartptryl;
