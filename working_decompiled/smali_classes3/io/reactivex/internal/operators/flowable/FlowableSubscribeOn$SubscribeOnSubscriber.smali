...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$qfzjddwuyn;
    }
.end annotation
...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lio/reactivex/lqubyxtgks$khjnvckbwi;Lx6/feyxvdiekx;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->worker:Lio/reactivex/lqubyxtgks$khjnvckbwi;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lx6/feyxvdiekx;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->worker:Lio/reactivex/lqubyxtgks$khjnvckbwi;
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->downstream:Lx6/khjnvckbwi;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->worker:Lio/reactivex/lqubyxtgks$khjnvckbwi;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    invoke-virtual {p0, v3, v4, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLx6/ibzphkbtmt;)V
...
.method public request(J)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLx6/ibzphkbtmt;)V
    ...
    invoke-virtual {p0, v2, v3, p1}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->requestUpstream(JLx6/ibzphkbtmt;)V

    :cond_1
    return-void
.end method

.method requestUpstream(JLx6/ibzphkbtmt;)V
    .locals 2
    ...
    new-instance v1, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$qfzjddwuyn;

    invoke-direct {v1, p3, p1, p2}, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber$qfzjddwuyn;-><init>(Lx6/ibzphkbtmt;J)V
    ...
    :cond_1
    :goto_0
    invoke-interface {p3, p1, p2}, Lx6/ibzphkbtmt;->request(J)V
...
.method public run()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lx6/feyxvdiekx;

    const/4 v1, 0x0

    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableSubscribeOn$SubscribeOnSubscriber;->source:Lx6/feyxvdiekx;
