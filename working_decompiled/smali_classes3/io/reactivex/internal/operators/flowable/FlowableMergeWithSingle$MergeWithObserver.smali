...
.method constructor <init>(Lx6/khjnvckbwi;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lx6/khjnvckbwi;
...
.method public cancel()V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;
...
.method drainLoop()V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lx6/khjnvckbwi;
    ...
    iput-object v13, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;
    ...
    invoke-interface {v1, v10}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v11, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;

    if-eqz v11, :cond_3

    invoke-interface {v11}, Lg3/bveuzccgjl;->poll()Ljava/lang/Object;
    ...
    :cond_6
    invoke-interface {v1, v11}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    check-cast v4, Lx6/ibzphkbtmt;

    int-to-long v10, v5

    invoke-interface {v4, v10, v11}, Lx6/ibzphkbtmt;->request(J)V
    ...
    iget-object v8, v0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;

    if-eqz v8, :cond_c

    invoke-interface {v8}, Lg3/thjjozpxyz;->isEmpty()Z
...
.method getOrCreateQueue()Lg3/bveuzccgjl;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->queue:Lg3/bveuzccgjl;
    ...
    :cond_0
    invoke-interface {v4, p1}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lx6/khjnvckbwi;

    invoke-interface {v2, p1}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    :cond_3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->getOrCreateQueue()Lg3/bveuzccgjl;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    invoke-static {v0, p1, v1, v2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lx6/ibzphkbtmt;J)Z
...
.method otherSuccess(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableMergeWithSingle$MergeWithObserver;->downstream:Lx6/khjnvckbwi;
