...
.implements Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$qfzjddwuyn;
...
# direct methods
.method constructor <init>(Lio/reactivex/vrjnqucdkj;ILf3/ibzphkbtmt;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqualSingle$EqualCoordinator;->downstream:Lio/reactivex/vrjnqucdkj;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqualSingle$EqualCoordinator;->comparer:Lf3/ibzphkbtmt;

    new-instance p1, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualSubscriber;

    invoke-direct {p1, p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualSubscriber;-><init>(Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$qfzjddwuyn;I)V
...
.method public drain()V
    ...
    iget-object v2, v2, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    iget-object v3, v3, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqualSingle$EqualCoordinator;->downstream:Lio/reactivex/vrjnqucdkj;
    ...
    :try_start_0
    invoke-interface {v2}, Lg3/thjjozpxyz;->poll()Ljava/lang/Object;
    ...
    :cond_a
    :try_start_2
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqualSingle$EqualCoordinator;->comparer:Lf3/ibzphkbtmt;

    invoke-interface {v4, v5, v9}, Lf3/ibzphkbtmt;->test(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method subscribe(Lx6/feyxvdiekx;Lx6/feyxvdiekx;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p1}, Lx6/feyxvdiekx;->subscribe(Lx6/khjnvckbwi;)V
