...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->mapper:Lf3/thjjozpxyz;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->set:Lio/reactivex/disposables/qfzjddwuyn;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v0}, Lx6/ibzphkbtmt;->cancel()V

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->set:Lio/reactivex/disposables/qfzjddwuyn;
...
.method drainLoop()V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    check-cast v15, Lio/reactivex/internal/queue/qfzjddwuyn;

    if-eqz v15, :cond_4

    invoke-virtual {v15}, Lio/reactivex/internal/queue/qfzjddwuyn;->poll()Ljava/lang/Object;
    ...
    :cond_8
    invoke-interface {v1, v15}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    invoke-virtual {v7}, Lio/reactivex/internal/queue/qfzjddwuyn;->isEmpty()Z
    ...
    invoke-static {v6, v10, v11}, Lio/reactivex/internal/util/feyxvdiekx;->qhoahqxrkc(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    iget-object v6, v0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v6, v10, v11}, Lx6/ibzphkbtmt;->request(J)V
...
.method innerComplete(Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver;)V
    ...
    check-cast v3, Lio/reactivex/internal/queue/qfzjddwuyn;

    if-eqz p1, :cond_3

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lio/reactivex/internal/queue/qfzjddwuyn;->isEmpty()Z
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    :cond_2
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->upstream:Lx6/ibzphkbtmt;
...
.method innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->set:Lio/reactivex/disposables/qfzjddwuyn;
...
.method innerSuccess(Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber$InnerObserver;Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p2}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    invoke-static {p1, v0, v1}, Lio/reactivex/internal/util/feyxvdiekx;->qhoahqxrkc(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    :cond_4
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->getOrCreateQueue()Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->mapper:Lf3/thjjozpxyz;
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->set:Lio/reactivex/disposables/qfzjddwuyn;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMapMaybe$FlatMapMaybeSubscriber;->upstream:Lx6/ibzphkbtmt;
