.class final Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;
...
.method constructor <init>(Ljava/util/concurrent/atomic/AtomicReference;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;

    iput p2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;->xglnwpaccw:I
...
.method public subscribe(Lx6/khjnvckbwi;)V
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowablePublish$InnerSubscriber;-><init>(Lx6/khjnvckbwi;)V

    invoke-interface {p1, v0}, Lx6/khjnvckbwi;->onSubscribe(Lx6/ibzphkbtmt;)V

    :cond_0
    :goto_0
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;

    iget v3, p0, Lio/reactivex/internal/operators/flowable/FlowablePublish$qfzjddwuyn;->xglnwpaccw:I
