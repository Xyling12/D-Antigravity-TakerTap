...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lf3/thjjozpxyz;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lg3/thjjozpxyz;
...
.method checkTerminated(ZZLx6/khjnvckbwi;Lg3/thjjozpxyz;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-static {p1}, Lio/reactivex/internal/util/ExceptionHelper;->khjnvckbwi(Ljava/util/concurrent/atomic/AtomicReference;)Ljava/lang/Throwable;
...
.method drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lx6/khjnvckbwi;

    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    :try_start_0
    invoke-interface {v3}, Lg3/thjjozpxyz;->poll()Ljava/lang/Object;
    ...
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lg3/thjjozpxyz;)Z
    ...
    :try_start_1
    iget-object v6, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lf3/thjjozpxyz;

    invoke-interface {v6, v10}, Lf3/thjjozpxyz;->apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v3}, Lx6/ibzphkbtmt;->cancel()V
    ...
    invoke-static {v3, v0}, Lio/reactivex/internal/util/ExceptionHelper;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    iget-object v4, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    invoke-static {v4, v0}, Lio/reactivex/internal/util/ExceptionHelper;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-interface {v3}, Lg3/thjjozpxyz;->clear()V
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lg3/thjjozpxyz;)Z
    ...
    invoke-static {v15, v5}, Lio/reactivex/internal/functions/qfzjddwuyn;->nhdortzefg(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v5
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_3

    invoke-interface {v2, v5}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V

    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lg3/thjjozpxyz;)Z
    ...
    :goto_6
    invoke-virtual {v1, v5, v8, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lg3/thjjozpxyz;)Z
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->queue:Lg3/thjjozpxyz;

    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Lx6/khjnvckbwi;
...
.method public poll()Ljava/lang/Object;
    ...
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->mapper:Lf3/thjjozpxyz;
