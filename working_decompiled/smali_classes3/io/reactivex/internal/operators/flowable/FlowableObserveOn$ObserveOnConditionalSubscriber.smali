...
# direct methods
.method constructor <init>(Lg3/qfzjddwuyn;Lio/reactivex/lqubyxtgks$khjnvckbwi;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lio/reactivex/lqubyxtgks$khjnvckbwi;ZI)V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lg3/thjjozpxyz;

    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;

    invoke-interface {v0, p0}, Lio/reactivex/thjjozpxyz;->onSubscribe(Lx6/ibzphkbtmt;)V
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v3, v1, v2}, Lx6/ibzphkbtmt;->request(J)V
...
.method runAsync()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    :goto_2
    invoke-virtual {p0, v11, v13, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;)Z
    ...
    :cond_4
    invoke-interface {v0, v12}, Lg3/qfzjddwuyn;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v10, v4, v5}, Lx6/ibzphkbtmt;->request(J)V
    ...
    invoke-interface {v0, v2}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lio/reactivex/lqubyxtgks$khjnvckbwi;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLx6/khjnvckbwi;)Z
...
.method runBackfused()V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;

    const/4 v4, 0x0

    invoke-interface {v3, v4}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->downstream:Lg3/qfzjddwuyn;
...
.method runSync()V
    ...
    :cond_3
    invoke-interface {v0, v8}, Lg3/qfzjddwuyn;->tryOnNext(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->upstream:Lx6/ibzphkbtmt;
