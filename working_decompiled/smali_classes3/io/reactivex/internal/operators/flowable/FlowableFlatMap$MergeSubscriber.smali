...
.field volatile queue:Lg3/bveuzccgjl;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lg3/bveuzccgjl<",
            "TU;>;"
...
.method constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;ZII)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lf3/thjjozpxyz;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lg3/bveuzccgjl;
...
.method checkTerminate()Z
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lx6/khjnvckbwi;

    invoke-interface {v2, v0}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
...
.method drainLoop()V
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    :cond_1
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lg3/bveuzccgjl;
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lg3/bveuzccgjl;
    ...
    invoke-interface {v3}, Lg3/thjjozpxyz;->isEmpty()Z
    ...
    sget-object v3, Lio/reactivex/internal/util/ExceptionHelper;->qfzjddwuyn:Ljava/lang/Throwable;

    if-eq v0, v3, :cond_29

    if-nez v0, :cond_c

    invoke-interface {v2}, Lx6/khjnvckbwi;->onComplete()V
    ...
    :cond_15
    iget-object v13, v11, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    :try_start_0
    invoke-interface {v13}, Lg3/thjjozpxyz;->poll()Ljava/lang/Object;
    ...
    :cond_17
    invoke-interface {v2, v12}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iget-object v12, v11, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;

    if-eqz v7, :cond_22

    if-eqz v12, :cond_20

    invoke-interface {v12}, Lg3/thjjozpxyz;->isEmpty()Z
    ...
    invoke-interface {v0, v5, v6}, Lx6/ibzphkbtmt;->request(J)V
...
.method getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Lg3/thjjozpxyz;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    iput-object v0, p1, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;

    :cond_0
    return-object v0
.end method

.method getMainQueue()Lg3/thjjozpxyz;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    :goto_0
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lg3/bveuzccgjl;
...
.method innerError(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lx6/ibzphkbtmt;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->mapper:Lf3/thjjozpxyz;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->upstream:Lx6/ibzphkbtmt;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lx6/khjnvckbwi;
...
.method tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)V
    ...
    iget-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;
    ...
    invoke-virtual {p0, p2}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getInnerQueue(Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;)Lg3/thjjozpxyz;
    ...
    iput-object v0, p2, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$InnerSubscriber;->queue:Lg3/thjjozpxyz;
...
.method tryEmitScalar(Ljava/lang/Object;)V
    ...
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->queue:Lg3/bveuzccgjl;
    ...
    invoke-interface {v5}, Lg3/thjjozpxyz;->isEmpty()Z
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableFlatMap$MergeSubscriber;->getMainQueue()Lg3/thjjozpxyz;

    move-result-object v5

    :cond_3
    invoke-interface {v5, p1}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
