...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;IIZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lf3/thjjozpxyz;
    ...
    invoke-direct {p1, p4}, Lio/reactivex/internal/queue/qfzjddwuyn;-><init>(I)V

    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public clear()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method drainAsync()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->downstream:Lx6/khjnvckbwi;

    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLx6/khjnvckbwi;Lio/reactivex/internal/queue/qfzjddwuyn;)Z
    ...
    :try_start_0
    iget-object v11, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lf3/thjjozpxyz;

    invoke-interface {v11, v10}, Lf3/thjjozpxyz;->apply(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v10

    const-string v11, "The combiner returned a null value"

    invoke-static {v10, v11}, Lio/reactivex/internal/functions/qfzjddwuyn;->nhdortzefg(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v10
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-interface {v0, v10}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lio/reactivex/internal/util/ExceptionHelper;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
    ...
    invoke-static {v1}, Lio/reactivex/internal/util/ExceptionHelper;->khjnvckbwi(Ljava/util/concurrent/atomic/AtomicReference;)Ljava/lang/Throwable;
    ...
    invoke-virtual {p0, v10, v11, v0, v1}, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->checkTerminated(ZZLx6/khjnvckbwi;Lio/reactivex/internal/queue/qfzjddwuyn;)Z
...
.method drainOutput()V
    ...
    invoke-virtual {v1}, Lio/reactivex/internal/queue/qfzjddwuyn;->clear()V
    ...
    invoke-interface {v0, v3}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, v5}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
...
.method innerError(ILjava/lang/Throwable;)V
    ...
    invoke-static {v0, p2}, Lio/reactivex/internal/util/ExceptionHelper;->qfzjddwuyn(Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Throwable;)Z
...
.method innerValue(ILjava/lang/Object;)V
    ...
    iget-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
    ...
    invoke-virtual {p2, v1, v0}, Lio/reactivex/internal/queue/qfzjddwuyn;->offer(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public poll()Ljava/lang/Object;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$CombineLatestCoordinator;->combiner:Lf3/thjjozpxyz;
...
.method subscribe([Lx6/feyxvdiekx;I)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
