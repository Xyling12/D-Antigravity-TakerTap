...
# instance fields
.field final accumulator:Lf3/khjnvckbwi;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf3/khjnvckbwi<",
            "TR;-TT;TR;>;"
...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lf3/khjnvckbwi;Ljava/lang/Object;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:Lf3/khjnvckbwi;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lg3/bveuzccgjl;

    invoke-interface {p1, p3}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lg3/bveuzccgjl;
...
.method drain()V
    ...
    :cond_0
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lx6/khjnvckbwi;

    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->queue:Lg3/bveuzccgjl;
    ...
    invoke-interface {v1, v15}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lx6/ibzphkbtmt;

    int-to-long v13, v3

    invoke-interface {v4, v13, v14}, Lx6/ibzphkbtmt;->request(J)V
    ...
    invoke-interface {v1, v7}, Lx6/khjnvckbwi;->onError(Ljava/lang/Throwable;)V

    return-void

    :cond_9
    invoke-interface {v2}, Lg3/thjjozpxyz;->isEmpty()Z
    ...
    invoke-static {v7, v11, v12}, Lio/reactivex/internal/util/feyxvdiekx;->qhoahqxrkc(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->accumulator:Lf3/khjnvckbwi;
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->upstream:Lx6/ibzphkbtmt;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableScanSeed$ScanSeedSubscriber;->downstream:Lx6/khjnvckbwi;
