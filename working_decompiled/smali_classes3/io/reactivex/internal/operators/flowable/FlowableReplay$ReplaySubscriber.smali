...
# instance fields
.field final buffer:Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->buffer:Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;
...
.method manageRequests()V
    ...
    invoke-interface {v1, v4, v5}, Lx6/ibzphkbtmt;->request(J)V
...
.method public onComplete()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->buffer:Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;

    invoke-interface {v0}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;->complete()V
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->buffer:Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;

    invoke-interface {v4, v3}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;->replay(Lio/reactivex/internal/operators/flowable/FlowableReplay$InnerSubscription;)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;->error(Ljava/lang/Throwable;)V
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableReplay$ReplaySubscriber;->buffer:Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;

    invoke-interface {v3, v2}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;->replay(Lio/reactivex/internal/operators/flowable/FlowableReplay$InnerSubscription;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/internal/operators/flowable/FlowableReplay$ibzphkbtmt;->next(Ljava/lang/Object;)V
