...
.implements Lio/reactivex/internal/subscribers/nhdortzefg;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "TT;>;",
        "Lx6/ibzphkbtmt;",
        "Lio/reactivex/internal/subscribers/nhdortzefg<",
        "TR;>;"
    }
.end annotation
...
.field final subscribers:Lio/reactivex/internal/queue/qfzjddwuyn;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;IILio/reactivex/internal/util/ErrorMode;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->mapper:Lf3/thjjozpxyz;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->subscribers:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->upstream:Lx6/ibzphkbtmt;
...
.method cancelAll()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->subscribers:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public drain()V
    ...
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->downstream:Lx6/khjnvckbwi;
    ...
    iget-object v8, v1, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->subscribers:Lio/reactivex/internal/queue/qfzjddwuyn;

    invoke-virtual {v8}, Lio/reactivex/internal/queue/qfzjddwuyn;->poll()Ljava/lang/Object;
    ...
    invoke-virtual {v8}, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue()Lg3/thjjozpxyz;
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    :cond_a
    invoke-interface {v2, v15}, Lx6/khjnvckbwi;->onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v11}, Lg3/thjjozpxyz;->isEmpty()Z
...
.method public innerError(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->upstream:Lx6/ibzphkbtmt;
...
.method public innerNext(Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1}, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;->queue()Lg3/thjjozpxyz;

    move-result-object v0

    invoke-interface {v0, p2}, Lg3/thjjozpxyz;->offer(Ljava/lang/Object;)Z
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->mapper:Lf3/thjjozpxyz;
    ...
    invoke-direct {v0, p0, v1}, Lio/reactivex/internal/subscribers/InnerQueuedSubscriber;-><init>(Lio/reactivex/internal/subscribers/nhdortzefg;I)V
    ...
    :cond_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->subscribers:Lio/reactivex/internal/queue/qfzjddwuyn;

    invoke-virtual {v1, v0}, Lio/reactivex/internal/queue/qfzjddwuyn;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->upstream:Lx6/ibzphkbtmt;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableConcatMapEager$ConcatMapEagerDelayErrorSubscriber;->downstream:Lx6/khjnvckbwi;
