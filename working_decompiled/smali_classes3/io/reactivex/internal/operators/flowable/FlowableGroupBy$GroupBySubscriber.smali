...
.method public constructor <init>(Lx6/khjnvckbwi;Lf3/thjjozpxyz;Lf3/thjjozpxyz;IZLjava/util/Map;Ljava/util/Queue;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lx6/khjnvckbwi;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->keySelector:Lf3/thjjozpxyz;

    iput-object p3, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->valueSelector:Lf3/thjjozpxyz;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method private qfzjddwuyn()V
    ...
    check-cast v1, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;->onComplete()V
...
.method public cancel()V
    ...
    .line 2
    invoke-direct {p0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->qfzjddwuyn()V
    ...
    .line 4
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lx6/ibzphkbtmt;
...
.method public cancel(Ljava/lang/Object;)V
    ...
    .line 8
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lx6/ibzphkbtmt;
    ...
    .line 10
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method public clear()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->queue:Lio/reactivex/internal/queue/qfzjddwuyn;
...
.method drainFused()V
    ...
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lx6/khjnvckbwi;
...
.method drainNormal()V
    ...
    check-cast v12, Lio/reactivex/flowables/feyxvdiekx;
    ...
    :goto_1
    invoke-virtual {p0, v11, v13, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lio/reactivex/internal/queue/qfzjddwuyn;)Z
    ...
    invoke-virtual {p0, v10, v11, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->checkTerminated(ZZLx6/khjnvckbwi;Lio/reactivex/internal/queue/qfzjddwuyn;)Z
    ...
    :cond_6
    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lx6/ibzphkbtmt;

    invoke-interface {v4, v8, v9}, Lx6/ibzphkbtmt;->request(J)V
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    check-cast v2, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;

    invoke-virtual {v2, p1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;->onError(Ljava/lang/Throwable;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->keySelector:Lf3/thjjozpxyz;
    ...
    check-cast v3, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;
    ...
    invoke-static {v1, v3, p0, v4}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;->N6(Ljava/lang/Object;ILio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;Z)Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;
    ...
    :goto_1
    :try_start_1
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->valueSelector:Lf3/thjjozpxyz;
    ...
    invoke-virtual {v3, p1}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$feyxvdiekx;->onNext(Ljava/lang/Object;)V

    invoke-direct {p0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->qfzjddwuyn()V

    if-eqz v1, :cond_4

    invoke-virtual {v0, v3}, Lio/reactivex/internal/queue/qfzjddwuyn;->offer(Ljava/lang/Object;)Z
...
.method public onSubscribe(Lx6/ibzphkbtmt;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->upstream:Lx6/ibzphkbtmt;

    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->downstream:Lx6/khjnvckbwi;
...
.method public poll()Lio/reactivex/flowables/feyxvdiekx;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    check-cast v0, Lio/reactivex/flowables/feyxvdiekx;
...
.method public bridge synthetic poll()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/FlowableGroupBy$GroupBySubscriber;->poll()Lio/reactivex/flowables/feyxvdiekx;
