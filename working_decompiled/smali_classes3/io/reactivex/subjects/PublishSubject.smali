...
# static fields
.field static final kqhmbgiocc:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;

.field static final thipomyfnm:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lio/reactivex/subjects/PublishSubject;->kqhmbgiocc:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;

    new-array v0, v0, [Lio/reactivex/subjects/PublishSubject$PublishDisposable;

    sput-object v0, Lio/reactivex/subjects/PublishSubject;->thipomyfnm:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;
...
.method constructor <init>()V
    ...
    sget-object v1, Lio/reactivex/subjects/PublishSubject;->thipomyfnm:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lio/reactivex/subjects/PublishSubject;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;

    return-void
.end method

.method public static ktvtxjqbtt()Lio/reactivex/subjects/PublishSubject;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public extxjewlhp()Z
    ...
    iget-object v0, p0, Lio/reactivex/subjects/PublishSubject;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    sget-object v1, Lio/reactivex/subjects/PublishSubject;->kqhmbgiocc:[Lio/reactivex/subjects/PublishSubject$PublishDisposable;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lio/reactivex/subjects/PublishSubject;->xglnwpaccw:Ljava/lang/Throwable;
...
.method lsvcqaryex(Lio/reactivex/subjects/PublishSubject$PublishDisposable;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_2
    iget-object v2, p0, Lio/reactivex/subjects/PublishSubject;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    :cond_0
    iput-object p1, p0, Lio/reactivex/subjects/PublishSubject;->xglnwpaccw:Ljava/lang/Throwable;
...
.method protected subscribeActual(Lio/reactivex/noartptryl;)V
    ...
    invoke-direct {v0, p1, p0}, Lio/reactivex/subjects/PublishSubject$PublishDisposable;-><init>(Lio/reactivex/noartptryl;Lio/reactivex/subjects/PublishSubject;)V

    invoke-interface {p1, v0}, Lio/reactivex/noartptryl;->onSubscribe(Lio/reactivex/disposables/feyxvdiekx;)V

    invoke-virtual {p0, v0}, Lio/reactivex/subjects/PublishSubject;->tthmnequln(Lio/reactivex/subjects/PublishSubject$PublishDisposable;)Z
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/subjects/PublishSubject;->lsvcqaryex(Lio/reactivex/subjects/PublishSubject$PublishDisposable;)V
...
.method tthmnequln(Lio/reactivex/subjects/PublishSubject$PublishDisposable;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Lio/reactivex/subjects/PublishSubject;->cbsxzgznvp:Ljava/util/concurrent/atomic/AtomicReference;
