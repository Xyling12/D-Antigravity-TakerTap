...
.field private static final synthetic cbsxzgznvp:[Lio/ktor/http/content/VersionCheckResult;


# instance fields
.field private final statusCode:Lio/ktor/http/erplbhbeyt;
...
.method static constructor <clinit>()V
    ...
    invoke-virtual {v1}, Lio/ktor/http/erplbhbeyt$qfzjddwuyn;->jtuzwzphqf()Lio/ktor/http/erplbhbeyt;
    ...
    invoke-direct {v0, v3, v4, v2}, Lio/ktor/http/content/VersionCheckResult;-><init>(Ljava/lang/String;ILio/ktor/http/erplbhbeyt;)V
    ...
    invoke-virtual {v1}, Lio/ktor/http/erplbhbeyt$qfzjddwuyn;->kedepleukr()Lio/ktor/http/erplbhbeyt;

    move-result-object v3

    const-string v4, "NOT_MODIFIED"

    invoke-direct {v0, v4, v2, v3}, Lio/ktor/http/content/VersionCheckResult;-><init>(Ljava/lang/String;ILio/ktor/http/erplbhbeyt;)V
    ...
    invoke-virtual {v1}, Lio/ktor/http/erplbhbeyt$qfzjddwuyn;->lqubyxtgks()Lio/ktor/http/erplbhbeyt;

    move-result-object v1

    const-string v3, "PRECONDITION_FAILED"

    invoke-direct {v0, v3, v2, v1}, Lio/ktor/http/content/VersionCheckResult;-><init>(Ljava/lang/String;ILio/ktor/http/erplbhbeyt;)V

    sput-object v0, Lio/ktor/http/content/VersionCheckResult;->PRECONDITION_FAILED:Lio/ktor/http/content/VersionCheckResult;

    invoke-static {}, Lio/ktor/http/content/VersionCheckResult;->khjnvckbwi()[Lio/ktor/http/content/VersionCheckResult;

    move-result-object v0

    sput-object v0, Lio/ktor/http/content/VersionCheckResult;->cbsxzgznvp:[Lio/ktor/http/content/VersionCheckResult;

    return-void
.end method

.method private constructor <init>(Ljava/lang/String;ILio/ktor/http/erplbhbeyt;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lio/ktor/http/content/VersionCheckResult;->statusCode:Lio/ktor/http/erplbhbeyt;

    return-void
.end method

.method private static final synthetic khjnvckbwi()[Lio/ktor/http/content/VersionCheckResult;
    .locals 3
...
.method public static values()[Lio/ktor/http/content/VersionCheckResult;
    ...
    sget-object v0, Lio/ktor/http/content/VersionCheckResult;->cbsxzgznvp:[Lio/ktor/http/content/VersionCheckResult;
...
# virtual methods
.method public final getStatusCode()Lio/ktor/http/erplbhbeyt;
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    iget-object v0, p0, Lio/ktor/http/content/VersionCheckResult;->statusCode:Lio/ktor/http/erplbhbeyt;
