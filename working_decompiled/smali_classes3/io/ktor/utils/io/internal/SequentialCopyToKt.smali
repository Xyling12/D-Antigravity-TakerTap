...
# direct methods
.method public static final feyxvdiekx(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 18
    ...
    invoke-direct {v2, v1}, Lio/ktor/utils/io/internal/SequentialCopyToKt$copyToSequentialImpl$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-virtual {v1}, Lio/ktor/utils/io/ByteChannelSequentialBase;->khjnvckbwi()Ljava/lang/Throwable;
    ...
    invoke-virtual {v0, v1}, Lio/ktor/utils/io/ByteChannelSequentialBase;->nhdortzefg(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {v1, v2}, Lio/ktor/utils/io/ByteChannelSequentialBase;->nuuhnxocxs(Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :cond_8
    invoke-virtual {v4, v0, v12, v13}, Lio/ktor/utils/io/ByteChannelSequentialBase;->P(Lio/ktor/utils/io/ByteChannelSequentialBase;J)J
    ...
    invoke-static {v4, v0, v12, v13, v2}, Lio/ktor/utils/io/internal/SequentialCopyToKt;->khjnvckbwi(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, v7, v2}, Lio/ktor/utils/io/ByteChannelSequentialBase;->juwnxwmdmo(ILkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v12, v13}, Lkotlin/coroutines/jvm/internal/qfzjddwuyn;->nhdortzefg(J)Ljava/lang/Long;
...
.method public static final ibzphkbtmt(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;ZLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 4
    .param p0    # Lio/ktor/utils/io/ByteChannelSequentialBase;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-direct {v0, p3}, Lio/ktor/utils/io/internal/SequentialCopyToKt$joinToImpl$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-static {p0, p1, v2, v3, v0}, Lio/ktor/utils/io/internal/SequentialCopyToKt;->feyxvdiekx(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method private static final khjnvckbwi(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p4}, Lio/ktor/utils/io/internal/SequentialCopyToKt$copyToTail$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-interface {p4}, Lio/ktor/utils/io/pool/nhdortzefg;->n1()Ljava/lang/Object;

    move-result-object p4

    check-cast p4, Lio/ktor/utils/io/core/internal/feyxvdiekx;

    :try_start_2
    invoke-virtual {p4}, Lio/ktor/utils/io/core/qfzjddwuyn;->kgyfkythat()I

    move-result v2

    int-to-long v5, v2

    invoke-static {p2, p3, v5, v6}, Lkotlin/ranges/ldyhhegomq;->jtuzwzphqf(JJ)J

    move-result-wide p2

    long-to-int p2, p2

    invoke-virtual {p4, p2}, Lio/ktor/utils/io/core/qfzjddwuyn;->tgyvlqjbcn(I)V
    ...
    invoke-virtual {p0, p4, v0}, Lio/ktor/utils/io/ByteChannelSequentialBase;->pgglzjfpqi(Lio/ktor/utils/io/core/internal/feyxvdiekx;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-virtual {p4, p1}, Lio/ktor/utils/io/core/internal/feyxvdiekx;->pldnqpfyrw(Lio/ktor/utils/io/pool/nhdortzefg;)V

    const-wide/16 p1, 0x0

    invoke-static {p1, p2}, Lkotlin/coroutines/jvm/internal/qfzjddwuyn;->nhdortzefg(J)Ljava/lang/Long;
    ...
    invoke-virtual {p4, p0}, Lio/ktor/utils/io/core/internal/feyxvdiekx;->pldnqpfyrw(Lio/ktor/utils/io/pool/nhdortzefg;)V
    ...
    invoke-virtual {p1, p4, v0}, Lio/ktor/utils/io/ByteChannelSequentialBase;->lrtruanqwg(Lio/ktor/utils/io/core/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, p2}, Lio/ktor/utils/io/core/internal/feyxvdiekx;->pldnqpfyrw(Lio/ktor/utils/io/pool/nhdortzefg;)V
...
.method public static final synthetic qfzjddwuyn(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lio/ktor/utils/io/internal/SequentialCopyToKt;->khjnvckbwi(Lio/ktor/utils/io/ByteChannelSequentialBase;Lio/ktor/utils/io/ByteChannelSequentialBase;JLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
