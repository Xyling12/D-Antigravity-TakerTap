...
# direct methods
.method public static final feyxvdiekx(Lio/ktor/websocket/ewnfwzyokr;Lw2/feyxvdiekx;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 16
    ...
    .param p1    # Lw2/feyxvdiekx;
        ...
        .end annotation
    .end param
    .param p2    # Lio/ktor/serialization/feyxvdiekx;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    invoke-direct {v1, v0}, Lio/ktor/websocket/serialization/WebsocketChannelSerializationKt$receiveDeserializedBase$2;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast v7, Lio/ktor/serialization/feyxvdiekx;
    ...
    invoke-interface/range {p0 .. p0}, Lio/ktor/websocket/ewnfwzyokr;->vlnjtcdbbq()Lkotlinx/coroutines/channels/ReceiveChannel;
    ...
    invoke-interface {v0, v1}, Lkotlinx/coroutines/channels/ReceiveChannel;->strivszpdp(Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    check-cast v12, Lio/ktor/websocket/khjnvckbwi;

    invoke-interface {v7, v12}, Lio/ktor/serialization/feyxvdiekx;->qfzjddwuyn(Lio/ktor/websocket/khjnvckbwi;)Z
    ...
    invoke-interface {v7, v8, v3, v12, v1}, Lio/ktor/serialization/feyxvdiekx;->feyxvdiekx(Ljava/nio/charset/Charset;Lw2/feyxvdiekx;Lio/ktor/websocket/khjnvckbwi;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v0}, Lkotlin/reflect/ibzphkbtmt;->jolohcwnyk(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1}, Lw2/feyxvdiekx;->extxjewlhp()Lkotlin/reflect/pednzybqgd;
    ...
    invoke-direct/range {v7 .. v12}, Lio/ktor/serialization/WebsocketDeserializeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Lio/ktor/websocket/khjnvckbwi;ILkotlin/jvm/internal/pyxggrwgoy;)V
    ...
    invoke-virtual {v12}, Lio/ktor/websocket/khjnvckbwi;->nhdortzefg()Lio/ktor/websocket/FrameType;
    ...
    invoke-direct/range {v9 .. v14}, Lio/ktor/serialization/WebsocketDeserializeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Lio/ktor/websocket/khjnvckbwi;ILkotlin/jvm/internal/pyxggrwgoy;)V

    throw v9
.end method

.method public static final ibzphkbtmt(Lio/ktor/websocket/ewnfwzyokr;Ljava/lang/Object;Lw2/feyxvdiekx;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 5
    .param p0    # Lio/ktor/websocket/ewnfwzyokr;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    .param p2    # Lw2/feyxvdiekx;
        ...
        .end annotation
    .end param
    .param p3    # Lio/ktor/serialization/feyxvdiekx;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    ...
    invoke-direct {v0, p5}, Lio/ktor/websocket/serialization/WebsocketChannelSerializationKt$sendSerializedBase$2;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-interface {p3, p4, p2, p1, v0}, Lio/ktor/serialization/feyxvdiekx;->khjnvckbwi(Ljava/nio/charset/Charset;Lw2/feyxvdiekx;Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :cond_4
    :goto_1
    check-cast p5, Lio/ktor/websocket/khjnvckbwi;

    invoke-interface {p0}, Lio/ktor/websocket/ewnfwzyokr;->jfjhscekir()Lkotlinx/coroutines/channels/cqwyelzfbm;
    ...
    invoke-interface {p0, p5, v0}, Lkotlinx/coroutines/channels/cqwyelzfbm;->cbvdcosrqn(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic khjnvckbwi(Lio/ktor/websocket/ewnfwzyokr;Ljava/lang/Object;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {v3 .. v8}, Lio/ktor/websocket/serialization/WebsocketChannelSerializationKt;->ibzphkbtmt(Lio/ktor/websocket/ewnfwzyokr;Ljava/lang/Object;Lw2/feyxvdiekx;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic qfzjddwuyn(Lio/ktor/websocket/ewnfwzyokr;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, v0, p1, p2, p3}, Lio/ktor/websocket/serialization/WebsocketChannelSerializationKt;->feyxvdiekx(Lio/ktor/websocket/ewnfwzyokr;Lw2/feyxvdiekx;Lio/ktor/serialization/feyxvdiekx;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
