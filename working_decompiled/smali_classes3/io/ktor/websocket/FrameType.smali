...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/ktor/websocket/FrameType$qfzjddwuyn;
    }
.end annotation
...
.field public static final Companion:Lio/ktor/websocket/FrameType$qfzjddwuyn;
...
.field private static final cbsxzgznvp:I

.field private static final synthetic kqhmbgiocc:[Lio/ktor/websocket/FrameType;

.field private static final xglnwpaccw:[Lio/ktor/websocket/FrameType;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lio/ktor/websocket/FrameType;->khjnvckbwi()[Lio/ktor/websocket/FrameType;

    move-result-object v0

    sput-object v0, Lio/ktor/websocket/FrameType;->kqhmbgiocc:[Lio/ktor/websocket/FrameType;

    new-instance v0, Lio/ktor/websocket/FrameType$qfzjddwuyn;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/ktor/websocket/FrameType$qfzjddwuyn;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V

    sput-object v0, Lio/ktor/websocket/FrameType;->Companion:Lio/ktor/websocket/FrameType$qfzjddwuyn;
    ...
    new-instance v7, Lkotlin/ranges/lsvcqaryex;

    invoke-direct {v7, v3, v5}, Lkotlin/ranges/lsvcqaryex;-><init>(II)V

    invoke-virtual {v7}, Lkotlin/ranges/tthmnequln;->lsvcqaryex()Lkotlin/collections/jfjhscekir;
    ...
    sput v0, Lio/ktor/websocket/FrameType;->cbsxzgznvp:I
    ...
    :cond_8
    sput-object v4, Lio/ktor/websocket/FrameType;->xglnwpaccw:[Lio/ktor/websocket/FrameType;
...
.method public static final synthetic access$getByOpcodeArray$cp()[Lio/ktor/websocket/FrameType;
    ...
    sget-object v0, Lio/ktor/websocket/FrameType;->xglnwpaccw:[Lio/ktor/websocket/FrameType;
...
.method public static final synthetic access$getMaxOpcode$cp()I
    ...
    sget v0, Lio/ktor/websocket/FrameType;->cbsxzgznvp:I

    return v0
.end method

.method private static final synthetic khjnvckbwi()[Lio/ktor/websocket/FrameType;
    .locals 5
...
.method public static values()[Lio/ktor/websocket/FrameType;
    ...
    sget-object v0, Lio/ktor/websocket/FrameType;->kqhmbgiocc:[Lio/ktor/websocket/FrameType;
