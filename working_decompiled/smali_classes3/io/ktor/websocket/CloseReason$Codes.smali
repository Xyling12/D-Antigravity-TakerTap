...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/ktor/websocket/CloseReason$Codes$qfzjddwuyn;
    }
.end annotation
...
.field public static final Companion:Lio/ktor/websocket/CloseReason$Codes$qfzjddwuyn;
...
.field private static final synthetic xglnwpaccw:[Lio/ktor/websocket/CloseReason$Codes;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lio/ktor/websocket/CloseReason$Codes;->khjnvckbwi()[Lio/ktor/websocket/CloseReason$Codes;

    move-result-object v0

    sput-object v0, Lio/ktor/websocket/CloseReason$Codes;->xglnwpaccw:[Lio/ktor/websocket/CloseReason$Codes;

    new-instance v0, Lio/ktor/websocket/CloseReason$Codes$qfzjddwuyn;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/ktor/websocket/CloseReason$Codes$qfzjddwuyn;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V

    sput-object v0, Lio/ktor/websocket/CloseReason$Codes;->Companion:Lio/ktor/websocket/CloseReason$Codes$qfzjddwuyn;
    ...
    :cond_0
    sput-object v2, Lio/ktor/websocket/CloseReason$Codes;->cbsxzgznvp:Ljava/util/Map;
...
.method public static final synthetic access$getByCodeMap$cp()Ljava/util/Map;
    ...
    sget-object v0, Lio/ktor/websocket/CloseReason$Codes;->cbsxzgznvp:Ljava/util/Map;

    return-object v0
.end method

.method private static final synthetic khjnvckbwi()[Lio/ktor/websocket/CloseReason$Codes;
    .locals 12
...
.method public static values()[Lio/ktor/websocket/CloseReason$Codes;
    ...
    sget-object v0, Lio/ktor/websocket/CloseReason$Codes;->xglnwpaccw:[Lio/ktor/websocket/CloseReason$Codes;
