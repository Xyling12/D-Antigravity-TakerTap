...
# interfaces
.implements Lio/ktor/serialization/kotlinx/ibzphkbtmt;
...
.field private final feyxvdiekx:Ljava/util/Map;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;",
            ">;"
        }
    .end annotation
.end field

.field private final qfzjddwuyn:Lkotlinx/serialization/json/qfzjddwuyn;
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation
.end field
...
# direct methods
.method public constructor <init>(Lkotlinx/serialization/json/qfzjddwuyn;)V
    .locals 1
    ...
    iput-object p1, p0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->qfzjddwuyn:Lkotlinx/serialization/json/qfzjddwuyn;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->feyxvdiekx:Ljava/util/Map;

    return-void
.end method

.method public static final synthetic ibzphkbtmt(Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;Lkotlinx/coroutines/flow/qhoahqxrkc;Lkotlinx/serialization/drkbbjxjkt;Ljava/nio/charset/Charset;Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-direct/range {p0 .. p5}, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->qhoahqxrkc(Lkotlinx/coroutines/flow/qhoahqxrkc;Lkotlinx/serialization/drkbbjxjkt;Ljava/nio/charset/Charset;Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic khjnvckbwi(Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;)Lkotlinx/serialization/json/qfzjddwuyn;
    .locals 0

    iget-object p0, p0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->qfzjddwuyn:Lkotlinx/serialization/json/qfzjddwuyn;

    return-object p0
.end method

.method private final qhoahqxrkc(Lkotlinx/coroutines/flow/qhoahqxrkc;Lkotlinx/serialization/drkbbjxjkt;Ljava/nio/charset/Charset;Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v4, v0, v3}, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions$serialize$3;-><init>(Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-static {v3}, Lkotlin/klvawbfmro;->bveuzccgjl(Ljava/lang/Object;)V
    ...
    check-cast v1, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;
    ...
    check-cast v9, Lkotlinx/serialization/drkbbjxjkt;
    ...
    check-cast v11, Lkotlinx/coroutines/flow/qhoahqxrkc;
    ...
    iget-object v3, v0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->feyxvdiekx:Ljava/util/Map;
    ...
    new-instance v6, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;

    invoke-direct {v6, v1}, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;-><init>(Ljava/nio/charset/Charset;)V
    ...
    check-cast v3, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;

    invoke-virtual {v3}, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;->qfzjddwuyn()[B
    ...
    invoke-static {v2, v6, v4}, Lio/ktor/utils/io/ByteWriteChannelKt;->extxjewlhp(Lio/ktor/utils/io/extxjewlhp;[BLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-direct/range {v12 .. v17}, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions$serialize$$inlined$collectIndexed$1;-><init>(Lio/ktor/utils/io/extxjewlhp;Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;Lkotlinx/serialization/drkbbjxjkt;Ljava/nio/charset/Charset;)V
    ...
    invoke-interface {v11, v12, v4}, Lkotlinx/coroutines/flow/qhoahqxrkc;->qfzjddwuyn(Lkotlinx/coroutines/flow/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :goto_3
    invoke-virtual {v1}, Lio/ktor/serialization/kotlinx/json/qfzjddwuyn;->feyxvdiekx()[B
    ...
    invoke-static {v2, v1, v4}, Lio/ktor/utils/io/ByteWriteChannelKt;->extxjewlhp(Lio/ktor/utils/io/extxjewlhp;[BLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public feyxvdiekx(Lio/ktor/http/extxjewlhp;Ljava/nio/charset/Charset;Lw2/feyxvdiekx;Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-virtual {p3}, Lw2/feyxvdiekx;->kgyfkythat()Lkotlin/reflect/ibzphkbtmt;

    move-result-object v0

    const-class v1, Lkotlinx/coroutines/flow/qhoahqxrkc;
    ...
    :cond_0
    invoke-static {p3}, Lio/ktor/serialization/kotlinx/json/khjnvckbwi;->qfzjddwuyn(Lw2/feyxvdiekx;)Lw2/feyxvdiekx;

    move-result-object p3

    iget-object v0, p0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->qfzjddwuyn:Lkotlinx/serialization/json/qfzjddwuyn;

    invoke-virtual {v0}, Lkotlinx/serialization/json/qfzjddwuyn;->qfzjddwuyn()Lkotlinx/serialization/modules/qhoahqxrkc;

    move-result-object v0

    invoke-static {v0, p3}, Lio/ktor/serialization/kotlinx/nhdortzefg;->ibzphkbtmt(Lkotlinx/serialization/modules/qhoahqxrkc;Lw2/feyxvdiekx;)Lkotlinx/serialization/drkbbjxjkt;

    move-result-object v4

    new-instance p3, Lio/ktor/http/content/ibzphkbtmt;
    ...
    invoke-direct/range {v1 .. v6}, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions$serialize$2;-><init>(Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;Ljava/lang/Object;Lkotlinx/serialization/drkbbjxjkt;Ljava/nio/charset/Charset;Lkotlin/coroutines/khjnvckbwi;)V

    invoke-static/range {p1 .. p2}, Lio/ktor/http/kgyfkythat;->khjnvckbwi(Lio/ktor/http/extxjewlhp;Ljava/nio/charset/Charset;)Lio/ktor/http/extxjewlhp;
    ...
    invoke-direct/range {v5 .. v11}, Lio/ktor/http/content/ibzphkbtmt;-><init>(Ls3/lohkmxcimj;Lio/ktor/http/extxjewlhp;Lio/ktor/http/erplbhbeyt;Ljava/lang/Long;ILkotlin/jvm/internal/pyxggrwgoy;)V
...
.method public qfzjddwuyn(Ljava/nio/charset/Charset;Lw2/feyxvdiekx;Lio/ktor/utils/io/ByteReadChannel;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p4}, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions$deserialize$1;-><init>(Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;Lkotlin/coroutines/khjnvckbwi;)V
    ...
    sget-object p4, Lkotlin/text/ibzphkbtmt;->feyxvdiekx:Ljava/nio/charset/Charset;

    invoke-static {p1, p4}, Lkotlin/jvm/internal/erplbhbeyt;->nhdortzefg(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    const-class p4, Lkotlin/sequences/rmnxkaltsn;
    ...
    :cond_3
    :try_start_1
    iget-object p1, p0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions;->qfzjddwuyn:Lkotlinx/serialization/json/qfzjddwuyn;

    iput v3, v0, Lio/ktor/serialization/kotlinx/json/KotlinxSerializationJsonExtensions$deserialize$1;->label:I

    invoke-static {p1, p3, p2, v0}, Lio/ktor/serialization/kotlinx/json/JsonExtensionsJvmKt;->qfzjddwuyn(Lkotlinx/serialization/json/qfzjddwuyn;Lio/ktor/utils/io/ByteReadChannel;Lw2/feyxvdiekx;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
