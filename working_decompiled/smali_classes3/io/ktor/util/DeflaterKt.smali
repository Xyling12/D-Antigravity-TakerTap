...
.field public static final qfzjddwuyn:S = -0x74e1s
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/ktor/util/DeflaterKt;->feyxvdiekx:[B

    return-void
.end method

.method private static final bveuzccgjl(Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 6
    ...
    invoke-direct {v0, p1}, Lio/ktor/util/DeflaterKt$putGzipHeader$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-interface {p0, p1, v0}, Lio/ktor/utils/io/extxjewlhp;->sqegvvfvzl(SLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1, v0}, Lio/ktor/utils/io/extxjewlhp;->vlnjtcdbbq(BLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :cond_6
    :goto_2
    sget-object p1, Lio/ktor/util/DeflaterKt;->feyxvdiekx:[B
    ...
    invoke-static {p0, p1, v0}, Lio/ktor/utils/io/ByteWriteChannelKt;->extxjewlhp(Lio/ktor/utils/io/extxjewlhp;[BLkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final drkbbjxjkt(Lio/ktor/utils/io/ByteReadChannel;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;)Lio/ktor/utils/io/ByteReadChannel;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lio/ktor/util/DeflaterKt$deflated$1;-><init>(Lio/ktor/utils/io/ByteReadChannel;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;)V

    const/4 p0, 0x1

    invoke-static {v0, p3, p0, v1}, Lio/ktor/utils/io/CoroutinesKt;->rmnxkaltsn(Lkotlinx/coroutines/oltojwzksj;Lkotlin/coroutines/CoroutineContext;ZLs3/lohkmxcimj;)Lio/ktor/utils/io/opauvyugnb;
...
.method public static final ewnfwzyokr(Ljava/util/zip/Checksum;Ljava/nio/ByteBuffer;)V
    .locals 3
...
.method private static final extxjewlhp(Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;)V
    .locals 3
...
.method public static final synthetic feyxvdiekx(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;Ls3/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lio/ktor/util/DeflaterKt;->kgyfkythat(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;Ls3/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic ibzphkbtmt(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Checksum;Ljava/util/zip/Deflater;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lio/ktor/util/DeflaterKt;->thjjozpxyz(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Checksum;Ljava/util/zip/Deflater;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method private static final kgyfkythat(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;Ls3/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p4}, Lio/ktor/util/DeflaterKt$deflateWhile$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast p3, Lio/ktor/utils/io/extxjewlhp;
    ...
    invoke-static {p1, p2}, Lio/ktor/util/DeflaterKt;->extxjewlhp(Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;)V
    ...
    invoke-interface {p0, p2, v0}, Lio/ktor/utils/io/extxjewlhp;->thjjozpxyz(Ljava/nio/ByteBuffer;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic khjnvckbwi(Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0

    invoke-static {p0, p1}, Lio/ktor/util/DeflaterKt;->bveuzccgjl(Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static synthetic ktvtxjqbtt(Lio/ktor/utils/io/ByteReadChannel;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;ILjava/lang/Object;)Lio/ktor/utils/io/ByteReadChannel;
    .locals 0
    ...
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lio/ktor/util/DeflaterKt;->drkbbjxjkt(Lio/ktor/utils/io/ByteReadChannel;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;)Lio/ktor/utils/io/ByteReadChannel;
...
.method private static final lohkmxcimj(Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;)V
    .locals 3
...
.method public static synthetic lsvcqaryex(Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;ILjava/lang/Object;)Lio/ktor/utils/io/extxjewlhp;
    .locals 0
    ...
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lio/ktor/util/DeflaterKt;->tthmnequln(Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;)Lio/ktor/utils/io/extxjewlhp;
...
.method static synthetic nhdortzefg(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 0
    ...
    :cond_1
    invoke-static {p0, p1, p2, p3, p4}, Lio/ktor/util/DeflaterKt;->qhoahqxrkc(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final synthetic qfzjddwuyn(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0
...
.method private static final qhoahqxrkc(Lio/ktor/utils/io/ByteReadChannel;Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v3, v2}, Lio/ktor/util/DeflaterKt$deflateTo$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    check-cast v3, Lio/ktor/utils/io/pool/nhdortzefg;
    ...
    check-cast v9, Lio/ktor/utils/io/pool/nhdortzefg;

    iget-object v11, v3, Lio/ktor/util/DeflaterKt$deflateTo$1;->L$0:Ljava/lang/Object;

    check-cast v11, Lio/ktor/utils/io/extxjewlhp;
    ...
    check-cast v13, Lio/ktor/utils/io/pool/nhdortzefg;
    ...
    invoke-interface/range {p3 .. p3}, Lio/ktor/utils/io/pool/nhdortzefg;->n1()Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Lio/ktor/util/DeflaterKt;->bveuzccgjl(Lio/ktor/utils/io/extxjewlhp;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :goto_5
    :try_start_6
    invoke-interface {v14}, Lio/ktor/utils/io/ByteReadChannel;->goeuijvzrq()Z
    ...
    invoke-interface {v14, v5, v3}, Lio/ktor/utils/io/ByteReadChannel;->rbnwhbktth(Ljava/nio/ByteBuffer;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v13, v11}, Lio/ktor/util/DeflaterKt;->ewnfwzyokr(Ljava/util/zip/Checksum;Ljava/nio/ByteBuffer;)V

    invoke-static {v12, v11}, Lio/ktor/util/DeflaterKt;->lohkmxcimj(Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v0, v12, v3, v2, v5}, Lio/ktor/util/DeflaterKt;->kgyfkythat(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;Ls3/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    :cond_b
    :try_start_8
    invoke-interface {v14}, Lio/ktor/utils/io/ByteReadChannel;->khjnvckbwi()Ljava/lang/Throwable;
    ...
    invoke-static {v0, v11, v2, v8, v3}, Lio/ktor/util/DeflaterKt;->kgyfkythat(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Deflater;Ljava/nio/ByteBuffer;Ls3/qfzjddwuyn;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v2, v8, v11, v3}, Lio/ktor/util/DeflaterKt;->thjjozpxyz(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Checksum;Ljava/util/zip/Deflater;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-interface {v13, v5}, Lio/ktor/utils/io/pool/nhdortzefg;->j3(Ljava/lang/Object;)V

    invoke-interface {v13, v1}, Lio/ktor/utils/io/pool/nhdortzefg;->j3(Ljava/lang/Object;)V
    ...
    invoke-interface {v13, v4}, Lio/ktor/utils/io/pool/nhdortzefg;->j3(Ljava/lang/Object;)V
...
.method public static final rmnxkaltsn()[B
    .locals 1
    .annotation build Ld6/ktvtxjqbtt;
    .end annotation

    sget-object v0, Lio/ktor/util/DeflaterKt;->feyxvdiekx:[B

    return-object v0
.end method

.method private static final thjjozpxyz(Lio/ktor/utils/io/extxjewlhp;Ljava/util/zip/Checksum;Ljava/util/zip/Deflater;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p3}, Lio/ktor/util/DeflaterKt$putGzipTrailer$1;-><init>(Lkotlin/coroutines/khjnvckbwi;)V
    ...
    invoke-interface {p0, p1, v0}, Lio/ktor/utils/io/extxjewlhp;->cbvdcosrqn(ILkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public static final tthmnequln(Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/CoroutineContext;)Lio/ktor/utils/io/extxjewlhp;
    .locals 3
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lio/ktor/util/DeflaterKt$deflated$2;-><init>(Lio/ktor/utils/io/extxjewlhp;ZLio/ktor/utils/io/pool/nhdortzefg;Lkotlin/coroutines/khjnvckbwi;)V

    const/4 p0, 0x1

    invoke-static {v0, p3, p0, v1}, Lio/ktor/utils/io/CoroutinesKt;->qhoahqxrkc(Lkotlinx/coroutines/oltojwzksj;Lkotlin/coroutines/CoroutineContext;ZLs3/lohkmxcimj;)Lio/ktor/utils/io/pednzybqgd;
