...
# instance fields
.field final synthetic $$this$writer:Lio/ktor/utils/io/jodmjjzdpr;
...
# direct methods
.method constructor <init>(Lio/ktor/utils/io/jodmjjzdpr;Ljava/nio/channels/FileChannel;Lkotlin/coroutines/khjnvckbwi;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->$$this$writer:Lio/ktor/utils/io/jodmjjzdpr;
...
.method public final create(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Lkotlin/coroutines/khjnvckbwi;
    ...
    iget-object v1, p0, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->$$this$writer:Lio/ktor/utils/io/jodmjjzdpr;

    iget-object v2, p0, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->$fileChannel:Ljava/nio/channels/FileChannel;

    invoke-direct {v0, v1, v2, p2}, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;-><init>(Lio/ktor/utils/io/jodmjjzdpr;Ljava/nio/channels/FileChannel;Lkotlin/coroutines/khjnvckbwi;)V
...
.method public final invoke(Lio/ktor/utils/io/bdweufyeak;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    .locals 0
    .param p1    # Lio/ktor/utils/io/bdweufyeak;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    .end param
    .param p2    # Lkotlin/coroutines/khjnvckbwi;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->create(Ljava/lang/Object;Lkotlin/coroutines/khjnvckbwi;)Lkotlin/coroutines/khjnvckbwi;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2
    check-cast p1, Lio/ktor/utils/io/bdweufyeak;

    check-cast p2, Lkotlin/coroutines/khjnvckbwi;

    invoke-virtual {p0, p1, p2}, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->invoke(Lio/ktor/utils/io/bdweufyeak;Lkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    check-cast v1, Lio/ktor/utils/io/bdweufyeak;
    ...
    :cond_2
    :goto_0
    invoke-interface {v1, v2}, Lio/ktor/utils/io/czxichccep;->qfzjddwuyn(I)Lio/ktor/utils/io/core/internal/feyxvdiekx;

    move-result-object p1

    if-nez p1, :cond_3

    iget-object p1, p0, Lio/ktor/util/cio/FileChannelsKt$readChannel$1$3$1;->$$this$writer:Lio/ktor/utils/io/jodmjjzdpr;
    ...
    invoke-interface {v1, v2, p0}, Lio/ktor/utils/io/bdweufyeak;->khjnvckbwi(ILkotlin/coroutines/khjnvckbwi;)Ljava/lang/Object;
    ...
    invoke-static {v3, p1}, Lio/ktor/util/kgyfkythat;->qfzjddwuyn(Ljava/nio/channels/ReadableByteChannel;Lio/ktor/utils/io/core/internal/feyxvdiekx;)I
    ...
    invoke-interface {v1, p1}, Lio/ktor/utils/io/czxichccep;->feyxvdiekx(I)V
