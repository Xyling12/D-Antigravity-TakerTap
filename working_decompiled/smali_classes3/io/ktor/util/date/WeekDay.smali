...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lio/ktor/util/date/WeekDay$qfzjddwuyn;
    }
.end annotation
...
# static fields
.field public static final Companion:Lio/ktor/util/date/WeekDay$qfzjddwuyn;
...
.field private static final synthetic cbsxzgznvp:[Lio/ktor/util/date/WeekDay;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lio/ktor/util/date/WeekDay;->khjnvckbwi()[Lio/ktor/util/date/WeekDay;

    move-result-object v0

    sput-object v0, Lio/ktor/util/date/WeekDay;->cbsxzgznvp:[Lio/ktor/util/date/WeekDay;

    new-instance v0, Lio/ktor/util/date/WeekDay$qfzjddwuyn;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lio/ktor/util/date/WeekDay$qfzjddwuyn;-><init>(Lkotlin/jvm/internal/pyxggrwgoy;)V

    sput-object v0, Lio/ktor/util/date/WeekDay;->Companion:Lio/ktor/util/date/WeekDay$qfzjddwuyn;
...
.method private static final synthetic khjnvckbwi()[Lio/ktor/util/date/WeekDay;
    .locals 7
...
.method public static values()[Lio/ktor/util/date/WeekDay;
    ...
    sget-object v0, Lio/ktor/util/date/WeekDay;->cbsxzgznvp:[Lio/ktor/util/date/WeekDay;
