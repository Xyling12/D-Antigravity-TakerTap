.class public final Lio/ktor/util/jfjhscekir;
...
# direct methods
.method public static final feyxvdiekx(Ljava/nio/file/Path;Ljava/nio/file/Path;)Ljava/io/File;
    .locals 3
    ...
    invoke-static {p1}, Lio/ktor/util/jfjhscekir;->qhoahqxrkc(Ljava/nio/file/Path;)Ljava/nio/file/Path;
...
.method public static final ibzphkbtmt(Ljava/nio/file/Path;)Ljava/lang/String;
    .locals 3
    .param p0    # Ljava/nio/file/Path;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-static {p0, v2, v0, v1, v0}, Lkotlin/text/lohkmxcimj;->z3(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
...
.method private static final khjnvckbwi(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    .locals 4
...
.method public static final qfzjddwuyn(Ljava/io/File;Ljava/nio/file/Path;)Ljava/io/File;
    .locals 3
...
.method public static final qhoahqxrkc(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    .locals 1
    .param p0    # Ljava/nio/file/Path;
        .annotation build Ld6/ktvtxjqbtt;
        .end annotation
    ...
    invoke-static {v0}, Lio/ktor/util/jfjhscekir;->khjnvckbwi(Ljava/nio/file/Path;)Ljava/nio/file/Path;
    ...
    invoke-static {p0}, Lio/ktor/util/jfjhscekir;->khjnvckbwi(Ljava/nio/file/Path;)Ljava/nio/file/Path;
