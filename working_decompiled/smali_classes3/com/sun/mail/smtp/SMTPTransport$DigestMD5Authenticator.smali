...
.method doAuth(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p2, p0, Lcom/sun/mail/smtp/SMTPTransport$DigestMD5Authenticator;->this$0:Lcom/sun/mail/smtp/SMTPTransport;

    invoke-virtual {p2}, Lcom/sun/mail/smtp/SMTPTransport;->getSASLRealm()Ljava/lang/String;
    ...
    invoke-virtual {p2, p1}, Lcom/sun/mail/smtp/SMTPTransport;->simpleCommand([B)I
    ...
    invoke-virtual {v0, p1}, Lcom/sun/mail/smtp/DigestMD5;->authServer(Ljava/lang/String;)Z
