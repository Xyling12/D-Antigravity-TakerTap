...
.field private readbuf:Lcom/sun/mail/iap/ibzphkbtmt;
...
.method private fill()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/sun/mail/imap/IMAPInputStream;->readbuf:Lcom/sun/mail/iap/ibzphkbtmt;
    ...
    invoke-direct {v0, v2}, Lcom/sun/mail/iap/ibzphkbtmt;-><init>(I)V

    iput-object v0, p0, Lcom/sun/mail/imap/IMAPInputStream;->readbuf:Lcom/sun/mail/iap/ibzphkbtmt;
    ...
    iget v0, p0, Lcom/sun/mail/imap/IMAPInputStream;->blksize:I
    ...
    iget-object v8, p0, Lcom/sun/mail/imap/IMAPInputStream;->readbuf:Lcom/sun/mail/iap/ibzphkbtmt;

    invoke-virtual/range {v3 .. v8}, Lcom/sun/mail/imap/protocol/IMAPProtocol;->peekBody(ILjava/lang/String;IILcom/sun/mail/iap/ibzphkbtmt;)Lcom/sun/mail/imap/protocol/BODY;
    ...
    invoke-virtual/range {v3 .. v8}, Lcom/sun/mail/imap/protocol/IMAPProtocol;->fetchBody(ILjava/lang/String;IILcom/sun/mail/iap/ibzphkbtmt;)Lcom/sun/mail/imap/protocol/BODY;
    ...
    :try_start_1
    invoke-virtual {v0}, Lcom/sun/mail/imap/protocol/BODY;->getByteArray()Lcom/sun/mail/iap/ibzphkbtmt;
    ...
    new-instance v3, Lcom/sun/mail/iap/ibzphkbtmt;

    invoke-direct {v3, v1}, Lcom/sun/mail/iap/ibzphkbtmt;-><init>(I)V
    ...
    :cond_6
    invoke-virtual {v3}, Lcom/sun/mail/iap/ibzphkbtmt;->qfzjddwuyn()[B

    move-result-object v2

    iput-object v2, p0, Lcom/sun/mail/imap/IMAPInputStream;->buf:[B

    invoke-virtual {v3}, Lcom/sun/mail/iap/ibzphkbtmt;->ibzphkbtmt()I

    move-result v2

    iput v2, p0, Lcom/sun/mail/imap/IMAPInputStream;->bufpos:I

    invoke-virtual {v3}, Lcom/sun/mail/iap/ibzphkbtmt;->feyxvdiekx()I
    ...
    :cond_8
    iput-boolean v1, p0, Lcom/sun/mail/imap/IMAPInputStream;->lastBuffer:Z
    ...
    invoke-direct {v1, v3, v0}, Lcom/sun/mail/util/FolderClosedIOException;-><init>(Ljavax/mail/Folder;Ljava/lang/String;)V
