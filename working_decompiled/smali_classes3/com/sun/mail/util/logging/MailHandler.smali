...
.method private getAndSetContextClassLoader(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_0
    invoke-static {p1}, Lcom/sun/mail/util/logging/LogManagerProperties;->runOrDoPrivileged(Ljava/security/PrivilegedAction;)Ljava/lang/Object;
...
.method private verifySettings0(Ljavax/mail/Session;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-direct {v1}, Lcom/sun/mail/util/logging/MailHandler;->getEncodingName()Ljava/lang/String;
    ...
    :try_start_5
    invoke-virtual {v2}, Ljavax/mail/Session;->getTransport()Ljavax/mail/Transport;

    move-result-object v0
    :try_end_5
    .catch Ljavax/mail/MessagingException; {:try_start_5 .. :try_end_5} :catch_10
    ...
    :try_end_d
    .catch Ljavax/mail/MessagingException; {:try_start_d .. :try_end_d} :catch_6
    ...
    invoke-static {v2, v0}, Lcom/sun/mail/util/logging/MailHandler;->verifyProperties(Ljavax/mail/Session;Ljava/lang/String;)V
    :try_end_e
    .catch Ljavax/mail/SendFailedException; {:try_start_e .. :try_end_e} :catch_8
    .catch Ljavax/mail/MessagingException; {:try_start_e .. :try_end_e} :catch_7
    ...
    throw v2
    :try_end_10
    .catch Ljavax/mail/SendFailedException; {:try_start_10 .. :try_end_10} :catch_b
    ...
    :try_start_1b
    invoke-virtual {v1}, Lcom/sun/mail/util/logging/MailHandler;->getFormatter()Ljava/util/logging/Formatter;
    ...
    invoke-direct {v1}, Lcom/sun/mail/util/logging/MailHandler;->createBodyPart()Ljavax/mail/internet/MimeBodyPart;
    ...
    :try_start_22
    invoke-static {v12, v0}, Lcom/sun/mail/util/logging/MailHandler;->attach(Ljavax/mail/MessagingException;Ljava/lang/Exception;)Ljavax/mail/MessagingException;
...
.method private writeLogRecords0()Ljavax/mail/Message;
    ...
    invoke-direct {v0}, Lcom/sun/mail/util/logging/MailHandler;->sort()V

    iget-object v1, v0, Lcom/sun/mail/util/logging/MailHandler;->session:Ljavax/mail/Session;

    if-nez v1, :cond_0

    invoke-direct {v0}, Lcom/sun/mail/util/logging/MailHandler;->initSession()Ljavax/mail/Session;
    ...
    invoke-virtual {v0}, Lcom/sun/mail/util/logging/MailHandler;->getFormatter()Ljava/util/logging/Formatter;

    move-result-object v5

    invoke-virtual {v0}, Lcom/sun/mail/util/logging/MailHandler;->getFilter()Ljava/util/logging/Filter;
    ...
    invoke-direct {v0}, Lcom/sun/mail/util/logging/MailHandler;->createBodyPart()Ljavax/mail/internet/MimeBodyPart;
    ...
    invoke-interface {v4, v15}, Ljava/util/logging/Filter;->isLoggable(Ljava/util/logging/LogRecord;)Z
    ...
    invoke-direct {v0, v3}, Lcom/sun/mail/util/logging/MailHandler;->createBodyPart(I)Ljavax/mail/internet/MimeBodyPart;
    ...
    iget-object v9, v0, Lcom/sun/mail/util/logging/MailHandler;->attachmentFormatters:[Ljava/util/logging/Formatter;

    aget-object v9, v9, v3

    invoke-direct {v0, v9}, Lcom/sun/mail/util/logging/MailHandler;->head(Ljava/util/logging/Formatter;)Ljava/lang/String;
    ...
    iget-object v9, v0, Lcom/sun/mail/util/logging/MailHandler;->attachmentNames:[Ljava/util/logging/Formatter;
    ...
    invoke-direct {v0, v4, v9}, Lcom/sun/mail/util/logging/MailHandler;->appendFileName(Ljavax/mail/Part;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4, v14}, Lcom/sun/mail/util/logging/MailHandler;->appendContentLang(Ljavax/mail/internet/MimePart;Ljava/util/Locale;)V
    ...
    iput v3, v0, Lcom/sun/mail/util/logging/MailHandler;->size:I
    ...
    iget-object v8, v0, Lcom/sun/mail/util/logging/MailHandler;->attachmentNames:[Ljava/util/logging/Formatter;

    aget-object v8, v8, v3

    const-string v9, "err"

    invoke-direct {v0, v8, v9}, Lcom/sun/mail/util/logging/MailHandler;->tail(Ljava/util/logging/Formatter;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    invoke-direct {v0, v7, v8}, Lcom/sun/mail/util/logging/MailHandler;->appendFileName(Ljavax/mail/Part;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v8, v4}, Lcom/sun/mail/util/logging/MailHandler;->tail(Ljava/util/logging/Formatter;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Ljavax/mail/internet/MimeBodyPart;->getFileName()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Lcom/sun/mail/util/logging/MailHandler;->isEmpty(Ljava/lang/CharSequence;)Z
    ...
    invoke-direct {v0, v4}, Lcom/sun/mail/util/logging/MailHandler;->toString(Ljava/util/logging/Formatter;)Ljava/lang/String;

    move-result-object v4

    aget-object v7, v18, v3

    invoke-virtual {v7, v4}, Ljavax/mail/internet/MimeBodyPart;->setFileName(Ljava/lang/String;)V
    ...
    invoke-direct {v0, v4}, Lcom/sun/mail/util/logging/MailHandler;->getContentType(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {v0, v7, v8, v4}, Lcom/sun/mail/util/logging/MailHandler;->setContent(Ljavax/mail/internet/MimePart;Ljava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v6, v4}, Lcom/sun/mail/util/logging/MailHandler;->tail(Ljava/util/logging/Formatter;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v7, v4}, Lcom/sun/mail/util/logging/MailHandler;->tail(Ljava/util/logging/Formatter;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-direct {v0, v1, v4}, Lcom/sun/mail/util/logging/MailHandler;->appendSubject(Ljavax/mail/Message;Ljava/lang/String;)V
    ...
    :goto_9
    invoke-direct {v0, v5, v11, v4}, Lcom/sun/mail/util/logging/MailHandler;->setContent(Ljavax/mail/internet/MimePart;Ljava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v5}, Ljavax/mail/internet/MimeMultipart;->addBodyPart(Ljavax/mail/BodyPart;)V
    ...
    invoke-virtual {v4, v3}, Ljavax/mail/internet/MimeMultipart;->addBodyPart(Ljavax/mail/BodyPart;)V
    ...
    :cond_16
    invoke-virtual {v1, v4}, Ljavax/mail/internet/MimeMessage;->setContent(Ljavax/mail/Multipart;)V
