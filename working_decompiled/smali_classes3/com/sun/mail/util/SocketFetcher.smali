...
.method static constructor <clinit>()V
    ...
    const-string v1, "mail.socket.debug"

    const/4 v2, 0x0

    invoke-static {v1, v2}, Lcom/sun/mail/util/PropUtil;->getBooleanSystemProperty(Ljava/lang/String;Z)Z
...
.method private static createSocket(Ljava/net/InetAddress;ILjava/lang/String;IIILjava/util/Properties;Ljava/lang/String;Ljavax/net/SocketFactory;Z)Ljava/net/Socket;
    ...
    invoke-virtual {v4, v12}, Lcom/sun/mail/util/MailLogger;->finest(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v4, v12}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, v13, v12}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, v14, v12}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v6, v3}, Lcom/sun/mail/util/PropUtil;->getIntProperty(Ljava/util/Properties;Ljava/lang/String;I)I
    ...
    const-string v12, "Using web proxy host, port: "
    ...
    sget-object v12, Lcom/sun/mail/util/SocketFetcher;->logger:Lcom/sun/mail/util/MailLogger;

    sget-object v15, Ljava/util/logging/Level;->FINER:Ljava/util/logging/Level;

    invoke-virtual {v12, v15}, Lcom/sun/mail/util/MailLogger;->isLoggable(Ljava/util/logging/Level;)Z
    ...
    const-string v6, "web proxy host "
    ...
    invoke-virtual {v12, v5}, Lcom/sun/mail/util/MailLogger;->finer(Ljava/lang/String;)V
    ...
    const-string v12, "web proxy user "
    ...
    invoke-virtual {v8, v3, v6}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v4, v6}, Lcom/sun/mail/util/PropUtil;->getIntProperty(Ljava/util/Properties;Ljava/lang/String;I)I
    ...
    const-string v12, "Using SOCKS host, port: "
    ...
    instance-of v6, v10, Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-direct {v4, v3, v5}, Ljava/net/InetSocketAddress;-><init>(Ljava/lang/String;I)V

    invoke-direct {v6, v15, v4}, Ljava/net/Proxy;-><init>(Ljava/net/Proxy$Type;Ljava/net/SocketAddress;)V

    invoke-direct {v12, v6}, Ljava/net/Socket;-><init>(Ljava/net/Proxy;)V
    ...
    invoke-static {v8, v3, v6}, Lcom/sun/mail/util/PropUtil;->getBooleanProperty(Ljava/util/Properties;Ljava/lang/String;Z)Z
    ...
    invoke-static {v8, v2, v3}, Lcom/sun/mail/util/PropUtil;->getIntProperty(Ljava/util/Properties;Ljava/lang/String;I)I
    ...
    const-string v5, "set socket write timeout "
    ...
    invoke-direct {v3, v12, v2}, Lcom/sun/mail/util/WriteTimeoutSocket;-><init>(Ljava/net/Socket;I)V
    ...
    invoke-virtual {v0, v1, v7}, Ljava/net/Socket;->connect(Ljava/net/SocketAddress;I)V
    ...
    instance-of v1, v10, Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-virtual {v4, v1}, Lcom/sun/mail/util/MailSSLSocketFactory;->setTrustedHosts([Ljava/lang/String;)V
    :try_end_5
    ...
    :goto_9
    invoke-virtual {v1, v0, v3, v6, v2}, Ljavax/net/ssl/SSLSocketFactory;->createSocket(Ljava/net/Socket;Ljava/lang/String;IZ)Ljava/net/Socket;
    ...
    :goto_a
    invoke-static {v12, v3, v8, v9, v10}, Lcom/sun/mail/util/SocketFetcher;->configureSSLSocket(Ljava/net/Socket;Ljava/lang/String;Ljava/util/Properties;Ljava/lang/String;Ljavax/net/SocketFactory;)V
...
.method public static getSocket(Ljava/lang/String;ILjava/util/Properties;Ljava/lang/String;Z)Ljava/net/Socket;
    ...
    invoke-static {v7, v0, v1}, Lcom/sun/mail/util/PropUtil;->getIntProperty(Ljava/util/Properties;Ljava/lang/String;I)I
    ...
    invoke-virtual {v7, v0, v12}, Ljava/util/Properties;->getProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v0, v4}, Lcom/sun/mail/util/PropUtil;->getIntProperty(Ljava/util/Properties;Ljava/lang/String;I)I
    ...
    invoke-static {v7, v0, v6}, Lcom/sun/mail/util/PropUtil;->getBooleanProperty(Ljava/util/Properties;Ljava/lang/String;Z)Z
    ...
    .line 11
    const-string v9, "unknown socket factory"
    ...
    const-string v14, ".ssl.socketFactory"
    ...
    .line 13
    instance-of v14, v0, Ljavax/net/SocketFactory;
    ...
    const-string v15, "SSL socket factory instance "
    ...
    const-string v14, ".ssl.socketFactory.class"
    ...
    const-string v12, "SSL socket factory class "
    ...
    .line 20
    :cond_5
    const-string v12, ".ssl.socketFactory.port"
    ...
    invoke-virtual {v7, v12}, Ljava/util/Properties;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v12

    .line 22
    instance-of v14, v12, Ljavax/net/SocketFactory;
    ...
    const-string v14, "socket factory instance "
    ...
    const-string v12, ".socketFactory.class"
    ...
    const-string v15, "socket factory class "
    ...
    .line 29
    :cond_8
    const-string v12, ".socketFactory.port"
    :try_end_0
    ...
    const-string v2, "set socket read timeout "
...
.method private static proxyConnect(Ljava/net/Socket;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-direct {p7, v0, v5, v4}, Ljava/io/PrintStream;-><init>(Ljava/io/OutputStream;ZLjava/lang/String;)V
    ...
    invoke-direct {p4, p3, v6}, Ljava/lang/String;-><init>([BLjava/nio/charset/Charset;)V
    ...
    invoke-direct {p4, p7, v3}, Ljava/io/InputStreamReader;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
