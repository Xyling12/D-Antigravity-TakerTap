.class Lcom/soft373/db/bveuzccgjl$qfzjddwuyn;
...
.method constructor <init>(Lcom/soft373/db/bveuzccgjl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/soft373/db/bveuzccgjl$qfzjddwuyn;->ibzphkbtmt:Lcom/soft373/db/bveuzccgjl;
...
.method protected bridge synthetic drkbbjxjkt(Lthipomyfnm/drkbbjxjkt;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/soft373/db/bveuzccgjl$qfzjddwuyn;->vlnjtcdbbq(Lthipomyfnm/drkbbjxjkt;Lcom/soft373/data/kgyfkythat;)V
...
.method protected qhoahqxrkc()Ljava/lang/String;
    ...
    const-string v0, "INSERT OR REPLACE INTO `log_trip_data` (`timestamp`,`order_id`,`log_file_name`,`error`,`position`,`last_high_speed_json_pos`,`inner_start_time`,`inner_stop_time`,`prev_time`,`elapsed_real_time`,`last_valid_coordTime`,`uptime_millis`,`length`,`time`,`measurement`,`old_measurement`,`tax_state`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"

    return-object v0
.end method

.method protected vlnjtcdbbq(Lthipomyfnm/drkbbjxjkt;Lcom/soft373/data/kgyfkythat;)V
    .locals 3
    .param p1    # Lthipomyfnm/drkbbjxjkt;
        .annotation build Landroidx/annotation/yjsnmddfnr;
        .end annotation
    ...
    :goto_1
    iget-object v0, p0, Lcom/soft373/db/bveuzccgjl$qfzjddwuyn;->ibzphkbtmt:Lcom/soft373/db/bveuzccgjl;
