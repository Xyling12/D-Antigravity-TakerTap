.class Lcom/soft373/db/lsvcqaryex$feyxvdiekx;
...
.method constructor <init>(Lcom/soft373/db/lsvcqaryex;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/soft373/db/lsvcqaryex$feyxvdiekx;->ibzphkbtmt:Lcom/soft373/db/lsvcqaryex;
...
.method protected bridge synthetic drkbbjxjkt(Lthipomyfnm/drkbbjxjkt;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/soft373/db/lsvcqaryex$feyxvdiekx;->rmnxkaltsn(Lthipomyfnm/drkbbjxjkt;Lcom/soft373/data/nhdortzefg;)V
...
.method protected qhoahqxrkc()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR REPLACE `log_tax_data` SET `call_id` = ?,`city_id` = ?,`order_id` = ?,`phone` = ?,`start_time` = ?,`stop_time` = ?,`inner_start_time` = ?,`inner_stop_time` = ?,`prev_time` = ?,`pause_time` = ?,`last_valid_coord_time` = ?,`last_access_time` = ?,`valid_coord_count` = ?,`log_file_name` = ?,`tariff_data` = ?,`last_position` = ?,`last_measurement` = ? WHERE `call_id` = ?"

    return-object v0
.end method

.method protected rmnxkaltsn(Lthipomyfnm/drkbbjxjkt;Lcom/soft373/data/nhdortzefg;)V
    .locals 3
    .param p1    # Lthipomyfnm/drkbbjxjkt;
        .annotation build Landroidx/annotation/yjsnmddfnr;
        .end annotation
    ...
    :goto_1
    iget-object v0, p0, Lcom/soft373/db/lsvcqaryex$feyxvdiekx;->ibzphkbtmt:Lcom/soft373/db/lsvcqaryex;
    ...
    invoke-virtual {v0, v1}, Lcom/soft373/data/compatibility/feyxvdiekx;->feyxvdiekx(Lcom/soft373/data/Measurement;)Ljava/lang/String;
