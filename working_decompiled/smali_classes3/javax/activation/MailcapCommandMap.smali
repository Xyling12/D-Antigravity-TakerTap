...
# instance fields
.field private DB:[Lcom/sun/activation/registries/khjnvckbwi;
...
.method public constructor <init>()V
    ...
    .line 7
    invoke-direct {p0, v1}, Ljavax/activation/MailcapCommandMap;->loadFile(Ljava/lang/String;)Lcom/sun/activation/registries/khjnvckbwi;
    ...
    invoke-direct {p0, v1}, Ljavax/activation/MailcapCommandMap;->loadResource(Ljava/lang/String;)Lcom/sun/activation/registries/khjnvckbwi;
    ...
    new-array v1, v1, [Lcom/sun/activation/registries/khjnvckbwi;

    iput-object v1, p0, Ljavax/activation/MailcapCommandMap;->DB:[Lcom/sun/activation/registries/khjnvckbwi;
    ...
    check-cast v0, [Lcom/sun/activation/registries/khjnvckbwi;

    iput-object v0, p0, Ljavax/activation/MailcapCommandMap;->DB:[Lcom/sun/activation/registries/khjnvckbwi;
...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    .line 27
    iget-object v0, p0, Ljavax/activation/MailcapCommandMap;->DB:[Lcom/sun/activation/registries/khjnvckbwi;
    ...
    .line 28
    :try_start_0
    new-instance v2, Lcom/sun/activation/registries/khjnvckbwi;

    invoke-direct {v2, p1}, Lcom/sun/activation/registries/khjnvckbwi;-><init>(Ljava/io/InputStream;)V
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    invoke-direct {v2, p1}, Lcom/sun/activation/registries/khjnvckbwi;-><init>(Ljava/lang/String;)V
...
.method private getDataContentHandler(Ljava/lang/String;)Ljavax/activation/DataContentHandler;
    ...
    invoke-static {p1, v1}, Lcom/sun/activation/registries/feyxvdiekx;->khjnvckbwi(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private loadAllResources(Ljava/util/List;Ljava/lang/String;)V
    ...
    new-instance v6, Lcom/sun/activation/registries/khjnvckbwi;

    invoke-direct {v6, v5}, Lcom/sun/activation/registries/khjnvckbwi;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-direct {p0, p2}, Ljavax/activation/MailcapCommandMap;->loadResource(Ljava/lang/String;)Lcom/sun/activation/registries/khjnvckbwi;
...
.method private loadFile(Ljava/lang/String;)Lcom/sun/activation/registries/khjnvckbwi;
    .locals 1

    :try_start_0
    new-instance v0, Lcom/sun/activation/registries/khjnvckbwi;

    invoke-direct {v0, p1}, Lcom/sun/activation/registries/khjnvckbwi;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private loadResource(Ljava/lang/String;)Lcom/sun/activation/registries/khjnvckbwi;
    .locals 6
    ...
    :try_start_1
    new-instance v3, Lcom/sun/activation/registries/khjnvckbwi;

    invoke-direct {v3, v2}, Lcom/sun/activation/registries/khjnvckbwi;-><init>(Ljava/io/InputStream;)V
...
.method public declared-synchronized addMailcap(Ljava/lang/String;)V
    ...
    invoke-direct {v2}, Lcom/sun/activation/registries/khjnvckbwi;-><init>()V
    ...
    invoke-virtual {v0, p1}, Lcom/sun/activation/registries/khjnvckbwi;->qfzjddwuyn(Ljava/lang/String;)V
    :try_end_0
...
.method public declared-synchronized createDataContentHandler(Ljava/lang/String;)Ljavax/activation/DataContentHandler;
    ...
    :goto_1
    iget-object v2, p0, Ljavax/activation/MailcapCommandMap;->DB:[Lcom/sun/activation/registries/khjnvckbwi;
    ...
    invoke-virtual {v2, p1}, Lcom/sun/activation/registries/khjnvckbwi;->khjnvckbwi(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-virtual {v2, p1}, Lcom/sun/activation/registries/khjnvckbwi;->feyxvdiekx(Ljava/lang/String;)Ljava/util/Map;
...
.method public declared-synchronized getAllCommands(Ljava/lang/String;)[Ljavax/activation/CommandInfo;
    ...
    :goto_1
    iget-object v3, p0, Ljavax/activation/MailcapCommandMap;->DB:[Lcom/sun/activation/registries/khjnvckbwi;
    ...
    :cond_1
    invoke-virtual {v3, p1}, Lcom/sun/activation/registries/khjnvckbwi;->khjnvckbwi(Ljava/lang/String;)Ljava/util/Map;
...
.method public declared-synchronized getMimeTypes()[Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v3}, Lcom/sun/activation/registries/khjnvckbwi;->ibzphkbtmt()[Ljava/lang/String;
...
.method public declared-synchronized getNativeCommands(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v3, p1}, Lcom/sun/activation/registries/khjnvckbwi;->qhoahqxrkc(Ljava/lang/String;)[Ljava/lang/String;
