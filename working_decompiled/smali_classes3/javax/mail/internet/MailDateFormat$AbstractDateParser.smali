...
.method final parseMonthName(Z)I
    ...
    invoke-virtual {v0}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->getChar()I
    ...
    :goto_0
    :sswitch_8
    invoke-virtual {v0, v15, v14}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipPair(CC)Z
    ...
    invoke-virtual {v0, v15, v11, v14, v7}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v13, v6, v1, v3}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v1, v3}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipPair(CC)Z
    ...
    invoke-virtual {v0, v1, v4, v3, v5}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v5}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipChar(C)Z
    ...
    :goto_6
    :sswitch_c
    invoke-virtual {v0, v8}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipChar(C)Z
    ...
    :cond_8
    invoke-virtual {v0, v10, v6}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipPair(CC)Z
    ...
    invoke-virtual {v0, v10, v5, v6, v4}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v15, v11, v1, v3}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v15, v11, v13, v6}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    invoke-virtual {v0, v8, v1}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipPair(CC)Z
    ...
    invoke-virtual {v0, v8, v3, v1, v5}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    :cond_11
    invoke-virtual {v0, v14, v9}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipPair(CC)Z
    ...
    invoke-virtual {v0, v14, v7, v9, v4}, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->skipAlternativePair(CCCC)Z
    ...
    iget-object v3, v0, Ljavax/mail/internet/MailDateFormat$AbstractDateParser;->pos:Ljava/text/ParsePosition;
