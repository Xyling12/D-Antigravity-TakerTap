...
.method private static doEncode(Ljava/lang/String;ZLjava/lang/String;ILjava/lang/String;ZZLjava/lang/StringBuilder;)V
    ...
    :cond_0
    invoke-static {v0, v6}, Lcom/sun/mail/util/QEncoderStream;->encodedLength([BZ)I
    ...
    new-instance p1, Lcom/sun/mail/util/BEncoderStream;

    invoke-direct {p1, p0}, Lcom/sun/mail/util/BEncoderStream;-><init>(Ljava/io/OutputStream;)V

    goto :goto_1

    :cond_4
    new-instance p1, Lcom/sun/mail/util/QEncoderStream;

    invoke-direct {p1, p0, v6}, Lcom/sun/mail/util/QEncoderStream;-><init>(Ljava/io/OutputStream;Z)V
    ...
    sget-boolean p1, Ljavax/mail/internet/MimeUtility;->foldEncodedWords:Z
