...
.method private loadProviders(Ljava/lang/Class;)V
    ...
    invoke-direct {p0, v2, p1, v0}, Ljavax/mail/Session;->loadAllResources(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/StreamLoader;)V

    const-string v2, "/META-INF/javamail.default.providers"

    const/4 v3, 0x0

    invoke-direct {p0, v2, p1, v0, v3}, Ljavax/mail/Session;->loadResource(Ljava/lang/String;Ljava/lang/Class;Ljavax/mail/StreamLoader;Z)V
    ...
    new-instance v2, Ljavax/mail/Provider;

    const-string v6, "Oracle"

    const-string v7, "1.6.8"

    const-string v4, "imaps"

    const-string v5, "com.sun.mail.imap.IMAPSSLStore"
    ...
    const-string v4, "pop3s"

    const-string v5, "com.sun.mail.pop3.POP3SSLStore"

    invoke-direct/range {v2 .. v7}, Ljavax/mail/Provider;-><init>(Ljavax/mail/Provider$Type;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v2}, Ljavax/mail/Session;->addProvider(Ljavax/mail/Provider;)V

    new-instance v3, Ljavax/mail/Provider;

    sget-object v4, Ljavax/mail/Provider$Type;->TRANSPORT:Ljavax/mail/Provider$Type;

    const-string v7, "Oracle"

    const-string v8, "1.6.8"

    const-string v5, "smtp"

    const-string v6, "com.sun.mail.smtp.SMTPTransport"
    ...
    const-string v9, "1.6.8"

    const-string v6, "smtps"

    const-string v7, "com.sun.mail.smtp.SMTPSSLTransport"
    ...
    invoke-virtual {p0, v4}, Ljavax/mail/Session;->addProvider(Ljavax/mail/Provider;)V
